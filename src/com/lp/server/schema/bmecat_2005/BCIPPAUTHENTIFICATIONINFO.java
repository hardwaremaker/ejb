 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.bmecat.org/bmecat/2005}AUTHENTIFICATION" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "IPP_AUTHENTIFICATION_INFO")
public class BCIPPAUTHENTIFICATIONINFO {

    @XmlElement(name = "AUTHENTIFICATION")
    protected List<BCAUTHENTIFICATION> authentification;
    @XmlAttribute
     ...
     * This is why there is not a <CODE>set</CODE> method for the authentification property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAUTHENTIFICATION().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BCAUTHENTIFICATION> getAUTHENTIFICATION() {
        if (authentification == null) {
            authentification = new ArrayList<BCAUTHENTIFICATION>();
        }
