 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.bmecat.org/bmecat/2005}SYNONYM" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ALLOWED_VALUE_SYNONYMS")
public class BCALLOWEDVALUESYNONYMS {

    @XmlElement(name = "SYNONYM", required = true)
    protected List<BCSYNONYM> synonym;
     ...
     * 
     */
    public List<BCSYNONYM> getSYNONYM() {
        if (synonym == null) {
            synonym = new ArrayList<BCSYNONYM>();
        }
        return this.synonym;
    }
