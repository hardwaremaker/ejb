...
public class BCCLASSIFICATIONGROUPFEATURETEMPLATES {

    @XmlElement(name = "CLASSIFICATION_GROUP_FEATURE_TEMPLATE", required = true)
    protected List<BCCLASSIFICATIONGROUPFEATURETEMPLATE> classificationgroupfeaturetemplate;
     ...
     * {@link BCCLASSIFICATIONGROUPFEATURETEMPLATE }
     * 
     * 
     */
    public List<BCCLASSIFICATIONGROUPFEATURETEMPLATE> getCLASSIFICATIONGROUPFEATURETEMPLATE() {
        if (classificationgroupfeaturetemplate == null) {
            classificationgroupfeaturetemplate = new ArrayList<BCCLASSIFICATIONGROUPFEATURETEMPLATE>();
        }
