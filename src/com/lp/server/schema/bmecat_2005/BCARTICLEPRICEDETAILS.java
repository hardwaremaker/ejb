...
public class BCARTICLEPRICEDETAILS {
     ...
     * {@link BCARTICLEPRICEDETAILS.DATETIME }
     * 
     * 
     */
    public List<BCARTICLEPRICEDETAILS.DATETIME> getDATETIME() {
        if (datetime == null) {
            datetime = new ArrayList<BCARTICLEPRICEDETAILS.DATETIME>();
        }
     ...
     * 
     */
    public List<BCARTICLEPRICE> getARTICLEPRICE() {
        if (articleprice == null) {
            articleprice = new ArrayList<BCARTICLEPRICE>();
        }
