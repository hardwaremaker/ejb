...
public class BCAGREEMENT {
    ...
    protected List<BCAGREEMENT.DATETIME> datetime;
     ...
     * {@link BCAGREEMENT.DATETIME }
     * 
     * 
     */
    public List<BCAGREEMENT.DATETIME> getDATETIME() {
        if (datetime == null) {
            datetime = new ArrayList<BCAGREEMENT.DATETIME>();
        }
