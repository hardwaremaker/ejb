...
public class BCCLASSIFICATIONGROUPS {

    @XmlElement(name = "CLASSIFICATION_GROUP", required = true)
    protected List<BCCLASSIFICATIONGROUP> classificationgroup;
     ...
     * {@link BCCLASSIFICATIONGROUP }
     * 
     * 
     */
    public List<BCCLASSIFICATIONGROUP> getCLASSIFICATIONGROUP() {
        if (classificationgroup == null) {
            classificationgroup = new ArrayList<BCCLASSIFICATIONGROUP>();
        }
