 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.bmecat.org/bmecat/2005}FORMULA" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class BCFORMULAS {
    ...
    protected List<BCFORMULA> formula;
     ...
     * 
     */
    public List<BCFORMULA> getFORMULA() {
        if (formula == null) {
            formula = new ArrayList<BCFORMULA>();
        }
        return this.formula;
    }
