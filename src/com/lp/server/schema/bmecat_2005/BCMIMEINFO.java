 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.bmecat.org/bmecat/2005}MIME" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class BCMIMEINFO {

    @XmlElement(name = "MIME", required = true)
    protected List<BCMIME> mime;
     ...
     * 
     */
    public List<BCMIME> getMIME() {
        if (mime == null) {
            mime = new ArrayList<BCMIME>();
        }
        return this.mime;
    }
