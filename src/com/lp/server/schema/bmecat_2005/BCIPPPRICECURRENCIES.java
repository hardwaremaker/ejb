 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.bmecat.org/bmecat/2005}PRICE_CURRENCY" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "IPP_PRICE_CURRENCIES")
public class BCIPPPRICECURRENCIES {

    @XmlElement(name = "PRICE_CURRENCY")
    protected List<DtCURRENCIES> pricecurrency;
    @XmlAttribute
     ...
     * This is why there is not a <CODE>set</CODE> method for the pricecurrency property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPRICECURRENCY().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DtCURRENCIES> getPRICECURRENCY() {
        if (pricecurrency == null) {
            pricecurrency = new ArrayList<DtCURRENCIES>();
        }
