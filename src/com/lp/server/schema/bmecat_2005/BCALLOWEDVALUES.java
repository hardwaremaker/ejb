 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.bmecat.org/bmecat/2005}ALLOWED_VALUE" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class BCALLOWEDVALUES {

    @XmlElement(name = "ALLOWED_VALUE", required = true)
    protected List<BCALLOWEDVALUE> allowedvalue;
     ...
     * 
     */
    public List<BCALLOWEDVALUE> getALLOWEDVALUE() {
        if (allowedvalue == null) {
            allowedvalue = new ArrayList<BCALLOWEDVALUE>();
        }
