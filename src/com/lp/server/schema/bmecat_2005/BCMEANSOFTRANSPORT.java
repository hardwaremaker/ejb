...
public class BCMEANSOFTRANSPORT {
    ...
    protected List<BCMEANSOFTRANSPORTNAME> meansoftransportname;
     ...
     * {@link BCMEANSOFTRANSPORTNAME }
     * 
     * 
     */
    public List<BCMEANSOFTRANSPORTNAME> getMEANSOFTRANSPORTNAME() {
        if (meansoftransportname == null) {
            meansoftransportname = new ArrayList<BCMEANSOFTRANSPORTNAME>();
        }
