 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.opentrans.org/XMLSchema/2.1}INVOICE_ITEM" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OT2INVOICEITEMLIST {

    @XmlElement(name = "INVOICE_ITEM", required = true)
    protected List<OT2INVOICEITEM> invoiceitem;
     ...
     * 
     */
    public List<OT2INVOICEITEM> getINVOICEITEM() {
        if (invoiceitem == null) {
            invoiceitem = new ArrayList<OT2INVOICEITEM>();
        }
