...
public class OT2DISPATCHNOTIFICATIONITEMLIST {

    @XmlElement(name = "DISPATCHNOTIFICATION_ITEM", required = true)
    protected List<OT2DISPATCHNOTIFICATIONITEM> dispatchnotificationitem;
     ...
     * {@link OT2DISPATCHNOTIFICATIONITEM }
     * 
     * 
     */
    public List<OT2DISPATCHNOTIFICATIONITEM> getDISPATCHNOTIFICATIONITEM() {
        if (dispatchnotificationitem == null) {
            dispatchnotificationitem = new ArrayList<OT2DISPATCHNOTIFICATIONITEM>();
        }
