...
import com.lp.server.schema.bmecat_2005.BCREFERENCEFEATUREGROUPNAME;
import com.lp.server.schema.bmecat_2005.TypeCLASSIFICATIONGROUPID;
 ...
 *         &lt;element ref="{http://www.opentrans.org/XMLSchema/2.1}FEATURE" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OT2PRODUCTFEATURES {

    @XmlElement(name = "REFERENCE_FEATURE_SYSTEM_NAME", namespace = "http://www.bmecat.org/bmecat/2005")
    protected String referencefeaturesystemname;
    @XmlElement(name = "REFERENCE_FEATURE_GROUP_ID", namespace = "http://www.bmecat.org/bmecat/2005")
    protected List<TypeCLASSIFICATIONGROUPID> referencefeaturegroupid;
    @XmlElement(name = "REFERENCE_FEATURE_GROUP_NAME", namespace = "http://www.bmecat.org/bmecat/2005")
    protected List<BCREFERENCEFEATUREGROUPNAME> referencefeaturegroupname;
    @XmlElement(name = "REFERENCE_FEATURE_GROUP_ID2", namespace = "http://www.bmecat.org/bmecat/2005")
    protected List<TypeCLASSIFICATIONGROUPID> referencefeaturegroupid2;
    @XmlElement(name = "GROUP_PRODUCT_ORDER", namespace = "http://www.bmecat.org/bmecat/2005")
    protected BigInteger groupproductorder;
    @XmlElement(name = "FEATURE")
    protected List<OT2FEATURE> feature;
     ...
     * 
     */
    public List<OT2FEATURE> getFEATURE() {
        if (feature == null) {
            feature = new ArrayList<OT2FEATURE>();
        }
        return this.feature;
    }
