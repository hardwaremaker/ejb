 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.opentrans.org/XMLSchema/2.1}MIME" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OT2MIMEINFO {

    @XmlElement(name = "MIME", required = true)
    protected List<OT2MIME> mime;
     ...
     * 
     */
    public List<OT2MIME> getMIME() {
        if (mime == null) {
            mime = new ArrayList<OT2MIME>();
        }
        return this.mime;
    }
