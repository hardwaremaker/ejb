...
public class OT2RECEIPTACKNOWLEDGEMENTITEMLIST {

    @XmlElement(name = "RECEIPTACKNOWLEDGEMENT_ITEM", required = true)
    protected List<OT2RECEIPTACKNOWLEDGEMENTITEM> receiptacknowledgementitem;
     ...
     * {@link OT2RECEIPTACKNOWLEDGEMENTITEM }
     * 
     * 
     */
    public List<OT2RECEIPTACKNOWLEDGEMENTITEM> getRECEIPTACKNOWLEDGEMENTITEM() {
        if (receiptacknowledgementitem == null) {
            receiptacknowledgementitem = new ArrayList<OT2RECEIPTACKNOWLEDGEMENTITEM>();
        }
