 ...
 *         &lt;element name="countryList" type="{http://schemas.microsoft.com/2003/10/Serialization/Arrays}ArrayOfstring" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAllowedServicesForCountry")
public class GetAllowedServicesForCountry {

    protected Integer clientID;
    protected Integer orgUnitID;
    protected String orgUnitGuid;
    @XmlElementRef(name = "countryList", namespace = "http://post.ondot.at", type = JAXBElement.class)
    protected JAXBElement<ArrayOfstring> countryList;
     ...
     *     
     */
    public JAXBElement<ArrayOfstring> getCountryList() {
        return countryList;
    }
     ...
     *     
     */
    public void setCountryList(JAXBElement<ArrayOfstring> value) {
