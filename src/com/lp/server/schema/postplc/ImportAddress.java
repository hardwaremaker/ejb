 ...
 *         &lt;element name="addresses" type="{http://post.ondot.at}ArrayOfAddressRow" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ImportAddress")
public class ImportAddress {

    protected Integer clientID;
    protected Integer orgUnitID;
    protected String orgUnitGuid;
    @XmlElementRef(name = "addresses", namespace = "http://post.ondot.at", type = JAXBElement.class)
    protected JAXBElement<ArrayOfAddressRow> addresses;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfAddressRow }{@code >}
     *     
     */
    public JAXBElement<ArrayOfAddressRow> getAddresses() {
        return addresses;
    }
     ...
     *     
     */
    public void setAddresses(JAXBElement<ArrayOfAddressRow> value) {
