...
/**
 * <p>Java class for _XML_XML_ORDERRESPONSE_ITEM_LIST complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="_XML_XML_ORDERRESPONSE_ITEM_LIST">
 *   &lt;complexContent>
...
@XmlType(name = "_XML_XML_ORDERRESPONSE_ITEM_LIST", propOrder = {
    "orderresponseitem"
})
public class XMLXMLORDERRESPONSEITEMLIST {

    @XmlElement(name = "ORDERRESPONSE_ITEM", required = true)
    protected List<XMLXMLORDERRESPONSEITEM> orderresponseitem;
     ...
     * {@link XMLXMLORDERRESPONSEITEM }
     * 
     * 
     */
    public List<XMLXMLORDERRESPONSEITEM> getORDERRESPONSEITEM() {
        if (orderresponseitem == null) {
            orderresponseitem = new ArrayList<XMLXMLORDERRESPONSEITEM>();
        }
