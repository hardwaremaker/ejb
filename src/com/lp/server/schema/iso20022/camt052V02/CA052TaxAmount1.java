...
public class CA052TaxAmount1 {

    @XmlElement(name = "Rate")
    protected BigDecimal rate;
    @XmlElement(name = "TaxblBaseAmt")
    protected CA052ActiveOrHistoricCurrencyAndAmount taxblBaseAmt;
    @XmlElement(name = "TtlAmt")
    protected CA052ActiveOrHistoricCurrencyAndAmount ttlAmt;
    @XmlElement(name = "Dtls")
    protected List<CA052TaxRecordDetails1> dtls;
     ...
     *     
     */
    public CA052ActiveOrHistoricCurrencyAndAmount getTaxblBaseAmt() {
        return taxblBaseAmt;
    }
     ...
     *     
     */
    public void setTaxblBaseAmt(CA052ActiveOrHistoricCurrencyAndAmount value) {
     ...
     *     
     */
    public CA052ActiveOrHistoricCurrencyAndAmount getTtlAmt() {
        return ttlAmt;
    }
     ...
     *     
     */
    public void setTtlAmt(CA052ActiveOrHistoricCurrencyAndAmount value) {
        this.ttlAmt = value;
    }
     ...
     * {@link CA052TaxRecordDetails1 }
     * 
     * 
     */
    public List<CA052TaxRecordDetails1> getDtls() {
        if (dtls == null) {
            dtls = new ArrayList<CA052TaxRecordDetails1>();
        }
        return this.dtls;
    }
