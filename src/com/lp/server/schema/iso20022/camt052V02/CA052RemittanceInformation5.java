...
public class CA052RemittanceInformation5 {

    @XmlElement(name = "Ustrd")
    protected List<String> ustrd;
    @XmlElement(name = "Strd")
    protected List<CA052StructuredRemittanceInformation7> strd;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CA052StructuredRemittanceInformation7 }
     * 
     * 
     */
    public List<CA052StructuredRemittanceInformation7> getStrd() {
        if (strd == null) {
            strd = new ArrayList<CA052StructuredRemittanceInformation7>();
        }
        return this.strd;
    }
