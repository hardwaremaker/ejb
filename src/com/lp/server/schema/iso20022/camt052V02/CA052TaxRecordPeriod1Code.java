...
@XmlEnum
public enum CA052TaxRecordPeriod1Code {
    ...
    CA052TaxRecordPeriod1Code(String v) {
        value = v;
    }
    ...
    public static CA052TaxRecordPeriod1Code fromValue(String v) {
        for (CA052TaxRecordPeriod1Code c: CA052TaxRecordPeriod1Code.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
