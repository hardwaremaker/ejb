...
public class CA052TransactionDates2 {
    ...
    protected List<CA052ProprietaryDate2> prtry;
     ...
     * {@link CA052ProprietaryDate2 }
     * 
     * 
     */
    public List<CA052ProprietaryDate2> getPrtry() {
        if (prtry == null) {
            prtry = new ArrayList<CA052ProprietaryDate2>();
        }
        return this.prtry;
    }
