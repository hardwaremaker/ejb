...
/**
 * <p>Java-Klasse fuer ReferredDocumentInformation3 complex type.
 * 
...
public class PAReferredDocumentInformation3 {

    @XmlElement(name = "Tp")
    protected PAReferredDocumentType2 tp;
    @XmlElement(name = "Nb")
    protected String nb;
     ...
     * @return
     *     possible object is
     *     {@link PAReferredDocumentType2 }
     *     
     */
    public PAReferredDocumentType2 getTp() {
        return tp;
    }
     ...
     *     
     */
    public void setTp(PAReferredDocumentType2 value) {
        this.tp = value;
    }
