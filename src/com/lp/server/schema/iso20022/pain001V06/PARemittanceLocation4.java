 ...
 *       &lt;sequence>
 *         &lt;element name="RmtId" type="{urn:iso:std:iso:20022:tech:xsd:pain.001.001.06}Max35Text" minOccurs="0"/>
 *         &lt;element name="RmtLctnDtls" type="{urn:iso:std:iso:20022:tech:xsd:pain.001.001.06}RemittanceLocationDetails1" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PARemittanceLocation4 {

    @XmlElement(name = "RmtId")
    protected String rmtId;
    @XmlElement(name = "RmtLctnDtls")
    protected List<PARemittanceLocationDetails1> rmtLctnDtls;
     ...
     * {@link PARemittanceLocationDetails1 }
     * 
     * 
     */
    public List<PARemittanceLocationDetails1> getRmtLctnDtls() {
        if (rmtLctnDtls == null) {
            rmtLctnDtls = new ArrayList<PARemittanceLocationDetails1>();
        }
