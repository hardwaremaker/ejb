...
/**
 * <p>Java-Klasse fuer CustomerCreditTransferInitiationV06 complex type.
 * 
...
public class PACustomerCreditTransferInitiationV06 {

    @XmlElement(name = "GrpHdr", required = true)
    protected PAGroupHeader48 grpHdr;
    @XmlElement(name = "PmtInf", required = true)
    protected List<PAPaymentInstruction16> pmtInf;
     ...
     * @return
     *     possible object is
     *     {@link PAGroupHeader48 }
     *     
     */
    public PAGroupHeader48 getGrpHdr() {
        return grpHdr;
    }
     ...
     *     
     */
    public void setGrpHdr(PAGroupHeader48 value) {
        this.grpHdr = value;
    }
     ...
     * {@link PAPaymentInstruction16 }
     * 
     * 
     */
    public List<PAPaymentInstruction16> getPmtInf() {
        if (pmtInf == null) {
            pmtInf = new ArrayList<PAPaymentInstruction16>();
        }
        return this.pmtInf;
    }
