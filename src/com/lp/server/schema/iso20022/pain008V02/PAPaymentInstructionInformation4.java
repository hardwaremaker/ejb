...
/**
 * <p>Java-Klasse fuer PaymentInstructionInformation4 complex type.
 * 
...
public class PAPaymentInstructionInformation4 {

    @XmlElement(name = "PmtInfId", required = true)
    protected String pmtInfId;
    @XmlElement(name = "PmtMtd", required = true)
    @XmlSchemaType(name = "string")
    protected PAPaymentMethod2Code pmtMtd;
    ...
    protected List<PADirectDebitTransactionInformation9> drctDbtTxInf;
     ...
     * @return
     *     possible object is
     *     {@link PAPaymentMethod2Code }
     *     
     */
    public PAPaymentMethod2Code getPmtMtd() {
        return pmtMtd;
    }
     ...
     *     
     */
    public void setPmtMtd(PAPaymentMethod2Code value) {
        this.pmtMtd = value;
    }
     ...
     * {@link PADirectDebitTransactionInformation9 }
     * 
     * 
     */
    public List<PADirectDebitTransactionInformation9> getDrctDbtTxInf() {
        if (drctDbtTxInf == null) {
            drctDbtTxInf = new ArrayList<PADirectDebitTransactionInformation9>();
        }
