...
/**
 * <p>Java-Klasse fuer TaxRecordPeriod1Code.
 * 
...
@XmlEnum
public enum PATaxRecordPeriod1Code {
    ...
    PATaxRecordPeriod1Code(String v) {
        value = v;
    }
    ...
    public static PATaxRecordPeriod1Code fromValue(String v) {
        for (PATaxRecordPeriod1Code c: PATaxRecordPeriod1Code.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
