...
public class PAStructuredRemittanceInformation7 {

    @XmlElement(name = "RfrdDocInf")
    protected List<PAReferredDocumentInformation3> rfrdDocInf;
    @XmlElement(name = "RfrdDocAmt")
    protected PARemittanceAmount1 rfrdDocAmt;
    @XmlElement(name = "CdtrRefInf")
    protected PACreditorReferenceInformation2 cdtrRefInf;
    @XmlElement(name = "Invcr")
    protected PAPartyIdentification32 invcr;
    @XmlElement(name = "Invcee")
    protected PAPartyIdentification32 invcee;
     ...
     * {@link PAReferredDocumentInformation3 }
     * 
     * 
     */
    public List<PAReferredDocumentInformation3> getRfrdDocInf() {
        if (rfrdDocInf == null) {
            rfrdDocInf = new ArrayList<PAReferredDocumentInformation3>();
        }
     ...
     * @return
     *     possible object is
     *     {@link PARemittanceAmount1 }
     *     
     */
    public PARemittanceAmount1 getRfrdDocAmt() {
        return rfrdDocAmt;
    }
     ...
     *     
     */
    public void setRfrdDocAmt(PARemittanceAmount1 value) {
     ...
     *     
     */
    public PAPartyIdentification32 getInvcr() {
        return invcr;
    }
     ...
     *     
     */
    public void setInvcr(PAPartyIdentification32 value) {
        this.invcr = value;
    }
     ...
     *     
     */
    public PAPartyIdentification32 getInvcee() {
        return invcee;
    }
     ...
     *     
     */
    public void setInvcee(PAPartyIdentification32 value) {
        this.invcee = value;
    }
