...
public class CA04TaxAmount1 {

    @XmlElement(name = "Rate")
    protected BigDecimal rate;
    @XmlElement(name = "TaxblBaseAmt")
    protected CA04ActiveOrHistoricCurrencyAndAmount taxblBaseAmt;
    @XmlElement(name = "TtlAmt")
    protected CA04ActiveOrHistoricCurrencyAndAmount ttlAmt;
    @XmlElement(name = "Dtls")
    protected List<CA04TaxRecordDetails1> dtls;
     ...
     *     
     */
    public CA04ActiveOrHistoricCurrencyAndAmount getTaxblBaseAmt() {
        return taxblBaseAmt;
    }
     ...
     *     
     */
    public void setTaxblBaseAmt(CA04ActiveOrHistoricCurrencyAndAmount value) {
     ...
     * {@link CA04TaxRecordDetails1 }
     * 
     * 
     */
    public List<CA04TaxRecordDetails1> getDtls() {
        if (dtls == null) {
            dtls = new ArrayList<CA04TaxRecordDetails1>();
        }
        return this.dtls;
    }
