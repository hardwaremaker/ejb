...
@XmlEnum
public enum CA04TaxRecordPeriod1Code {
    ...
    CA04TaxRecordPeriod1Code(String v) {
        value = v;
    }
    ...
    public static CA04TaxRecordPeriod1Code fromValue(String v) {
        for (CA04TaxRecordPeriod1Code c: CA04TaxRecordPeriod1Code.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
