...
public class CA04AmountAndCurrencyExchange3 {

    @XmlElement(name = "InstdAmt")
    protected CA04AmountAndCurrencyExchangeDetails3 instdAmt;
    @XmlElement(name = "TxAmt")
    protected CA04AmountAndCurrencyExchangeDetails3 txAmt;
    @XmlElement(name = "CntrValAmt")
    protected CA04AmountAndCurrencyExchangeDetails3 cntrValAmt;
    @XmlElement(name = "AnncdPstngAmt")
    protected CA04AmountAndCurrencyExchangeDetails3 anncdPstngAmt;
    @XmlElement(name = "PrtryAmt")
    protected List<CA04AmountAndCurrencyExchangeDetails4> prtryAmt;
     ...
     * @return
     *     possible object is
     *     {@link CA04AmountAndCurrencyExchangeDetails3 }
     *     
     */
    public CA04AmountAndCurrencyExchangeDetails3 getInstdAmt() {
        return instdAmt;
    }
     ...
     *     
     */
    public void setInstdAmt(CA04AmountAndCurrencyExchangeDetails3 value) {
        this.instdAmt = value;
    }
     ...
     *     
     */
    public CA04AmountAndCurrencyExchangeDetails3 getTxAmt() {
        return txAmt;
    }
     ...
     *     
     */
    public void setTxAmt(CA04AmountAndCurrencyExchangeDetails3 value) {
        this.txAmt = value;
    }
     ...
     *     
     */
    public CA04AmountAndCurrencyExchangeDetails3 getCntrValAmt() {
        return cntrValAmt;
    }
     ...
     *     
     */
    public void setCntrValAmt(CA04AmountAndCurrencyExchangeDetails3 value) {
     ...
     *     
     */
    public CA04AmountAndCurrencyExchangeDetails3 getAnncdPstngAmt() {
     ...
     *     
     */
    public void setAnncdPstngAmt(CA04AmountAndCurrencyExchangeDetails3 value) {
     ...
     * {@link CA04AmountAndCurrencyExchangeDetails4 }
     * 
     * 
     */
    public List<CA04AmountAndCurrencyExchangeDetails4> getPrtryAmt() {
        if (prtryAmt == null) {
            prtryAmt = new ArrayList<CA04AmountAndCurrencyExchangeDetails4>();
        }
