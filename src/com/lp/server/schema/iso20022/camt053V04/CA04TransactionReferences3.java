...
public class CA04TransactionReferences3 {
    ...
    protected List<CA04ProprietaryReference1> prtry;
     ...
     * {@link CA04ProprietaryReference1 }
     * 
     * 
     */
    public List<CA04ProprietaryReference1> getPrtry() {
        if (prtry == null) {
            prtry = new ArrayList<CA04ProprietaryReference1>();
        }
        return this.prtry;
    }
