...
public class CA04RemittanceInformation7 {

    @XmlElement(name = "Ustrd")
    protected List<String> ustrd;
    @XmlElement(name = "Strd")
    protected List<CA04StructuredRemittanceInformation9> strd;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CA04StructuredRemittanceInformation9 }
     * 
     * 
     */
    public List<CA04StructuredRemittanceInformation9> getStrd() {
        if (strd == null) {
            strd = new ArrayList<CA04StructuredRemittanceInformation9>();
        }
        return this.strd;
    }
