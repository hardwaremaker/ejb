...
public class CA04CashDeposit1 {

    @XmlElement(name = "NoteDnmtn", required = true)
    protected CA04ActiveCurrencyAndAmount noteDnmtn;
    @XmlElement(name = "NbOfNotes", required = true)
    protected String nbOfNotes;
    @XmlElement(name = "Amt", required = true)
    protected CA04ActiveCurrencyAndAmount amt;
     ...
     * @return
     *     possible object is
     *     {@link CA04ActiveCurrencyAndAmount }
     *     
     */
    public CA04ActiveCurrencyAndAmount getNoteDnmtn() {
        return noteDnmtn;
    }
     ...
     *     
     */
    public void setNoteDnmtn(CA04ActiveCurrencyAndAmount value) {
     ...
     *     
     */
    public CA04ActiveCurrencyAndAmount getAmt() {
        return amt;
    }
     ...
     *     
     */
    public void setAmt(CA04ActiveCurrencyAndAmount value) {
        this.amt = value;
    }
