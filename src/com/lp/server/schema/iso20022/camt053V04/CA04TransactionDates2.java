...
public class CA04TransactionDates2 {
    ...
    protected List<CA04ProprietaryDate2> prtry;
     ...
     * {@link CA04ProprietaryDate2 }
     * 
     * 
     */
    public List<CA04ProprietaryDate2> getPrtry() {
        if (prtry == null) {
            prtry = new ArrayList<CA04ProprietaryDate2>();
        }
        return this.prtry;
    }
