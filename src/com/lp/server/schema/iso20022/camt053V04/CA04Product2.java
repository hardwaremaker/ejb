...
public class CA04Product2 {

    @XmlElement(name = "PdctCd", required = true)
    protected String pdctCd;
    @XmlElement(name = "UnitOfMeasr")
    @XmlSchemaType(name = "string")
    protected CA04UnitOfMeasure1Code unitOfMeasr;
     ...
     * @return
     *     possible object is
     *     {@link CA04UnitOfMeasure1Code }
     *     
     */
    public CA04UnitOfMeasure1Code getUnitOfMeasr() {
        return unitOfMeasr;
    }
     ...
     *     
     */
    public void setUnitOfMeasr(CA04UnitOfMeasure1Code value) {
