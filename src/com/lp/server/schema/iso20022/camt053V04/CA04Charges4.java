...
public class CA04Charges4 {

    @XmlElement(name = "TtlChrgsAndTaxAmt")
    protected CA04ActiveOrHistoricCurrencyAndAmount ttlChrgsAndTaxAmt;
    @XmlElement(name = "Rcrd")
    protected List<CA04ChargesRecord2> rcrd;
     ...
     *     
     */
    public CA04ActiveOrHistoricCurrencyAndAmount getTtlChrgsAndTaxAmt() {
     ...
     *     
     */
    public void setTtlChrgsAndTaxAmt(CA04ActiveOrHistoricCurrencyAndAmount value) {
     ...
     * {@link CA04ChargesRecord2 }
     * 
     * 
     */
    public List<CA04ChargesRecord2> getRcrd() {
        if (rcrd == null) {
            rcrd = new ArrayList<CA04ChargesRecord2>();
        }
        return this.rcrd;
    }
