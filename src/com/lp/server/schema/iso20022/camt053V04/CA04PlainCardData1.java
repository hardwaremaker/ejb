...
public class CA04PlainCardData1 {
    ...
    protected List<CA04TrackData1> trckData;
    @XmlElement(name = "CardSctyCd")
    protected CA04CardSecurityInformation1 cardSctyCd;
     ...
     * 
     */
    public List<CA04TrackData1> getTrckData() {
        if (trckData == null) {
            trckData = new ArrayList<CA04TrackData1>();
        }
     ...
     * @return
     *     possible object is
     *     {@link CA04CardSecurityInformation1 }
     *     
     */
    public CA04CardSecurityInformation1 getCardSctyCd() {
        return cardSctyCd;
    }
     ...
     *     
     */
    public void setCardSctyCd(CA04CardSecurityInformation1 value) {
