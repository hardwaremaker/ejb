...
public class CA04SecurityIdentification14 {

    @XmlElement(name = "ISIN")
    protected String isin;
    @XmlElement(name = "OthrId")
    protected List<CA04OtherIdentification1> othrId;
     ...
     * {@link CA04OtherIdentification1 }
     * 
     * 
     */
    public List<CA04OtherIdentification1> getOthrId() {
        if (othrId == null) {
            othrId = new ArrayList<CA04OtherIdentification1>();
        }
        return this.othrId;
    }
