...
/**
 * <p>Java-Klasse fuer Product2 complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="PdctCd" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}Max70Text"/>
 *         &lt;element name="UnitOfMeasr" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}UnitOfMeasure1Code" minOccurs="0"/>
 *         &lt;element name="PdctQty" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}DecimalNumber" minOccurs="0"/>
 *         &lt;element name="UnitPric" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="PdctAmt" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}ImpliedCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="TaxTp" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}Max35Text" minOccurs="0"/>
 *         &lt;element name="AddtlPdctInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}Max35Text" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CAProduct2 {
     ...
     * @return
     *     possible object is
     *     {@link CAUnitOfMeasure1Code }
     *     
     */
    public CAUnitOfMeasure1Code getUnitOfMeasr() {
        return unitOfMeasr;
    }
     ...
     *     
     */
    public void setUnitOfMeasr(CAUnitOfMeasure1Code value) {
