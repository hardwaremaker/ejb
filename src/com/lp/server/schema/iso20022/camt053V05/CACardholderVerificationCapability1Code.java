...
/**
 * <p>Java-Klasse fuer CardholderVerificationCapability1Code.
 * 
...
@XmlEnum
public enum CACardholderVerificationCapability1Code {
    ...
    public static CACardholderVerificationCapability1Code fromValue(String v) {
        return valueOf(v);
    }
