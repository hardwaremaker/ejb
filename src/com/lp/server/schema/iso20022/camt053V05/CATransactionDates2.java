...
/**
 * <p>Java-Klasse fuer TransactionDates2 complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="AccptncDtTm" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}ISODateTime" minOccurs="0"/>
 *         &lt;element name="TradActvtyCtrctlSttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}ISODate" minOccurs="0"/>
 *         &lt;element name="TradDt" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}ISODate" minOccurs="0"/>
 *         &lt;element name="IntrBkSttlmDt" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}ISODate" minOccurs="0"/>
 *         &lt;element name="StartDt" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}ISODate" minOccurs="0"/>
 *         &lt;element name="EndDt" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}ISODate" minOccurs="0"/>
 *         &lt;element name="TxDtTm" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}ISODateTime" minOccurs="0"/>
 *         &lt;element name="Prtry" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.05}ProprietaryDate2" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CATransactionDates2 {
    ...
    protected List<CAProprietaryDate2> prtry;
     ...
     * {@link CAProprietaryDate2 }
     * 
     * 
     */
    public List<CAProprietaryDate2> getPrtry() {
        if (prtry == null) {
            prtry = new ArrayList<CAProprietaryDate2>();
        }
        return this.prtry;
    }
