...
public class PACHExchangeRateInformation1 {

    @XmlElement(name = "XchgRate")
    protected BigDecimal xchgRate;
    @XmlElement(name = "RateTp")
    @XmlSchemaType(name = "string")
    protected PACHExchangeRateType1Code rateTp;
     ...
     * @return
     *     possible object is
     *     {@link PACHExchangeRateType1Code }
     *     
     */
    public PACHExchangeRateType1Code getRateTp() {
        return rateTp;
    }
     ...
     *     
     */
    public void setRateTp(PACHExchangeRateType1Code value) {
        this.rateTp = value;
    }
