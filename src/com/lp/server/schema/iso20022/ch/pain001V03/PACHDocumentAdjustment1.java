...
public class PACHDocumentAdjustment1 {

    @XmlElement(name = "Amt", required = true)
    protected PACHActiveOrHistoricCurrencyAndAmount amt;
    @XmlElement(name = "CdtDbtInd")
    @XmlSchemaType(name = "string")
    protected PACHCreditDebitCode cdtDbtInd;
    @XmlElement(name = "Rsn")
     ...
     * @return
     *     possible object is
     *     {@link PACHCreditDebitCode }
     *     
     */
    public PACHCreditDebitCode getCdtDbtInd() {
        return cdtDbtInd;
    }
     ...
     *     
     */
    public void setCdtDbtInd(PACHCreditDebitCode value) {
