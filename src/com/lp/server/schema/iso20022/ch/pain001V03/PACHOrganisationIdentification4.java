...
public class PACHOrganisationIdentification4 {

    @XmlElement(name = "BICOrBEI")
    protected String bicOrBEI;
    @XmlElement(name = "Othr")
    protected List<PACHGenericOrganisationIdentification1> othr;
     ...
     * 
     */
    public List<PACHGenericOrganisationIdentification1> getOthr() {
        if (othr == null) {
            othr = new ArrayList<PACHGenericOrganisationIdentification1>();
        }
        return this.othr;
    }
