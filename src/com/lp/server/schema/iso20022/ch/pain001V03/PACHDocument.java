...
public class PACHDocument {

    @XmlElement(name = "CstmrCdtTrfInitn", required = true)
    protected PACHCustomerCreditTransferInitiationV03CH cstmrCdtTrfInitn;
     ...
     * @return
     *     possible object is
     *     {@link PACHCustomerCreditTransferInitiationV03CH }
     *     
     */
    public PACHCustomerCreditTransferInitiationV03CH getCstmrCdtTrfInitn() {
     ...
     *     
     */
    public void setCstmrCdtTrfInitn(PACHCustomerCreditTransferInitiationV03CH value) {
