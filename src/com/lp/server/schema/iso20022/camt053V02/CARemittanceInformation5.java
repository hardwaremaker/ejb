...
/**
 * <p>Java-Klasse fuer RemittanceInformation5 complex type.
 * 
...
public class CARemittanceInformation5 {

    @XmlElement(name = "Ustrd")
    protected List<String> ustrd;
    @XmlElement(name = "Strd")
    protected List<CAStructuredRemittanceInformation7> strd;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CAStructuredRemittanceInformation7 }
     * 
     * 
     */
    public List<CAStructuredRemittanceInformation7> getStrd() {
        if (strd == null) {
            strd = new ArrayList<CAStructuredRemittanceInformation7>();
        }
        return this.strd;
    }
