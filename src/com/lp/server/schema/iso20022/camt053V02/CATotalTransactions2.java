...
/**
 * <p>Java-Klasse fuer TotalTransactions2 complex type.
 * 
...
public class CATotalTransactions2 {

    @XmlElement(name = "TtlNtries")
    protected CANumberAndSumOfTransactions2 ttlNtries;
    ...
    protected List<CATotalsPerBankTransactionCode2> ttlNtriesPerBkTxCd;
     ...
     * @return
     *     possible object is
     *     {@link CANumberAndSumOfTransactions2 }
     *     
     */
    public CANumberAndSumOfTransactions2 getTtlNtries() {
        return ttlNtries;
    }
     ...
     *     
     */
    public void setTtlNtries(CANumberAndSumOfTransactions2 value) {
     ...
     * {@link CATotalsPerBankTransactionCode2 }
     * 
     * 
     */
    public List<CATotalsPerBankTransactionCode2> getTtlNtriesPerBkTxCd() {
        if (ttlNtriesPerBkTxCd == null) {
            ttlNtriesPerBkTxCd = new ArrayList<CATotalsPerBankTransactionCode2>();
        }
