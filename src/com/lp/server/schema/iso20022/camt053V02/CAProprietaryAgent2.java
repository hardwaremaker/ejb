...
/**
 * <p>Java-Klasse fuer ProprietaryAgent2 complex type.
 * 
...
public class CAProprietaryAgent2 {

    @XmlElement(name = "Tp", required = true)
    protected String tp;
    @XmlElement(name = "Agt", required = true)
    protected CABranchAndFinancialInstitutionIdentification4 agt;
     ...
     *     
     */
    public CABranchAndFinancialInstitutionIdentification4 getAgt() {
        return agt;
    }
     ...
     *     
     */
    public void setAgt(CABranchAndFinancialInstitutionIdentification4 value) {
        this.agt = value;
    }
