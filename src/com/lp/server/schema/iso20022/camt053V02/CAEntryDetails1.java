...
/**
 * <p>Java-Klasse fuer EntryDetails1 complex type.
 * 
...
public class CAEntryDetails1 {

    @XmlElement(name = "Btch")
    protected CABatchInformation2 btch;
    @XmlElement(name = "TxDtls")
    protected List<CAEntryTransaction2> txDtls;
     ...
     * {@link CAEntryTransaction2 }
     * 
     * 
     */
    public List<CAEntryTransaction2> getTxDtls() {
        if (txDtls == null) {
            txDtls = new ArrayList<CAEntryTransaction2>();
        }
        return this.txDtls;
    }
