...
@XmlEnum
public enum CATaxRecordPeriod1Code {
    ...
    CATaxRecordPeriod1Code(String v) {
        value = v;
    }
    ...
    public static CATaxRecordPeriod1Code fromValue(String v) {
        for (CATaxRecordPeriod1Code c: CATaxRecordPeriod1Code.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
