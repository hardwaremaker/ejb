...
public class CAReferredDocumentInformation3 {

    @XmlElement(name = "Tp")
    protected CAReferredDocumentType2 tp;
    @XmlElement(name = "Nb")
    protected String nb;
     ...
     * @return
     *     possible object is
     *     {@link CAReferredDocumentType2 }
     *     
     */
    public CAReferredDocumentType2 getTp() {
        return tp;
    }
     ...
     *     
     */
    public void setTp(CAReferredDocumentType2 value) {
        this.tp = value;
    }
