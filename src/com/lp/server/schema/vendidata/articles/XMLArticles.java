...
/**
 * <p>Java-Klasse fuer Articles complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="Article" type="{http://www.vendidata.com/XML/Schema/Articles}Article" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class XMLArticles {
    ...
    protected List<XMLArticle> article;
     ...
     * 
     */
    public List<XMLArticle> getArticle() {
        if (article == null) {
            article = new ArrayList<XMLArticle>();
        }
        return this.article;
    }
