...
import com.lp.server.anfrage.fastlanereader.generated.FLRAnfrageart;
import com.lp.server.anfrage.fastlanereader.generated.FLRAnfrageartspr;
 ...
 * @version 1.0
 */
public class AnfrageartHandler extends UseCaseHandler {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public static final String FLR_ANFRAGEART = "flranfrageart.";
	public static final String FLR_ANFRAGEART_FROM_CLAUSE = " from FLRAnfrageart flranfrageart ";
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				...
				Iterator<?> sprsetIterator = anfrageart
						.getAnfrageart_anfrageart_set().iterator();
	...
	private String findSpr(String sLocaleI, Iterator<?> iterUebersetzungenI) {
		...
		while (iterUebersetzungenI.hasNext()) {
			FLRAnfrageartspr anfrageart = (FLRAnfrageartspr) iterUebersetzungenI
					.next();
			if (anfrageart.getLocale().getC_nr().compareTo(sLocaleI) == 0) {
				sUebersetzung = anfrageart.getC_bez();
				break;
			}
		}
	...
	protected long getRowCountFromDataBase() {
		...
		try {
			...
			String queryString = "SELECT COUNT(*) FROM FLRAnfrageart AS anfrageart"
					+ " LEFT JOIN anfrageart.anfrageart_anfrageart_set AS anfrageart_anfrageart_set "
					+ buildWhereClause();
		...
		if (this.getQuery() != null && this.getQuery().getFilterBlock() != null
			...
			for (int i = 0; i < filterKriterien.length; i++) {
				if (filterKriterien[i].isKrit) {
					...
					filterAdded = true;
					where.append("anfrageart." + filterKriterien[i].kritName);
	...
	private String buildOrderByClause() {
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				...
				orderBy.append("anfrageart.i_sort ASC ");

				sortAdded = true;
			}
			if (orderBy.indexOf("anfrageart.i_sort") < 0) {
				...
				orderBy.append(" anfrageart.i_sort ");
				sortAdded = true;
			}
			if (sortAdded) {
	...
	private String getFromClause() {
		return " FROM FLRAnfrageart AS anfrageart"
				+ " LEFT JOIN anfrageart.anfrageart_anfrageart_set AS anfrageart_anfrageart_set";
	}
	...
	public TableInfo getTableInfo() {
		if (super.getTableInfo() == null) {
			setTableInfo(new TableInfo(new Class[] { String.class,
					...
					"anfrageart.c_nr", "anfrageart.c_nr", "anfrageart.i_sort",
					"anfrageart_anfrageart_set.c_bez" }));
		}
			...
			try {
				...
				if (scrollableResult != null) {
					...
					while (scrollableResult.next()) {
						FLRAnfrageart anfrageart = (FLRAnfrageart) scrollableResult
								.get(0);
