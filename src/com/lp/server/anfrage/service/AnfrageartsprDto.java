...
public class AnfrageartsprDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AnfrageartsprDto)) {
			return false;
		}
		AnfrageartsprDto that = (AnfrageartsprDto) obj;
		if (!(that.localeCNr == null ? this.localeCNr == null : that.localeCNr
				.equals(this.localeCNr))) {
			return false;
		}
		if (!(that.anfrageartCNr == null ? this.anfrageartCNr == null
				: that.anfrageartCNr.equals(this.anfrageartCNr))) {
			return false;
		}
	...
	public int hashCode() {
		...
		result = 37 * result + this.anfrageartCNr.hashCode();
