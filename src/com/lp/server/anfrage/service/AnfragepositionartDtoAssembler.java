...
public class AnfragepositionartDtoAssembler {
	public static AnfragepositionartDto createDto(
			Anfragepositionart anfragepositionart) {
		AnfragepositionartDto anfragepositionartDto = new AnfragepositionartDto();
		if (anfragepositionart != null) {
			anfragepositionartDto.setPositionsartCNr(anfragepositionart
					.getPositionsartCNr());
			anfragepositionartDto.setISort(anfragepositionart.getISort());
			anfragepositionartDto.setBVersteckt(anfragepositionart
					.getBVersteckt());
		}
		return anfragepositionartDto;
	}

	public static AnfragepositionartDto[] createDtos(
		...
		if (anfragepositionarts != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Anfragepositionart) iterator.next()));
			}
		}
