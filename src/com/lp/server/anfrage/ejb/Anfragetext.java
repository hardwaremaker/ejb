...
@NamedQueries( { @NamedQuery(name = "AnfragetextfindByMandantLocaleMediaartCNr", query = "SELECT OBJECT (o) FROM Anfragetext o WHERE o.mandantCNr=?1 AND o.localeCNr=?2 AND o.mediaartCNr=?3") })
@Entity
@Table(name = "ANF_ANFRAGETEXT")
public class Anfragetext implements Serializable {
	@Id
	@Column(name = "I_ID")
	private Integer iId;
	...
	public Anfragetext(Integer id, java.lang.String mandantCNr,
			java.lang.String localeCNr, java.lang.String mediaartCNr,
			java.lang.String textinhalt) {
		setIId(id);
	...
	public void setMediaartCNr(String mediaart) {
		this.mediaartCNr = mediaart;
	}
