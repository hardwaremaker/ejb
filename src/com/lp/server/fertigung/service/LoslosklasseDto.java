...
public class LoslosklasseDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof LoslosklasseDto))
			return false;
		LoslosklasseDto that = (LoslosklasseDto) obj;
		if (!(that.iId == null ? this.iId == null : that.iId.equals(this.iId)))
			return false;
		if (!(that.losIId == null ? this.losIId == null : that.losIId
				.equals(this.losIId)))
			return false;
		if (!(that.losklasseIId == null ? this.losklasseIId == null
				: that.losklasseIId.equals(this.losklasseIId)))
			return false;
	...
	public int hashCode() {
		...
		result = 37 * result + this.losklasseIId.hashCode();
