...
public class LoszusatzstatusDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof LoszusatzstatusDto))
			return false;
		LoszusatzstatusDto that = (LoszusatzstatusDto) obj;
		if (!(that.iId == null ? this.iId == null : that.iId.equals(this.iId)))
			return false;
		if (!(that.losIId == null ? this.losIId == null : that.losIId
				.equals(this.losIId)))
			return false;
		if (!(that.zusatzstatusIId == null ? this.zusatzstatusIId == null
				: that.zusatzstatusIId.equals(this.zusatzstatusIId)))
			return false;
	...
	public int hashCode() {
		...
		result = 37 * result + this.zusatzstatusIId.hashCode();
	...
	public String toString() {
		...
		returnStringBuffer.append("zusatzstatusIId:").append(zusatzstatusIId);
