...
public class ZusatzstatusDtoAssembler {
	public static ZusatzstatusDto createDto(Zusatzstatus zusatzstatus) {
		ZusatzstatusDto zusatzstatusDto = new ZusatzstatusDto();
