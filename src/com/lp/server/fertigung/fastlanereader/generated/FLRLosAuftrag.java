...
public class FLRLosAuftrag implements Serializable {
	...
	public FLRLosAuftrag(String mandant_c_nr, String c_nr, String status_c_nr,
			String c_projekt, Integer stueckliste_i_id, Date t_produktionsende,
			Date t_produktionsbeginn, Date t_ausgabe, Date t_erledigt,
			Date t_manuellerledigt, Date t_anlegen, Date t_produktionsstop,
			BigDecimal n_losgroesse, Double f_bewertung,
			Integer kostenstelle_i_id, Integer fertigungsgruppe_i_id,
			FLRStueckliste flrstueckliste, FLRKostenstelle flrkostenstelle,
			FLRAuftragposition flrauftragposition, FLRAuftragOD flrauftrag,
			FLRFertigungsgruppe flrfertigungsgruppe,
			FLRFertigungsgruppe flrwiederholendelose, Set<?> ablieferungset) {
