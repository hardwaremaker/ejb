 ...
 * @version 1.0
 */
public class LosklasseHandler extends UseCaseHandler {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final String FLR_LOSKLASSE = "flrlosklasse.";
	private static final String FLR_LOSKLASSE_FROM_CLAUSE = " from FLRLosklasse flrlosklasse ";
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				FLRLosklasse losklasse = (FLRLosklasse) resultListIterator
						.next();
				rows[row][col++] = losklasse.getI_id();
				rows[row][col++] = losklasse.getC_nr();
				String sBez = getFertigungServiceFac()
						.uebersetzeLosklasseOptimal(losklasse.getI_id(), locUI,
								locUI);
				if (sBez == null) {
					// keine Uebersetzung mit dem UI-Locale vorhanden
					LosklasseDto losklasseDto = getFertigungServiceFac()
							.losklasseFindByPrimaryKey(losklasse.getI_id(),
									theClientDto);
