...
@Embeddable
public class LosklassesprPK implements Serializable {
	@Column(name = "LOSKLASSE_I_ID", insertable = false, updatable = false)
	...
	public LosklassesprPK() {
		super();
	}

	public LosklassesprPK(Integer id, String locale) {
		setLosklasseIId(id);
		setLocaleCNr(locale);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof LosklassesprPK)) {
			return false;
		}
		LosklassesprPK other = (LosklassesprPK) o;
		return this.losklasseIId.equals(other.losklasseIId)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.losklasseIId.hashCode();
