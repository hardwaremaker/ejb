...
public class MagSearchCategoryResult implements Serializable {
	private static final long serialVersionUID = -6039054765022344541L;

	private List<MagCategory> items;
	private Integer totalCount;
	private Map<String, Object> searchCriteria;

	public List<MagCategory> getItems() {
		return items;
	}
	public void setItems(List<MagCategory> items) {
		this.items = items;
	}
