...
/**
 * The FastLaneReaders Hibernate session factory. This class provides access to
 * the database. Refer to Hibernat's documentation on how to use Sessions.
 * 
 * @author werner
 */
public class FLRSessionFactory {
