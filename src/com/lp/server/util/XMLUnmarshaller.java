...
public class XMLUnmarshaller<T> {
	...
	protected T unmarshal(String xmlContent, Class<T> clss) throws JAXBException, SAXException {
		return unmarshal(null, xmlContent, clss);
	}
	
	protected T unmarshal(String xsdSchema, String xmlContent, Class<T> clss) 
	...
	protected T unmarshal(JAXBContext jaxbContext, Schema schema,
