 ...
 */
public class BelegPositionDruckTextbausteinDto {
	private String sFreierText = null;
	...
	public String getSFreierText() {
		return sFreierText;
	}

	public void setOImage(BufferedImage oImage) {
		this.oImage = oImage;
	}

	public void setSFreierText(String sFreierText) {
		this.sFreierText = sFreierText;
	}
}
