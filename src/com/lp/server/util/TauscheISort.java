...
//				previousEntity == null ? null : ((IIId)previousEntity).getIId(), searchId) ;
	...
	/**
	 * Standard-Neunummerierung ISort Value mit 1000er-Schrittweite.
	 */
	...
	/**
	 * Neunummerierung ISort Value mit frei w&auml;hlbarer Schrittweite.
	 *
	 * @param incr Schrittweite
	 */
	public void renumber(Integer incr) {
