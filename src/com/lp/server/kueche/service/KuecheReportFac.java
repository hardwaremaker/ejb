...
@Remote
public interface KuecheReportFac {

	public final static String REPORT_MODUL = "kueche";

	public final static String REPORT_KUECHENAUSWERTUNG1 = "kue_kuechenauswertung1.jasper";
	public final static String REPORT_KUECHENAUSWERTUNG2 = "kue_kuechenauswertung2.jasper";
	public final static String REPORT_DECKUNGSBEITRAG = "kue_deckungsbeitrag.jasper";

	public JasperPrintLP printKuechenauswertung1(java.sql.Timestamp tVon,
			java.sql.Timestamp tBis, String artikelNrVon,
