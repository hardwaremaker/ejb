...
public class LieferscheinDtoAssembler {
	public static LieferscheinDto createDto(Lieferschein lieferschein) {
		...
		if (lieferschein != null) {
			...
			lieferscheinDto.setCVersandnummer2(lieferschein.getCVersandnummer2());
			...
			lieferscheinDto.setIKommissioniertyp(lieferschein.getIKommissioniertyp());
			lieferscheinDto.setLaenderartCnr(lieferschein.getLaenderartCnr());
			lieferscheinDto.setXInternerkommentar(lieferschein.getXInternerkommentar());
		}
