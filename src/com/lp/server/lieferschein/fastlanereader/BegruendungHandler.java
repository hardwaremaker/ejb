...
public class BegruendungHandler extends UseCaseHandler {
	...
	protected long getRowCountFromDataBase() {
		...
		try {
			...
			String queryString = "SELECT COUNT(*) FROM FLRBegruendung AS begruendung "
					+ buildWhereClause();
	...
	private String getFromClause() {
		return " FROM FLRBegruendung AS begruendung ";
	}
			...
			try {
				...
				if (scrollableResult != null) {
					...
					while (scrollableResult.next()) {
						FLRBegruendung lieferscheinart = (FLRBegruendung) scrollableResult
								.get(0);
