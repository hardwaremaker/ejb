...
public class FLRLieferscheintextsuche implements Serializable {
	...
	/** full constructor */
	public FLRLieferscheintextsuche(String c_typ, String c_nr, String c_suche) {
		this.c_typ = c_typ;
		this.c_nr = c_nr;
	...
	/** default constructor */
	public FLRLieferscheintextsuche() {
	}
