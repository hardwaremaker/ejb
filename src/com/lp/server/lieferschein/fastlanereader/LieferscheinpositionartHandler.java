...
import com.lp.server.lieferschein.fastlanereader.generated.FLRLieferscheinpositionart;
...
/**
 * <p>
 * <I>FLR fuer LS_LIEFERSCHEINPOSITIONART.</I>
 * </p>
 * 
 * <p>
 ...
 * @version 1.0
 */
public class LieferscheinpositionartHandler extends UseCaseHandler {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public static final String FLR_LIEFERSCHEINPOSITIONART = "flrlieferscheinpositionart.";
	public static final String FLR_LIEFERSCHEINPOSITIONART_FROM_CLAUSE = " from FLRLieferscheinpositionart flrlieferscheinpositionart ";
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				FLRLieferscheinpositionart positionart = (FLRLieferscheinpositionart) resultListIterator
						.next();
		...
		if (this.getQuery() != null && this.getQuery().getFilterBlock() != null
			...
			for (int i = 0; i < filterKriterien.length; i++) {
				if (filterKriterien[i].isKrit) {
					...
					filterAdded = true;
					where.append(" " + FLR_LIEFERSCHEINPOSITIONART
			...
			if (kriterien != null && kriterien.length > 0) {
				for (int i = 0; i < kriterien.length; i++) {
					if (kriterien[i].isKrit) {
						...
						sortAdded = true;
						orderBy.append(FLR_LIEFERSCHEINPOSITIONART
				...
				orderBy.append(FLR_LIEFERSCHEINPOSITIONART).append("i_sort")
						.append(" ASC ");
				sortAdded = true;
			}
			if (orderBy.indexOf(FLR_LIEFERSCHEINPOSITIONART + "i_sort") < 0) {
				...
				orderBy.append(" ").append(FLR_LIEFERSCHEINPOSITIONART).append(
						"i_sort").append(" ");
				sortAdded = true;
			}
			if (sortAdded) {
	...
	private String getFromClause() {
		return FLR_LIEFERSCHEINPOSITIONART_FROM_CLAUSE;
	}
	...
	public TableInfo getTableInfo() {
		if (super.getTableInfo() == null) {
			...
			setTableInfo(new TableInfo(
					...
					new String[] {
							LieferscheinServiceFac.FLR_LIEFERSCHEINPOSITIONART_POSITIONSART_C_NR,
		...
		if (selectedId != null) {
			...
			try {
				...
				String queryString = "select "
						+ FLR_LIEFERSCHEINPOSITIONART
						+ LieferscheinServiceFac.FLR_LIEFERSCHEINPOSITIONART_POSITIONSART_C_NR
						+ FLR_LIEFERSCHEINPOSITIONART_FROM_CLAUSE
