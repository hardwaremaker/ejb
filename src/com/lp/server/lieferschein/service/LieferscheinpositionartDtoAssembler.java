...
public class LieferscheinpositionartDtoAssembler {
	public static LieferscheinpositionartDto createDto(
			Lieferscheinpositionart lieferscheinpositionart) {
		LieferscheinpositionartDto lieferscheinpositionartDto = new LieferscheinpositionartDto();
		if (lieferscheinpositionart != null) {
			lieferscheinpositionartDto
					.setPositionsartCNr(lieferscheinpositionart
							.getPositionsartCNr());
			lieferscheinpositionartDto.setISort(lieferscheinpositionart
					.getISort());
			lieferscheinpositionartDto.setBVersteckt(lieferscheinpositionart
					.getBVersteckt());
		}
		return lieferscheinpositionartDto;
	}

	public static LieferscheinpositionartDto[] createDtos(
		...
		if (lieferscheinpositionarts != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Lieferscheinpositionart) iterator.next()));
			}
		}
