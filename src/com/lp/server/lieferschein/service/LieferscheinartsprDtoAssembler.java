...
public class LieferscheinartsprDtoAssembler {
	public static LieferscheinartsprDto createDto(
			Lieferscheinartspr lieferscheinartspr) {
		LieferscheinartsprDto lieferscheinartsprDto = new LieferscheinartsprDto();
		if (lieferscheinartspr != null) {
			lieferscheinartsprDto.setLocaleCNr(lieferscheinartspr
					.getLocaleCNr());
			lieferscheinartsprDto.setLieferscheinartCNr(lieferscheinartspr
					.getLieferscheinartCNr());
			lieferscheinartsprDto.setCBez(lieferscheinartspr.getCBez());
		}
		return lieferscheinartsprDto;
	}

	public static LieferscheinartsprDto[] createDtos(
		...
		if (lieferscheinartsprs != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Lieferscheinartspr) iterator.next()));
			}
		}
