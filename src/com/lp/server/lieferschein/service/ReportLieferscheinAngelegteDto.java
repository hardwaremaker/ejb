...
public class ReportLieferscheinAngelegteDto implements Serializable {
	/**
	 * 
	 */
	...
	private String personalanlegenKurzzeichen;
	private Date tAnlegen;
	...
	public String getPersonalanlegenKurzzeichen() {
		return this.personalanlegenKurzzeichen;
	}

	public void setPersonalanlegenKurzzeichen(String personalanlegenKurzzeichenI) {
		this.personalanlegenKurzzeichen = personalanlegenKurzzeichenI;
	}

	public Date getTAnlegen() {
		return this.tAnlegen;
	}

	public void setTAnlegen(Date tAnlegenI) {
