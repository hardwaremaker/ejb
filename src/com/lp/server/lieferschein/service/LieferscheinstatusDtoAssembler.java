...
public class LieferscheinstatusDtoAssembler {
	public static LieferscheinstatusDto createDto(
			Lieferscheinstatus lieferscheinstatus) {
		LieferscheinstatusDto lieferscheinstatusDto = new LieferscheinstatusDto();
		if (lieferscheinstatus != null) {
			lieferscheinstatusDto.setStatusCNr(lieferscheinstatus
					.getStatusCNr());
			lieferscheinstatusDto.setISort(lieferscheinstatus.getISort());
		}
		return lieferscheinstatusDto;
	}

	public static LieferscheinstatusDto[] createDtos(
		...
		if (lieferscheinstatuss != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Lieferscheinstatus) iterator.next()));
			}
		}
