...
@Embeddable
public class ProjekttypPK implements Serializable {
	...
	public ProjekttypPK(String cNr, String mandantCNr) {
		setCNr(cNr);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ProjekttypPK)) {
			return false;
		}
		ProjekttypPK other = (ProjekttypPK) o;
