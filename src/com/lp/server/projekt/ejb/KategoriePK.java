...
@Embeddable
public class KategoriePK implements Serializable {
	...
	public KategoriePK(String cNr, String mandantCNr) {
		setCNr(cNr);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof KategoriePK)) {
			return false;
		}
		KategoriePK other = (KategoriePK) o;
