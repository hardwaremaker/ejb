...
@Embeddable
public class VkfortschrittsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "VKFORTSCHRITT_I_ID", insertable = false, updatable = false)
	...
	public VkfortschrittsprPK(String locUiAsString, Integer vkfortschrittIId) {
		setLocaleCNr(locUiAsString);
		setVkfortschrittIId(vkfortschrittIId);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof VkfortschrittsprPK)) {
			return false;
		}
		VkfortschrittsprPK other = (VkfortschrittsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.vkfortschrittIId.equals(other.vkfortschrittIId);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.vkfortschrittIId.hashCode();
		return hash;
	}
