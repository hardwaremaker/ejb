...
@Embeddable
public class ProjektstatusPK implements Serializable {
	public ProjektstatusPK() {
	...
	public ProjektstatusPK(String cNr, String mandantCNr) {
		setCNr(cNr);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ProjektstatusPK)) {
			return false;
		}
		ProjektstatusPK other = (ProjektstatusPK) o;
