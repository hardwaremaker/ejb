...
public class KategoriesprDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof KategoriesprDto))
			return false;
		KategoriesprDto that = (KategoriesprDto) obj;
	...
	public String toString() {
		...
		returnStringBuffer.append("projektkategorieCNr:").append(kategorieCNr);
