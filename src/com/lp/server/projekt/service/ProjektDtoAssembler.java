...
public class ProjektDtoAssembler {
	public static ProjektDto createDto(Projekt projekt) {
		...
		if (projekt != null) {
			...
			projektDto.setBVerrechenbar(projekt.getBVerrechenbar());
			...
			projektDto.setProjekterledigungsgrundIId(projekt.getProjekterledigungsgrundIId());
			projektDto.setBereichIId(projekt.getBereichIId());
			projektDto.setProjektIIdNachfolger(projekt.getProjektIIdNachfolger());
			projektDto.setTInternerledigt(projekt.getTInternerledigt());
			projektDto.setPersonalIIdInternerledigt(projekt.getPersonalIIdInternerledigt());
