...
public class ProjekttypsprDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof ProjekttypsprDto))
			return false;
		ProjekttypsprDto that = (ProjekttypsprDto) obj;
		if (!(that.typCNr == null ? this.typCNr == null : that.typCNr
				.equals(this.typCNr)))
			return false;
	...
	public int hashCode() {
		int result = 17;
		result = 37 * result + this.typCNr.hashCode();
	...
	public String toString() {
		...
		returnStringBuffer.append("typCNr:").append(typCNr);
		returnStringBuffer.append("localeCNr:").append(localeCNr);
