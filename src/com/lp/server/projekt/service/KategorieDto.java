...
public class KategorieDto implements Serializable {
	...
	private KategoriesprDto kategoriesprDto;

	public KategoriesprDto getKategoriesprDto() {
		return kategoriesprDto;
	}

	public void setKategoriesprDto(KategoriesprDto kategoriesprDtoI) {
		kategoriesprDto = kategoriesprDtoI;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof KategorieDto)) {
			return false;
		}
		KategorieDto that = (KategorieDto) obj;
