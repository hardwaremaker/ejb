...
public class FLRTypPK implements Serializable {
    ...
    /** full constructor */
    public FLRTypPK(String c_nr, String mandant_c_nr) {
        this.c_nr = c_nr;
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof FLRTypPK) ) return false;
        FLRTypPK castOther = (FLRTypPK) other;
