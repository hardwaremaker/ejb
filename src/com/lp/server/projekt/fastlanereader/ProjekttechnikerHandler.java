 ...
 * @version 1.0
 */
public class ProjekttechnikerHandler extends UseCaseHandler {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final String FLR_PROJKTTECHNIKER = "flrprojekttechniker.";
	private static final String FLR_PROJEKTTECHNIKER_FROM_CLAUSE = " from FLRProjekttechniker flrprojekttechniker ";
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				FLRProjekttechniker losab = (FLRProjekttechniker) resultListIterator
						.next();
		...
		if (this.getQuery() != null && this.getQuery().getFilterBlock() != null
			...
			for (int i = 0; i < filterKriterien.length; i++) {
				if (filterKriterien[i].isKrit) {
					...
					filterAdded = true;
					where.append(" " + FLR_PROJKTTECHNIKER
	...
	private String buildOrderByClause() {
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				for (int i = 0; i < kriterien.length; i++) {
					if (kriterien[i].isKrit) {
						...
						sortAdded = true;
						orderBy.append(FLR_PROJKTTECHNIKER
			...
			if (orderBy.indexOf(FLR_PROJKTTECHNIKER
				...
				orderBy.append(" ").append(FLR_PROJKTTECHNIKER)
	...
	private String getFromClause() {
		return FLR_PROJEKTTECHNIKER_FROM_CLAUSE;
	}
	...
	public QueryResult sort(SortierKriterium[] sortierKriterien,
		...
		if (selectedId != null && ((Integer) selectedId).intValue() >= 0) {
			...
			try {
				session = factory.openSession();
				String queryString = "select " + FLR_PROJKTTECHNIKER
						+ FertigungFac.FLR_LOSKLASSE_I_ID
						+ FLR_PROJEKTTECHNIKER_FROM_CLAUSE
	...
	public TableInfo getTableInfo() {
		if (super.getTableInfo() == null) {
			...
			setTableInfo(new TableInfo(
					...
					new String[] {
							"i_id",
							ProjektServiceFac.FLR_PROJEKTTECHNIKER_FLRPERSONAL
									+ "."
