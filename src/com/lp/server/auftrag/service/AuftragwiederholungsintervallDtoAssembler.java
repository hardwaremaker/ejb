...
public class AuftragwiederholungsintervallDtoAssembler {
	public static AuftragwiederholungsintervallDto createDto(
			Auftragwiederholungsintervall auftragwiederholungsintervall) {
		AuftragwiederholungsintervallDto auftragwiederholungsintervallDto = new AuftragwiederholungsintervallDto();
		if (auftragwiederholungsintervall != null) {
			auftragwiederholungsintervallDto
					.setCNr(auftragwiederholungsintervall.getCNr());
			auftragwiederholungsintervallDto
					.setISort(auftragwiederholungsintervall.getISort());
		}
		return auftragwiederholungsintervallDto;
	}

	public static AuftragwiederholungsintervallDto[] createDtos(
		...
		if (auftragwiederholungsintervalls != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Auftragwiederholungsintervall) iterator
						.next()));
			}
		}
