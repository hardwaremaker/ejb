...
public class AuftragpositionstatusDtoAssembler {
	public static AuftragpositionstatusDto createDto(
			Auftragpositionstatus auftragpositionstatus) {
		AuftragpositionstatusDto auftragpositionstatusDto = new AuftragpositionstatusDto();
		if (auftragpositionstatus != null) {
			auftragpositionstatusDto.setStatusCNr(auftragpositionstatus
					.getStatusCNr());
			auftragpositionstatusDto.setISort(auftragpositionstatus.getISort());
		}
		return auftragpositionstatusDto;
	}

	public static AuftragpositionstatusDto[] createDtos(
		...
		if (auftragpositionstatuss != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Auftragpositionstatus) iterator.next()));
			}
		}
