...
public class AuftragQueryResult extends QueryResult {
	private static final long serialVersionUID = -7256497224798238903L;
	private List<IAddressContact> addresses = new ArrayList<IAddressContact>() ;
	private IAuftragFLRData[] flrData = null ;
	
	public AuftragQueryResult(Object[][] rowData, long rowCount, long indexOfFirstRow,
			long indexOfLastRow, long indexOfSelectedRow) {
		super(rowData, rowCount, indexOfFirstRow, indexOfLastRow, indexOfSelectedRow) ;
	}
	
	public void setAddresses(List<IAddressContact> addresses) {
	...
	public void setFlrData(IAuftragFLRData[] additionalFlrData) {
