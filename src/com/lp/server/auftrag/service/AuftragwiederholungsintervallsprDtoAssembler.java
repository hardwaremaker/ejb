...
public class AuftragwiederholungsintervallsprDtoAssembler {
	public static AuftragwiederholungsintervallsprDto createDto(
			Auftragwiederholungsintervallspr auftragwiederholungsintervallspr) {
		AuftragwiederholungsintervallsprDto auftragwiederholungsintervallsprDto = new AuftragwiederholungsintervallsprDto();
		if (auftragwiederholungsintervallspr != null) {
			auftragwiederholungsintervallsprDto
					.setLocaleCNr(auftragwiederholungsintervallspr.getPk()
							.getLocaleCNr());
			auftragwiederholungsintervallsprDto
					.setAuftragwiederholungsintervallCNr(auftragwiederholungsintervallspr.getPk()
							.getAuftragwiederholungsintervallCNr());
			auftragwiederholungsintervallsprDto
					.setCBez(auftragwiederholungsintervallspr.getCBez());
		}
		return auftragwiederholungsintervallsprDto;
	}

	public static AuftragwiederholungsintervallsprDto[] createDtos(
		...
		if (auftragwiederholungsintervallsprs != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Auftragwiederholungsintervallspr) iterator
						.next()));
			}
		}
