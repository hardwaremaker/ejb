...
@NamedQueries( { @NamedQuery(name = "AuftragStatusfindAll", query = "SELECT OBJECT (o) FROM Auftragstatus o") })
@Entity
@Table(name = "AUFT_AUFTRAGSTATUS")
public class Auftragstatus implements Serializable {
	...
	public Auftragstatus(String statusCNr, Integer iSort) {
