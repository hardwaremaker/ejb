...
@Embeddable
public class MeilensteinsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "MEILENSTEIN_I_ID", insertable = false, updatable = false)
	...
	public MeilensteinsprPK(String locUiAsString, Integer meilensteinIId) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof MeilensteinsprPK)) {
			return false;
		}
		MeilensteinsprPK other = (MeilensteinsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.meilensteinIId
						.equals(other.meilensteinIId);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.meilensteinIId.hashCode();
		return hash;
	}
