...
@Embeddable
public class AuftragartsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "AUFTRAGART_C_NR", insertable = false, updatable = false)
	private String auftragartCNr;

	private static final long serialVersionUID = 1L;

	public AuftragartsprPK(String localeCNr, String auftragartCNr) {
		setLocaleCNr(localeCNr);
		setAuftragartCNr(auftragartCNr);
	}

	public AuftragartsprPK() {
		super();
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof AuftragartsprPK)) {
			return false;
		}
		AuftragartsprPK other = (AuftragartsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.auftragartCNr.equals(other.auftragartCNr);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.auftragartCNr.hashCode();
		return hash;
	}
