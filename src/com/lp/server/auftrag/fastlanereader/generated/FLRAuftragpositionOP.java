...
public class FLRAuftragpositionOP implements Serializable {
	...
	public FLRAuftragpositionOP(
			Integer i_sort,
			String auftragpositionart_c_nr,
			String auftragpositionstatus_c_nr,
			BigDecimal n_menge,
			String c_bez,
			String c_zbez,
			BigDecimal n_offenemenge,
			BigDecimal n_offenerahmenmenge,
			String einheit_c_nr,
			Integer artikel_i_id,
			Date t_uebersteuerterliefertermin,
			BigDecimal n_nettogesamtpreisplusversteckteraufschlagminusrabatte,
			Integer position_i_id,
			String typ_c_nr,
			FLRArtikel flrartikel,
			FLRStklAuftragposition flrstueckliste,
			com.lp.server.auftrag.fastlanereader.generated.FLRAuftragOD flrauftrag) {
		this.i_sort = i_sort;
	...
	public void setT_uebersteuerterliefertermin(
			Date t_uebersteuerterliefertermin) {
		this.t_uebersteuerterliefertermin = t_uebersteuerterliefertermin;
	}
