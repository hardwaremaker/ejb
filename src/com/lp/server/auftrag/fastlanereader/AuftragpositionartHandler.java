...
import com.lp.server.auftrag.fastlanereader.generated.FLRAuftragpositionart;
...
/**
 * <p>
 * <I>FLR fuer AUFT_AUFTRAGPOSITIONART.</I>
 * </p>
 * 
 * <p>
 ...
 * @version 1.0
 */
public class AuftragpositionartHandler extends UseCaseHandler {
		...
		if (this.getQuery() != null && this.getQuery().getFilterBlock() != null
			...
			for (int i = 0; i < filterKriterien.length; i++) {
				if (filterKriterien[i].isKrit) {
					...
					filterAdded = true;
					where.append(" " + FLR_AUFTRAGPOSITIONART
	...
	private String getFromClause() {
		return FLR_AUFTRAGPOSITIONART_FROM_CLAUSE
				+ " LEFT JOIN "
				+ FLR_AUFTRAGPOSITIONART
		...
		if (selectedId != null) {
			...
			try {
				...
				String queryString = "select "
						+ FLR_AUFTRAGPOSITIONART
						+ AuftragServiceFac.FLR_AUFTRAGPOSITIONART_POSITIONSART_C_NR
						+ FLR_AUFTRAGPOSITIONART_FROM_CLAUSE
