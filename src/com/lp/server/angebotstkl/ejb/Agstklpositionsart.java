...
@NamedQueries( { @NamedQuery(name = "AgstklpositionsartfindAll", query = "SELECT OBJECT(o) FROM Agstklpositionsart o ORDER BY o.iSort ASC") })
@Entity
@Table(name = "AS_AGSTKLPOSITIONSART")
public class Agstklpositionsart implements Serializable {
	@Id
	...
	public Agstklpositionsart() {
		super();
	}

	public Agstklpositionsart(String positionsartCNr, Integer sort) {
