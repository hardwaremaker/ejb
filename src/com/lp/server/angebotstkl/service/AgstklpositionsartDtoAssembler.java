...
public class AgstklpositionsartDtoAssembler {
	public static AgstklpositionsartDto createDto(
			Agstklpositionsart agstklpositionsart) {
		AgstklpositionsartDto agstklpositionsartDto = new AgstklpositionsartDto();
		if (agstklpositionsart != null) {
			agstklpositionsartDto.setPositionsartCNr(agstklpositionsart
					.getPositionsartCNr());
			agstklpositionsartDto.setISort(agstklpositionsart.getISort());
		}
		return agstklpositionsartDto;
	}

	public static AgstklpositionsartDto[] createDtos(
		...
		if (agstklpositionsarts != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Agstklpositionsart) iterator.next()));
			}
		}
