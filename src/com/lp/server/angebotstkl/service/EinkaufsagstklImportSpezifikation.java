...
public class EinkaufsagstklImportSpezifikation extends
		StklImportSpezifikation {

	public EinkaufsagstklImportSpezifikation() {
		super();
	}
	...
	public String getKeyValueCGruppe() {
		return StklImportSpezifikation.getKeyValueCGruppeByStklTyp(SpezifikationsTyp.EINKAUFSANGEBOTSSTKL_SPEZ);
	}
