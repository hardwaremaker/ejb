...
public class BestellpositionDtoAssembler {
	public static BestellpositionDto createDto(Bestellposition bestellposition) {
		...
		if (bestellposition != null) {
			bestellpositionDto.setUsecaseIIdQuelle(QueryParameters.UC_ID_BESTELLPOSITION);
			...
			bestellpositionDto.setBNettopreisuebersteuert(bestellposition
			...
			bestellpositionDto.setPersonalIIdAbterminAendern(bestellposition
					.getPersonalIIdAbterminAendern());
			bestellpositionDto.setTAbterminAendern(bestellposition
					.getTAbterminAendern());
			bestellpositionDto.setTAbursprungstermin(bestellposition
					.getTAbursprungstermin());
			bestellpositionDto.setCAngebotnummer(bestellposition
					.getCAngebotnummer());
			bestellpositionDto.setNMaterialzuschlag(bestellposition
					.getNMaterialzuschlag());
			bestellpositionDto.setTLieferterminbestaetigt(bestellposition
					.getTLieferterminbestaetigt());
			bestellpositionDto
					.setPersonalIIdLieferterminbestaetigt(bestellposition
							.getPersonalIIdLieferterminbestaetigt());
			bestellpositionDto.setLossollmaterialIId(bestellposition
					.getLossollmaterialIId());
			bestellpositionDto.setPositioniIdArtikelset(bestellposition
					.getPositionIIdArtikelset());

			bestellpositionDto.setGebindeIId(bestellposition.getGebindeIId());
			bestellpositionDto.setNAnzahlgebinde(bestellposition
					.getNAnzahlgebinde());
			bestellpositionDto.setBWepinfoAnAnforderer(bestellposition.getBWepinfoAnAnforderer());
			bestellpositionDto.setTAbBelegdatum(bestellposition.getTAbBelegdatum());
		}
