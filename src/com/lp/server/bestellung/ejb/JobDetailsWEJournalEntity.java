...
@NamedQueries( { 
	@NamedQuery(name = JobDetailsFac.AutoWEJournalfindByMandantCNr, query = "SELECT OBJECT (o) FROM JobDetailsWEJournalEntity o WHERE o.mandantCNr=?1") 
})

@Entity
@Table(name = "AUTO_WEJOURNAL")
public class JobDetailsWEJournalEntity extends JobDetailsEntity {
	private static final long serialVersionUID = 6802810662448667458L;
