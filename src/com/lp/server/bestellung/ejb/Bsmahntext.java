...
@NamedQueries( { @NamedQuery(name = "BSMahntextfindByMandantLocaleCNr", query = "SELECT OBJECT (o) FROM Bsmahntext o WHERE o.mandantCNr=?1 AND o.localeCNr=?2 AND o.mahnstufeIId=?3") })
@Entity
@Table(name = "BES_BSMAHNTEXT")
public class Bsmahntext implements Serializable {
	@Id
	@Column(name = "I_ID")
	private Integer iId;
	...
	public Bsmahntext(Integer id, String mandantCNr, String localeCNr,
