...
@NamedQueries( {
		@NamedQuery(name = "BestellpositionartfindAll", query = "SELECT OBJECT (o) FROM Bestellpositionart o ORDER BY o.iSort ASC"),
		@NamedQuery(name = "BestellpositionartfindAllEnable", query = "SELECT OBJECT (o) FROM Bestellpositionart o WHERE o.bVersteckt=0 ORDER BY o.iSort ASC") })
@Entity
@Table(name = "BES_BESTELLPOSITIONART")
public class Bestellpositionart implements Serializable {
	@Id
	...
	public Bestellpositionart() {
		super();
	}

	public Bestellpositionart(String positionsartCNr, Integer sort,
			Short versteckt) {
