...
@NamedQueries( { @NamedQuery(name = "BestellungtextfindByMandantLocaleCNr", query = "SELECT OBJECT (o) FROM Bestellungtext o WHERE o.mandantCNr=?1 AND o.localeCNr=?2 AND o.cNr=?3") })
@Entity
@Table(name = "BES_BESTELLUNGTEXT")
public class Bestellungtext implements Serializable {
	@Id
	@Column(name = "I_ID")
	private Integer iId;
	...
	public Bestellungtext() {
		super();
	}

	public Bestellungtext(Integer id, String mandantCNr, String localeCNr,
