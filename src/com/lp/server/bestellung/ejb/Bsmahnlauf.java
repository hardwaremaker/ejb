...
@NamedQueries( { @NamedQuery(name = "BSMahnlauffindByMandantCNr", query = "SELECT OBJECT(o) FROM Bsmahnlauf o WHERE o.mandantCNr=?1") })
@Entity
@Table(name = "BES_BSMAHNLAUF")
public class Bsmahnlauf implements Serializable {
	@Id
	@Column(name = "I_ID")
	private Integer iId;
