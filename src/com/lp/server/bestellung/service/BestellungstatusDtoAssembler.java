...
public class BestellungstatusDtoAssembler {
	public static BestellungstatusDto createDto(
			Bestellungstatus bestellungstatus) {
		BestellungstatusDto bestellungstatusDto = new BestellungstatusDto();
		if (bestellungstatus != null) {
			bestellungstatusDto.setStatusCNr(bestellungstatus.getStatusCNr());
			bestellungstatusDto.setISort(bestellungstatus.getISort());
		}
		return bestellungstatusDto;
	}

	public static BestellungstatusDto[] createDtos(Collection<?> bestellungstatuss) {
		...
		if (bestellungstatuss != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Bestellungstatus) iterator.next()));
			}
		}
