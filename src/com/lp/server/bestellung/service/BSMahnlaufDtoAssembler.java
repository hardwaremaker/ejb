...
public class BSMahnlaufDtoAssembler {
	public static BSMahnlaufDto createDto(Bsmahnlauf bSMahnlauf) {
		BSMahnlaufDto bSMahnlaufDto = new BSMahnlaufDto();
		if (bSMahnlauf != null) {
			bSMahnlaufDto.setIId(bSMahnlauf.getIId());
			bSMahnlaufDto.setMandantCNr(bSMahnlauf.getMandantCNr());
			bSMahnlaufDto.setPersonalIIdAnlegen(bSMahnlauf
					.getPersonalIIdAnlegen());
			bSMahnlaufDto.setPersonalIIdAendern(bSMahnlauf
	...
	public static BSMahnlaufDto[] createDtos(Collection<?> bSMahnlaufs) {
		List<BSMahnlaufDto> list = new ArrayList<BSMahnlaufDto>();
		if (bSMahnlaufs != null) {
			Iterator<?> iterator = bSMahnlaufs.iterator();
			while (iterator.hasNext()) {
				list.add(createDto((Bsmahnlauf) iterator.next()));
			}
		}
