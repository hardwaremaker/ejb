...
public class NichtMehrBenoetigteBestellungenHandler extends UseCaseHandler {
	...
	private String buildOrderByClause() {
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				...
				orderBy.append("wareneingang.").append(
						WareneingangFac.FLR_WE_I_SORT) // vorher wurde nach i_id
						// geordnet
						.append(" ASC ");
				sortAdded = true;
			}
			if (orderBy
				...
				orderBy.append(" wareneingang.").append(
						WareneingangFac.FLR_WE_I_SORT).append(" ");
				sortAdded = true;
			}
			if (sortAdded) {
			...
			setTableInfo(new TableInfo(new Class[] { Integer.class,
					...
					new String[] {
							...
							getTextRespectUISpr("bes.lieferscheinnr",
									mandantCNr, locUI),
							getTextRespectUISpr("bes.lfdatum", mandantCNr,
									locUI),
							getTextRespectUISpr("bes.transportkosten",
									mandantCNr, locUI),
							getTextRespectUISpr("bes.gemeinkostenfaktor",
									mandantCNr, locUI),
							getTextRespectUISpr("bes.wedatum", mandantCNr,
									locUI) }, new int[] {
							-1, // id
