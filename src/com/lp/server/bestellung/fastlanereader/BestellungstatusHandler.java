...
import com.lp.server.bestellung.fastlanereader.generated.FLRBestellungstatus;
 ...
 * @version 1.0
 */
public class BestellungstatusHandler extends UseCaseHandler {
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				FLRBestellungstatus position = (FLRBestellungstatus) resultListIterator
						.next();
	...
	private String buildOrderByClause() {
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				...
				orderBy.append("position.").append("i_sort").append(" ASC ");
				sortAdded = true;
			}
			if (orderBy.indexOf("position.i_sort") < 0) {
				...
				orderBy.append(" position.").append("i_sort").append(" ");
				sortAdded = true;
			}
			if (sortAdded) {
	...
	private String getFromClause() {
		return "from FLRBestellungstatus position ";
	}
	...
	public QueryResult sort(SortierKriterium[] sortierKriterien,
		...
		if (selectedId != null) {
			...
			try {
				session = factory.openSession();
				String queryString = "select position.i_sort from FLRBestellungstatus position "
				...
				if (scrollableResult != null) {
					...
					while (scrollableResult.next()) {
						// String s_id = (String) scrollableResult.getString(0);
