...
public class FLRBestellungtextsuche implements Serializable {
	...
	/** full constructor */
	public FLRBestellungtextsuche(String c_typ, String c_nr, String c_suche) {
		this.c_typ = c_typ;
		this.c_nr = c_nr;
