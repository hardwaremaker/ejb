...
public class ArtikelkommentarDtoAssembler {
	public static ArtikelkommentarDto createDto(
			Artikelkommentar artikelkommentar) {
		ArtikelkommentarDto artikelkommentarDto = new ArtikelkommentarDto();
		if (artikelkommentar != null) {
			artikelkommentarDto.setIId(artikelkommentar.getIId());
			artikelkommentarDto.setArtikelIId(artikelkommentar.getArtikelIId());
			artikelkommentarDto.setArtikelkommentarartIId(artikelkommentar
					.getArtikelkommentarartIId());
			artikelkommentarDto.setDatenformatCNr(artikelkommentar
					.getDatenformatCNr());
			artikelkommentarDto.setBDefaultbild(artikelkommentar
					.getBDefaultbild());
	...
	public static ArtikelkommentarDto[] createDtos(Collection<?> artikelkommentars) {
		...
		if (artikelkommentars != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Artikelkommentar) iterator.next()));
			}
		}
