...
public class ArtikelkommentarartDtoAssembler {
	public static ArtikelkommentarartDto createDto(
		...
		if (artikelkommentarart != null) {
			artikelkommentarartDto.setIId(artikelkommentarart.getIId());
			artikelkommentarartDto.setCNr(artikelkommentarart.getCNr());
			artikelkommentarartDto.setBrancheId(artikelkommentarart
					.getBrancheId());
			artikelkommentarartDto.setBWebshop(artikelkommentarart
					.getBWebshop());
	...
	public static ArtikelkommentarartDto[] createDtos(
		...
		if (artikelkommentararts != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Artikelkommentarart) iterator.next()));
			}
		}
