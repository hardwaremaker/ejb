...
public class InvenurlisteImportDto implements Serializable {
	/**
	 * 
	 */
	...
	public String getCInventurmenge() {
		return cInventurmenge;
	}
	public void setCInventurmenge(String cInventurmenge) {
