...
public class LagerzugangursprungDtoAssembler {
	public static LagerzugangursprungDto createDto(
			Lagerzugangursprung lagerzugangursprung) {
		LagerzugangursprungDto lagerzugangursprungDto = new LagerzugangursprungDto();
		if (lagerzugangursprung != null) {
			lagerzugangursprungDto.setILagerbewegungid(lagerzugangursprung
					.getPk().getILagerbewegungid());
			lagerzugangursprungDto
					.setILagerbewegungidursprung(lagerzugangursprung.getPk()
							.getILagerbewegungidursprung());
		}
		return lagerzugangursprungDto;
	}

	public static LagerzugangursprungDto[] createDtos(
		...
		if (lagerzugangursprungs != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Lagerzugangursprung) iterator.next()));
			}
		}
