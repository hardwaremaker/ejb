...
public class ArtikellagerDtoAssembler {
	public static ArtikellagerDto createDto(Artikellager artikellager) {
		ArtikellagerDto artikellagerDto = new ArtikellagerDto();
		if (artikellager != null) {
			artikellagerDto.setArtikelIId(artikellager.getPk().getArtikelIId());
			artikellagerDto.setLagerIId(artikellager.getPk().getLagerIId());
			artikellagerDto.setNGestehungspreis(artikellager
					.getNGestehungspreis());
