...
public class ArtikelkommentardruckDtoAssembler {
	public static ArtikelkommentardruckDto createDto(
		...
		if (artikelkommentardruck != null) {
			...
			artikelkommentardruckDto.setArtikelIId(artikelkommentardruck
					.getArtikelIId());
			artikelkommentardruckDto
					.setArtikelkommentarIId(artikelkommentardruck
	...
	public static ArtikelkommentardruckDto[] createDtos(
		...
		if (artikelkommentardrucks != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Artikelkommentardruck) iterator.next()));
			}
		}
