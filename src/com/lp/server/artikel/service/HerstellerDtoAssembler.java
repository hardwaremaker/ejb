...
public class HerstellerDtoAssembler {
	public static HerstellerDto createDto(Hersteller hersteller) {
	...
	public static HerstellerDto[] createDtos(Collection<?> herstellers) {
		List<HerstellerDto> list = new ArrayList<HerstellerDto>();
		if (herstellers != null) {
			Iterator<?> iterator = herstellers.iterator();
			while (iterator.hasNext()) {
				list.add(createDto((Hersteller) iterator.next()));
			}
		}
