...
public class VkPreisfindungPreislisteDtoAssembler {
	public static VkPreisfindungPreislisteDto createDto(
		...
		if (vkPreisfindungPreisliste != null) {
			vkPreisfindungPreislisteDto.setIId(vkPreisfindungPreisliste
					.getIId());
			vkPreisfindungPreislisteDto
					.setVkpfartikelpreislisteIId(vkPreisfindungPreisliste
							.getVkpfartikelpreislisteIId());
			vkPreisfindungPreislisteDto.setArtikelIId(vkPreisfindungPreisliste
					.getArtikelIId());
			vkPreisfindungPreislisteDto
					.setTPreisgueltigab(vkPreisfindungPreisliste
							.getTPreisgueltigab());
			vkPreisfindungPreislisteDto
					.setNArtikelstandardrabattsatz(vkPreisfindungPreisliste
							.getNArtikelstandardrabattsatz());
			vkPreisfindungPreislisteDto
					.setNArtikelfixpreis(vkPreisfindungPreisliste
							.getNArtikelfixpreis());
	...
	public static VkPreisfindungPreislisteDto[] createDtos(
		...
		if (vkPreisfindungPreislistes != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((VkPreisfindungPreisliste) iterator.next()));
			}
		}
