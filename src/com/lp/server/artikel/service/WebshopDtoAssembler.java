...
public class WebshopDtoAssembler {
	public static WebshopDto createDto(Webshop bean) {
	...
	public static WebshopDto[] createDtos(Collection<?> beans) {
		List<WebshopDto> list = new ArrayList<WebshopDto>();
		if (beans != null) {
			Iterator<?> iterator = beans.iterator();
			while (iterator.hasNext()) {
				list.add(createDto((Webshop) iterator.next()));
			}
		}
		WebshopDto[] returnArray = new WebshopDto[list.size()];
		return (WebshopDto[]) list.toArray(returnArray);
	}
}
