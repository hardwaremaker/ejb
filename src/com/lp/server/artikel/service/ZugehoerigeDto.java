...
public class ZugehoerigeDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof ZugehoerigeDto))
			return false;
		ZugehoerigeDto that = (ZugehoerigeDto) obj;
	...
	public String toString() {
		...
		returnStringBuffer.append("artikelIIdZugehoerig:").append(
				artikelIIdZugehoerig);
		returnStringBuffer.append("]");
