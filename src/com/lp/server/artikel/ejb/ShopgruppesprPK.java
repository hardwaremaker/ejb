...
@Embeddable
public class ShopgruppesprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "SHOPGRUPPE_I_ID", insertable = false, updatable = false)
	private Integer shopgruppeIId;

	private static final long serialVersionUID = 1L;

	public ShopgruppesprPK() {
		super();
	}

	public ShopgruppesprPK(String locUiAsString, Integer id) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ShopgruppesprPK)) {
			return false;
		}
		ShopgruppesprPK other = (ShopgruppesprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.shopgruppeIId.equals(other.shopgruppeIId);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.shopgruppeIId.hashCode();
		return hash;
	}
