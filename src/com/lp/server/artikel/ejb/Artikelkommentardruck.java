...
public class Artikelkommentardruck implements Serializable {
	...
	@Column(name = "ARTIKELKOMMENTAR_I_ID")
	private Integer artikelkommentarIId;

	private static final long serialVersionUID = 1L;

	public Artikelkommentardruck() {
		super();
	}

	public Artikelkommentardruck(Integer id, Integer artikelIId,
			Integer artikelkommentarIId, String belegartCNr) {
		setIId(id);
		setArtikelIId(artikelIId);
		setArtikelkommentarIId(artikelkommentarIId);
