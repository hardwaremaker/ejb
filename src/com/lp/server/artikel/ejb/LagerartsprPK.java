...
@Embeddable
public class LagerartsprPK implements Serializable {
	@Column(name = "LAGERART_C_NR", insertable = false, updatable = false)
	...
	public LagerartsprPK() {
		super();
	}

	public LagerartsprPK(String lagerartCNr, String localeCNr) {
		setLocaleCNr(localeCNr);
		setLagerartCNr(lagerartCNr);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof LagerartsprPK)) {
			return false;
		}
		LagerartsprPK other = (LagerartsprPK) o;
		return this.lagerartCNr.equals(other.lagerartCNr)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.lagerartCNr.hashCode();
