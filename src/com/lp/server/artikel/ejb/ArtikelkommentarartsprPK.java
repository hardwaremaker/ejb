...
@Embeddable
public class ArtikelkommentarartsprPK implements Serializable {
	@Column(name = "ARTIKELKOMMENTARART_I_ID", insertable = false, updatable = false)
	...
	public ArtikelkommentarartsprPK() {
		super();
	}

	public ArtikelkommentarartsprPK(Integer id, String locUiAsString) {
		setArtikelkommentarartIId(id);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ArtikelkommentarartsprPK)) {
			return false;
		}
		ArtikelkommentarartsprPK other = (ArtikelkommentarartsprPK) o;
		return this.artikelkommentarartIId.equals(other.artikelkommentarartIId)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.artikelkommentarartIId.hashCode();
