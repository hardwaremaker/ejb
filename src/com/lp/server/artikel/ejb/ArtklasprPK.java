...
@Embeddable
public class ArtklasprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "ARTKLA_I_ID", insertable = false, updatable = false)
	...
	public ArtklasprPK(String locUiAsString, Integer id) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ArtklasprPK)) {
			return false;
		}
		ArtklasprPK other = (ArtklasprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.artklaIId.equals(other.artklaIId);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.artklaIId.hashCode();
		return hash;
	}
