...
@Embeddable
public class ArtikelsprPK implements Serializable {
	...
	public ArtikelsprPK(Integer id, String locUiAsString) {
		setArtikelIId(id);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ArtikelsprPK)) {
			return false;
		}
		ArtikelsprPK other = (ArtikelsprPK) o;
