...
@NamedQueries({ @NamedQuery(name = Webshop.QueryFindByMandantCNrCBez, query = "SELECT OBJECT(o) FROM Webshop o WHERE o.mandantCNr = ?1 AND o.cBez = ?2") })
@Entity
@Table(name = "WW_WEBSHOP")
public class Webshop implements Serializable {
	...
	public Webshop(Integer id, String mandantCNr, String cBez) {
		setIId(id);
