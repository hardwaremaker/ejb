...
@Embeddable
public class ArtgrusprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "ARTGRU_I_ID", insertable = false, updatable = false)
	...
	public ArtgrusprPK(String locUiAsString, Integer id) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ArtgrusprPK)) {
			return false;
		}
		ArtgrusprPK other = (ArtgrusprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.artgruIId.equals(other.artgruIId);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.artgruIId.hashCode();
		return hash;
	}
