...
import com.lp.server.artikel.fastlanereader.generated.FLRWaffenkategorie;
 ...
 * @version 1.0
 */
public class WaffenkategorieHandler extends UseCaseHandler {
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				...
				FLRWaffenkategorie flr = (FLRWaffenkategorie) resultListIterator
						.next();
	...
	protected long getRowCountFromDataBase() {
		...
		try {
			...
			String queryString = "SELECT COUNT(*) FROM FLRWaffenkategorie AS waffenkategorie"
					+ buildWhereClause();
	...
	private String buildOrderByClause() {
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				...
				orderBy.append("waffenkategorie.c_nr ASC ");

				sortAdded = true;
			}
			if (orderBy.indexOf("waffenkategorie.i_id") < 0) {
				...
				orderBy.append(" waffenkategorie.i_id ");
				sortAdded = true;
			}
			if (sortAdded) {
	...
	private String getFromClause() {
		return " FROM FLRWaffenkategorie AS waffenkategorie";
	}
			...
			try {
				...
				if (scrollableResult != null) {
					...
					while (scrollableResult.next()) {
						FLRWaffenkategorie flr = (FLRWaffenkategorie) scrollableResult
								.get(0);
