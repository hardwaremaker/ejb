...
import com.lp.server.artikel.fastlanereader.generated.FLRMedical;
import com.lp.server.artikel.fastlanereader.generated.FLRWaffenausfuehrung;
 ...
 * @version 1.0
 */
public class WaffenausfuehrungHandler extends UseCaseHandler {
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				...
				FLRWaffenausfuehrung flr = (FLRWaffenausfuehrung) resultListIterator
						.next();
	...
	protected long getRowCountFromDataBase() {
		...
		try {
			...
			String queryString = "SELECT COUNT(*) FROM FLRWaffenausfuehrung AS waffenausfuehrung"
					+ buildWhereClause();
	...
	private String buildOrderByClause() {
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				...
				orderBy.append("waffenausfuehrung.c_nr ASC ");

				sortAdded = true;
			}
			if (orderBy.indexOf("waffenausfuehrung.i_id") < 0) {
				...
				orderBy.append(" waffenausfuehrung.i_id ");
				sortAdded = true;
			}
			if (sortAdded) {
	...
	private String getFromClause() {
		return " FROM FLRWaffenausfuehrung AS waffenausfuehrung";
	}
			...
			try {
				...
				if (scrollableResult != null) {
					...
					while (scrollableResult.next()) {
						FLRWaffenausfuehrung flr = (FLRWaffenausfuehrung) scrollableResult
								.get(0);
