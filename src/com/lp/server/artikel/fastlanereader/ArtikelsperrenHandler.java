 ...
 * @version 1.0
 */
public class ArtikelsperrenHandler extends UseCaseHandler {
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				FLRArtikelsperren flrArtikelsperren = (FLRArtikelsperren) resultListIterator
						.next();
	...
	private String buildOrderByClause() {
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				...
				orderBy.append("artikelsperren.i_sort ASC ");
				sortAdded = true;
			}
			if (orderBy.indexOf("artikelsperren.i_sort") < 0) {
				...
				orderBy.append(" artikelsperren.i_sort ");
				sortAdded = true;
			}
			if (sortAdded) {
	...
	private static final String fromClause = "from FLRArtikelsperren artikelsperren ";
	...
	public QueryResult sort(SortierKriterium[] sortierKriterien,
		...
		if (selectedId != null /* && ((String) selectedId).length() > 0 */) {
			...
			try {
				session = factory.openSession();
				String queryString = "select artikelsperren.i_id from FLRArtikelsperren artikelsperren "
	...
	public TableInfo getTableInfo() {
		if (super.getTableInfo() == null) {
			setTableInfo(new TableInfo(new Class[] { Integer.class,
					...
					"PK",
					getTextRespectUISpr("lp.sperre", theClientDto.getMandant(),
							theClientDto.getLocUi()),
					getTextRespectUISpr("lp.grund", theClientDto.getMandant(),
							theClientDto.getLocUi()) }, new String[] { "i_id",
					"flrsperren.c_bez", "flrsperren.c_grund" }));
		}
