 ...
 * @version 1.0
 */
public class MaterialHandler extends UseCaseHandler {
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			int pageSize = MaterialHandler.PAGE_SIZE;
	...
	private String buildOrderByClause() {
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				...
				orderBy.append("material.c_nr ASC ");

				sortAdded = true;
			}
			if (orderBy.indexOf("material.c_nr") < 0) {
