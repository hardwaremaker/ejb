...
/**
 * <p>Hier wird die FLR Funktionalit&auml;t f&uuml;r den Artikel implementiert.
 * Pro UseCase gibt es einen Handler.</p>
 * <p>Copright Logistik Pur Software GmbH (c) 2004-2007</p>
 * <p>Erstellungsdatum 2004-08-14</p>
 * <p> </p>
 * @author ck
 * @version 1.0
 */

public class KundenidentnummerHandler
  ...
  protected long getRowCountFromDataBase() {
    ...
    try {
      ...
      String queryString =
          "SELECT count(kundesoko.i_id) FROM FLRKundesoko as kundesoko"+
  ...
  private String buildWhereClause() {
    StringBuffer where = new StringBuffer("WHERE artikelliste.i_id IS NOT NULL AND kundesoko.c_kundeartikelnummer IS NOT NULL ");
      ...
      for (int i = 0; i < filterKriterien.length; i++) {
        if (filterKriterien[i].isKrit) {
          ...
          if (filterKriterien[i].isBIgnoreCase()) {
            where.append(" upper(kundesoko." + filterKriterien[i].kritName + ")");
          }
          else {
            where.append(" kundesoko." + filterKriterien[i].kritName);
          }
  ...
  private String buildOrderByClause() {
    ...
    if (getQuery() != null) {
      ...
      if (orderBy.indexOf("kundesoko.i_id") < 0) {
        ...
        // within sort() method may be different from the position of selectedId
  ...
  private String getFromClause()
    ...
    return "SELECT kundesoko.i_id, kundesoko.c_kundeartikelnummer, artikelliste.c_nr, aspr.c_bez,aspr.c_zbez, kundesoko.flrkunde.flrpartner.c_name1nachnamefirmazeile1,(SELECT distinct s.artikel_i_id FROM FLRArtikelsperren as s  WHERE s.artikel_i_id=artikelliste.i_id) as sperren FROM FLRKundesoko as kundesoko"+
        " LEFT OUTER JOIN kundesoko.flrartikel AS artikelliste "+
        " LEFT OUTER JOIN kundesoko.flrartikel.artikelsprset AS aspr ";
  ...
  public TableInfo getTableInfo() {
    if (super.getTableInfo() == null) {
        ...
        setTableInfo(new TableInfo(
            ...
            new String[] {
            "i_id",
            getTextRespectUISpr("lp.kundenartikelnummer", theClientDto.getMandant(),
                                theClientDto.getLocUi()),
            getTextRespectUISpr("artikel.artikelnummerlang", theClientDto.getMandant(),
                                theClientDto.getLocUi()),
            getTextRespectUISpr("bes.artikelbezeichnung", theClientDto.getMandant(),
                                theClientDto.getLocUi()),
            getTextRespectUISpr("artikel.zusatzbez", theClientDto.getMandant(),
                                theClientDto.getLocUi()),
            getTextRespectUISpr("lp.firma", theClientDto.getMandant(),
                                theClientDto.getLocUi()),
            "S"
        }
            ,
            ...
            new String[] {
            "i_id",
            "kundesoko.c_kundeartikelnummer",
            "artikelliste.c_nr",
            "aspr.c_bez",
            "aspr.c_zbez",
