 ...
 * @version 1.0
 */
public class FehlmengeAufloesenHandler extends UseCaseHandler {
	...
	private static final String FLR_FEHLMENGE_FROM_CLAUSE = "SELECT flrfehlmenge from FLRFehlmenge flrfehlmenge LEFT OUTER JOIN flrfehlmenge.flrlossollmaterial.flrlos.flrstueckliste AS stkl ";
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				...
				if (bEndeStattBeginnTermin) {
					...
					orderBy.append(FLR_FEHLMENGE)
							.append(ArtikelFac.FLR_FEHLMENGE_I_ID)
							.append(" DESC ");
				}
			...
			setTableInfo(new TableInfo(
					...
					new String[] {
							...
							bEndeStattBeginnTermin ? getTextRespectUISpr(
									...
									: getTextRespectUISpr("lp.begintermin",
											mandantCNr, locUI),
							getTextRespectUISpr(
					...
					new String[] {
							...
							bEndeStattBeginnTermin ? FLR_FEHLMENGE
									+ "flrlossollmaterial.flrlos.t_produktionsende"
									: FLR_FEHLMENGE
