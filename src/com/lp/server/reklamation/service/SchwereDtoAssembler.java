...
public class SchwereDtoAssembler {
	public static SchwereDto createDto(Schwere schwere) {
		SchwereDto schwereDto = new SchwereDto();
		if (schwere != null) {
	...
	public static SchwereDto[] createDtos(Collection<?> schweres) {
		List<SchwereDto> list = new ArrayList<SchwereDto>();
		if (schweres != null) {
			Iterator<?> iterator = schweres.iterator();
			while (iterator.hasNext()) {
				list.add(createDto((Schwere) iterator.next()));
			}
		}
