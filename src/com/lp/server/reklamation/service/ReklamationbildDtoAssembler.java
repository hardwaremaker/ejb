...
public class ReklamationbildDtoAssembler {
	public static ReklamationbildDto createDto(Reklamationbild reklamationbild) {
		ReklamationbildDto reklamationbildDto = new ReklamationbildDto();
		if (reklamationbild != null) {
			reklamationbildDto.setIId(reklamationbild.getIId());
			reklamationbildDto.setCBez(reklamationbild.getCBez());
	...
	public static ReklamationbildDto[] createDtos(Collection<?> reklamationbilds) {
		List<ReklamationbildDto> list = new ArrayList<ReklamationbildDto>();
		if (reklamationbilds != null) {
			Iterator<?> iterator = reklamationbilds.iterator();
			while (iterator.hasNext()) {
				list.add(createDto((Reklamationbild) iterator.next()));
			}
		}
