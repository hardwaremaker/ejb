...
@Embeddable
public class FehlersprPK implements Serializable {
	/**
	 * 
	 */
	...
	@Column(name = "FEHLER_I_ID", insertable = false, updatable = false)
	...
	public FehlersprPK(String locUiAsString, Integer id) {
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((fehlerIId == null) ? 0 : fehlerIId.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FehlersprPK other = (FehlersprPK) obj;
		if (fehlerIId == null) {
			if (other.fehlerIId != null)
				return false;
		} else if (!fehlerIId.equals(other.fehlerIId))
			return false;
		if (localeCNr == null) {
