...
@NamedQueries( { @NamedQuery(name = "SchwerefindByCNr", query = "SELECT OBJECT(o) FROM Schwere o WHERE o.cNr = ?1") })
@Entity
@Table(name = "REKLA_SCHWERE")
public class Schwere implements Serializable {
	@Id
	@Column(name = "I_ID")
	private Integer iId;
