 ...
 * @version 1.0
 */
public class BehandlungHandler extends UseCaseHandler {
	...
	private String buildOrderByClause() {
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				...
				orderBy.append("behandlung.c_nr ASC ");
				sortAdded = true;
			}
			if (orderBy.indexOf("behandlung.c_nr ") < 0) {
				...
				orderBy.append(" behandlung.c_nr ");
				sortAdded = true;
			}
			if (sortAdded) {
