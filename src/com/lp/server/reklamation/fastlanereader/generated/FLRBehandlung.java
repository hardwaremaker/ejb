...
public class FLRBehandlung implements Serializable {
    ...
    /** full constructor */
    public FLRBehandlung(String c_nr, Integer i_punkte, Set sprset) {
        this.c_nr = c_nr;
    ...
    /** default constructor */
    public FLRBehandlung() {
    }

    /** minimal constructor */
    public FLRBehandlung(Set sprset) {
        this.sprset = sprset;
    }
