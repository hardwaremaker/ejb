...
public class FahrzeugHandler extends UseCaseHandler {
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			int pageSize = FahrzeugHandler.PAGE_SIZE;
			...
			while (resultListIterator.hasNext()) {
				FLRFahrzeug flrFahrzeug = (FLRFahrzeug) resultListIterator.next();
	...
	private String buildOrderByClause() {
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				...
				orderBy.append("fahrzeug.c_bez ASC ");

				sortAdded = true;
			}
			if (orderBy.indexOf("fahrzeug.c_bez") < 0) {
