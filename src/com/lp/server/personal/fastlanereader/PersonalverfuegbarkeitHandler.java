...
public class PersonalverfuegbarkeitHandler extends UseCaseHandler {
	 ...
	 * Konstruktor.
	 */
	public PersonalverfuegbarkeitHandler() {
	}
	...
	public QueryResult sort(SortierKriterium[] sortierKriterien, Object selectedId) throws EJBExceptionLP {
		...
		if (selectedId != null /* && ((String) selectedId).length() > 0 */) {
			...
			try {
				session = factory.openSession();
				String queryString = "select personalverfuegbarkeit.i_id from FLRPersonalverfuegbarkeit personalverfuegbarkeit "
