 ...
 * @version 1.0
 */
public class MaschinengruppeHandler extends UseCaseHandler {
	...
	private String getFromClause() {
		return "from FLRMaschinengruppe maschinengruppe ";
	}
	...
	public QueryResult sort(SortierKriterium[] sortierKriterien,
		...
		if (selectedId != null && ((Integer) selectedId).intValue() >= 0) {
			...
			try {
				session = factory.openSession();
				String queryString = "select maschinengruppe.i_id from FLRMaschinengruppe maschinengruppe "
