...
public class FLRKollektivuestd50 implements Serializable {
    ...
    /** full constructor */
    public FLRKollektivuestd50(Date u_bis, Date u_von, Short b_restdestages, Short b_unterignorieren, com.lp.server.personal.fastlanereader.generated.FLRKollektiv flrkollektiv, com.lp.server.personal.fastlanereader.generated.FLRTagesart flrtagesart) {
        this.u_bis = u_bis;
        this.u_von = u_von;
    ...
    public Date getU_von() {
        return this.u_von;
    }

    public void setU_von(Date u_von) {
        this.u_von = u_von;
    }
