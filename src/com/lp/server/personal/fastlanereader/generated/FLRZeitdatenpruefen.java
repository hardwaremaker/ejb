...
public class FLRZeitdatenpruefen implements Serializable {
	private static final long serialVersionUID = -6679421206736416041L;
    ...
    private Integer i_fehlercode;
    
    private String x_fehlertext;
	...
	public Integer getI_fehlercode() {
		return i_fehlercode;
	}

	public void setI_fehlercode(Integer i_fehlercode) {
		this.i_fehlercode = i_fehlercode;
	}

	public String getX_fehlertext() {
		return x_fehlertext;
	}

	public void setX_fehlertext(String x_fehlertext) {
		this.x_fehlertext = x_fehlertext;
	}
}
