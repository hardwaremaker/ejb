...
public class FLRZeitabschluss implements Serializable {
    ...
    /** nullable persistent field */
    private Date t_abgeschlossen_bis;

    /** nullable persistent field */
    private com.lp.server.personal.fastlanereader.generated.FLRPersonal flrpersonal;

    /** full constructor */
    public FLRZeitabschluss(Integer personal_i_id, Date t_abgeschlossen_bis, com.lp.server.personal.fastlanereader.generated.FLRPersonal flrpersonal) {
        this.personal_i_id = personal_i_id;
        this.t_abgeschlossen_bis = t_abgeschlossen_bis;
        this.flrpersonal = flrpersonal;
    }

    /** default constructor */
    public FLRZeitabschluss() {
    }
    ...
    public Date getT_abgeschlossen_bis() {
        return this.t_abgeschlossen_bis;
    }

    public void setT_abgeschlossen_bis(Date t_abgeschlossen_bis) {
        this.t_abgeschlossen_bis = t_abgeschlossen_bis;
    }
