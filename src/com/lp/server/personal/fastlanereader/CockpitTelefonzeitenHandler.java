...
public class CockpitTelefonzeitenHandler extends UseCaseHandler {
			...
			while (resultListIterator.hasNext()) {
				...
				if (reise.getFlransprechpartner() != null) {
					...
					if (reise.getFlransprechpartner().getFlrpartneransprechpartner()
						...
						firma += " " + reise.getFlransprechpartner().getFlrpartneransprechpartner().getC_name2vornamefirmazeile2();
					}
					rows[row][col++] = firma;
				} else {
					rows[row][col++] = null;
		...
		if (super.getTableInfo() == null) {
			setTableInfo(new TableInfo(
					new Class[] { Integer.class, java.sql.Timestamp.class, java.sql.Timestamp.class, String.class,
							String.class, String.class,java.sql.Timestamp.class, java.sql.Timestamp.class,  Color.class },
					new String[] { "Id",
					...
					new int[] { -1, // diese Spalte wird ausgeblendet
							...
							QueryParameters.FLR_BREITE_XL, QueryParameters.FLR_BREITE_SHARE_WITH_REST,QueryParameters.FLR_BREITE_XM,
