...
@Embeddable
public class TaetigkeitartsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "TAETIGKEITART_C_NR", insertable = false, updatable = false)
	private String taetigkeitartCNr;

	private static final long serialVersionUID = 1L;

	public TaetigkeitartsprPK() {
		super();
	}

	public TaetigkeitartsprPK(String nrSpracheI, String nr) {
		setLocaleCNr(nrSpracheI);
		setTaetigkeitartCNr(nr);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof TaetigkeitartsprPK)) {
			return false;
		}
		TaetigkeitartsprPK other = (TaetigkeitartsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.taetigkeitartCNr.equals(other.taetigkeitartCNr);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.taetigkeitartCNr.hashCode();
		return hash;
	}
