...
@Embeddable
public class FamilienstandsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "FAMILIENSTAND_C_NR", insertable = false, updatable = false)
	private String familienstandCNr;

	private static final long serialVersionUID = 1L;

	public FamilienstandsprPK() {
		super();
	}

	public FamilienstandsprPK(String nrSpracheI, String nr) {
		setLocaleCNr(nrSpracheI);
		setFamilienstandCNr(nr);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof FamilienstandsprPK)) {
			return false;
		}
		FamilienstandsprPK other = (FamilienstandsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.familienstandCNr.equals(other.familienstandCNr);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.familienstandCNr.hashCode();
		return hash;
	}
