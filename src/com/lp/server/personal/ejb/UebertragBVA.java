...
@NamedQueries({ @NamedQuery(name = "UebertragBVAByPersonalIIdTDatum", query = "SELECT OBJECT(C) FROM UebertragBVA c WHERE c.personalIId = ?1 AND c.tDatum = ?2") })
@Entity
@Table(name = "PERS_UEBERTRAG_BVA")
public class UebertragBVA implements Serializable {
	@Id
	@Column(name = "I_ID")
	private Integer iId;
	...
	public UebertragBVA(Integer id, Integer personalIId2, Timestamp tDatum,
