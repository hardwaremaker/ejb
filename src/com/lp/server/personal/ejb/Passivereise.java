...
@NamedQueries( {
		@NamedQuery(name = "PassivereisefindByKollektivIIdTagesartIId", query = "SELECT OBJECT(o) FROM Passivereise o WHERE o.kollektivIId = ?1 AND o.tagesartIId = ?2"),
		@NamedQuery(name = "PassivereisefindByKollektivIId", query = "SELECT OBJECT(o) FROM Passivereise o WHERE o.kollektivIId = ?1") })
@Entity
@Table(name = "PERS_PASSIVEREISE")
public class Passivereise implements Serializable {
	@Id
	@Column(name = "I_ID")
	private Integer iId;
	...
	public Passivereise(Integer id,
