...
@Embeddable
public class PersonalartsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "PERSONALART_C_NR", insertable = false, updatable = false)
	private String personalartCNr;

	private static final long serialVersionUID = 1L;

	public PersonalartsprPK() {
		super();
	}

	public PersonalartsprPK(String nrSpracheI, String nr) {
		setLocaleCNr(nrSpracheI);
		setPersonalartCNr(nr);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof PersonalartsprPK)) {
			return false;
		}
		PersonalartsprPK other = (PersonalartsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.personalartCNr.equals(other.personalartCNr);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.personalartCNr.hashCode();
		return hash;
	}
