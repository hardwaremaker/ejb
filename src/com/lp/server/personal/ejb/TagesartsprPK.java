...
@Embeddable
public class TagesartsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "TAGESART_I_ID", insertable = false, updatable = false)
	private Integer tagesartIId;

	private static final long serialVersionUID = 1L;

	public TagesartsprPK() {
		super();
	}

	public TagesartsprPK(String nrSpracheI, Integer id) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof TagesartsprPK)) {
			return false;
		}
		TagesartsprPK other = (TagesartsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.tagesartIId.equals(other.tagesartIId);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.tagesartIId.hashCode();
		return hash;
	}
