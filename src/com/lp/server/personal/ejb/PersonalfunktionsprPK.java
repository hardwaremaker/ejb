...
@Embeddable
public class PersonalfunktionsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "PERSONALFUNKTION_C_NR", insertable = false, updatable = false)
	private String personalfunktionCNr;

	private static final long serialVersionUID = 1L;

	public PersonalfunktionsprPK() {
		super();
	}

	public PersonalfunktionsprPK(String nrSpracheI, String nr) {
		setLocaleCNr(nrSpracheI);
		setPersonalfunktionCNr(nr);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof PersonalfunktionsprPK)) {
			return false;
		}
		PersonalfunktionsprPK other = (PersonalfunktionsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.personalfunktionCNr.equals(other.personalfunktionCNr);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.personalfunktionCNr.hashCode();
		return hash;
	}
