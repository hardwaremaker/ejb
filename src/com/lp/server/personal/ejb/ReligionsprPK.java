...
@Embeddable
public class ReligionsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "RELIGION_I_ID", insertable = false, updatable = false)
	private Integer religionIId;

	private static final long serialVersionUID = 1L;

	public ReligionsprPK() {
		super();
	}

	public ReligionsprPK(String locUiAsString, Integer id) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ReligionsprPK)) {
			return false;
		}
		ReligionsprPK other = (ReligionsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.religionIId.equals(other.religionIId);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.religionIId.hashCode();
		return hash;
	}
