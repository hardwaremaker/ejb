...
public class PersonalzeitmodellDtoAssembler {
	public static PersonalzeitmodellDto createDto(
		...
		if (personalzeitmodell != null) {
			personalzeitmodellDto.setIId(personalzeitmodell.getIId());
			personalzeitmodellDto.setPersonalIId(personalzeitmodell
					.getPersonalIId());
			personalzeitmodellDto.setZeitmodellIId(personalzeitmodell
					.getZeitmodellIId());
			personalzeitmodellDto.setTGueltigab(personalzeitmodell
					.getTGueltigab());
		}
		return personalzeitmodellDto;
	}

	public static PersonalzeitmodellDto[] createDtos(
		...
		if (personalzeitmodells != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Personalzeitmodell) iterator.next()));
			}
		}
