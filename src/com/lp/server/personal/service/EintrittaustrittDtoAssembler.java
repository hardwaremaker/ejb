...
public class EintrittaustrittDtoAssembler {
	public static EintrittaustrittDto createDto(
			Eintrittaustritt eintrittaustritt) {
		EintrittaustrittDto eintrittaustrittDto = new EintrittaustrittDto();
		if (eintrittaustritt != null) {
			eintrittaustrittDto.setIId(eintrittaustritt.getIId());
			eintrittaustrittDto.setPersonalIId(eintrittaustritt
					.getPersonalIId());
			eintrittaustrittDto.setTEintritt(eintrittaustritt.getTEintritt());
	...
	public static EintrittaustrittDto[] createDtos(Collection<?> eintrittaustritts) {
		...
		if (eintrittaustritts != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Eintrittaustritt) iterator.next()));
			}
		}
