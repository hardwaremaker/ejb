...
public class ArtikellagerplaetzeDtoAssembler {
	public static ArtikellagerplaetzeDto createDto(
		...
		if (artikellagerplaetze != null) {
			artikellagerplaetzeDto.setIId(artikellagerplaetze.getIId());
			artikellagerplaetzeDto.setArtikelIId(artikellagerplaetze
					.getArtikelIId());
			artikellagerplaetzeDto.setLagerplatzIId(artikellagerplaetze
					.getLagerplatzIId());
			artikellagerplaetzeDto.setNLagerstandPaternoster(artikellagerplaetze
					.getNLagerstandPaternoster());
			artikellagerplaetzeDto.setiSort(artikellagerplaetze.getiSort());
		}
		return artikellagerplaetzeDto;
	}

	public static ArtikellagerplaetzeDto[] createDtos(
		...
		if (artikellagerplaetzes != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Artikellagerplaetze) iterator.next()));
			}
		}
