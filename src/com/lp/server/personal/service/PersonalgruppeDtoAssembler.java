...
public class PersonalgruppeDtoAssembler {
	public static PersonalgruppeDto createDto(Personalgruppe maschinengruppe) {
		PersonalgruppeDto maschinengruppeDto = new PersonalgruppeDto();
	...
	public static PersonalgruppeDto[] createDtos(Collection<?> maschinengruppes) {
		...
		if (maschinengruppes != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Personalgruppe) iterator.next()));
			}
		}
