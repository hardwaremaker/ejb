...
public class PendlerpauschaleDtoAssembler {
	public static PendlerpauschaleDto createDto(
			Pendlerpauschale pendlerpauschale) {
		PendlerpauschaleDto pendlerpauschaleDto = new PendlerpauschaleDto();
		if (pendlerpauschale != null) {
			pendlerpauschaleDto.setIId(pendlerpauschale.getIId());
			pendlerpauschaleDto.setCBez(pendlerpauschale.getCBez());
		}
		return pendlerpauschaleDto;
	}

	public static PendlerpauschaleDto[] createDtos(Collection<?> pendlerpauschales) {
		...
		if (pendlerpauschales != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Pendlerpauschale) iterator.next()));
			}
		}
