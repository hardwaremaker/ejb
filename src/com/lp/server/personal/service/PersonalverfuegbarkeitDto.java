...
public class PersonalverfuegbarkeitDto implements Serializable {
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof PersonalverfuegbarkeitDto))
			return false;
		PersonalverfuegbarkeitDto that = (PersonalverfuegbarkeitDto) obj;
		...
		if (!(that.artikelIId == null ? this.artikelIId == null
			...
			return false;
		if (!(that.fAnteilprozent == null ? this.fAnteilprozent == null
				: that.fAnteilprozent.equals(this.fAnteilprozent)))
			return false;
		return true;
	}
	...
	public int hashCode() {
		...
		result = 37 * result + this.fAnteilprozent.hashCode();
		return result;
	}
	...
	public String toString() {
		...
		returnStringBuffer.append("fAnteilprozent:").append(fAnteilprozent);
		returnStringBuffer.append("]");
