...
public class ZeitverteilungDtoAssembler {

	public static ZeitverteilungDto createDto(Zeitverteilung zeitverteilung) {
		ZeitverteilungDto zeitverteilungDto = new ZeitverteilungDto();
		if (zeitverteilung != null) {
			zeitverteilungDto.setIId(zeitverteilung.getIId());
			zeitverteilungDto.setPersonalIId(zeitverteilung.getPersonalIId());
	...
	public static ZeitverteilungDto[] createDtos(Collection<?> zeitverteilungs) {
		...
		if (zeitverteilungs != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Zeitverteilung) iterator.next()));
			}
		}
