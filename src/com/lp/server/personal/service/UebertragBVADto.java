...
public class UebertragBVADto implements Serializable {
	private Integer iId;
	...
	public BigDecimal entsprichtNormalstunden() {
		BigDecimal entsprichtnormalstunden =BigDecimal.ZERO;
		
		if(nGleitzeit!=null) {
			entsprichtnormalstunden=entsprichtnormalstunden.add(nGleitzeit);
		}
		if(nUestd50Gz!=null) {
			entsprichtnormalstunden=entsprichtnormalstunden.add(nUestd50Gz);
		}
		if(nUestd50Gz_Zuschlag!=null) {
			entsprichtnormalstunden=entsprichtnormalstunden.add(nUestd50Gz_Zuschlag);
		}
		if(nUestd50!=null) {
			entsprichtnormalstunden=entsprichtnormalstunden.add(nUestd50);
		}
		if(nUestd50_Zuschlag!=null) {
			entsprichtnormalstunden=entsprichtnormalstunden.add(nUestd50_Zuschlag);
		}
		if(nUestd100!=null) {
			entsprichtnormalstunden=entsprichtnormalstunden.add(nUestd100);
		}
		if(nUestd100_Zuschlag!=null) {
			entsprichtnormalstunden=entsprichtnormalstunden.add(nUestd100_Zuschlag);
		}
		
		return entsprichtnormalstunden;
	}
