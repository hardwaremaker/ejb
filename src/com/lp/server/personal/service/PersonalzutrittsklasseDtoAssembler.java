...
public class PersonalzutrittsklasseDtoAssembler {
	public static PersonalzutrittsklasseDto createDto(
			Personalzutrittsklasse personalzutrittsklasse) {
		PersonalzutrittsklasseDto personalzutrittsklasseDto = new PersonalzutrittsklasseDto();
		if (personalzutrittsklasse != null) {
			personalzutrittsklasseDto.setIId(personalzutrittsklasse.getIId());
			personalzutrittsklasseDto.setPersonalIId(personalzutrittsklasse
					.getPersonalIId());
			personalzutrittsklasseDto
					.setZutrittsklasseIId(personalzutrittsklasse
							.getZutrittsklasseIId());
			personalzutrittsklasseDto.setTGueltigab(personalzutrittsklasse
					.getTGueltigab());
		}
		return personalzutrittsklasseDto;
	}

	public static PersonalzutrittsklasseDto[] createDtos(
		...
		if (personalzutrittsklasses != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Personalzutrittsklasse) iterator.next()));
			}
		}
