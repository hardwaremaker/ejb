...
public class KommunikationsartDtoAssembler {
	public static KommunikationsartDto createDto(
			Kommunikationsart kommunikationsart) {
		KommunikationsartDto kommunikationsartDto = new KommunikationsartDto();
		if (kommunikationsart != null) {
			kommunikationsartDto.setCNr(kommunikationsart.getCNr());
		}
		return kommunikationsartDto;
	}

	public static KommunikationsartDto[] createDtos(
		...
		if (kommunikationsarts != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Kommunikationsart) iterator.next()));
			}
		}
