...
public class LfliefergruppesprDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof LfliefergruppesprDto))
			return false;
		LfliefergruppesprDto that = (LfliefergruppesprDto) obj;
		if (!(that.lfliefergruppeIId == null ? this.lfliefergruppeIId == null
				: that.lfliefergruppeIId.equals(this.lfliefergruppeIId)))
			return false;
	...
	public int hashCode() {
		int result = 17;
		result = 37 * result + this.lfliefergruppeIId.hashCode();
	...
	public String toString() {
		String returnString = "";
		returnString += lfliefergruppeIId;
