...
public interface AnsprechpartnerFac {
	...
	public static final String FLR_ANSPRECHPARTNER_C_EMAIL = "c_email";
	public static final String FLR_ANSPRECHPARTNER_C_ABTEILUNG = "c_abteilung";
	...
	public static final String FLR_ANSPRECHPARTNER_FLRNEWSLETTERGRUND = "flrnewslettergrund";
	...
	public Map<?, ?> getAllAnsprechpartnerfunktion(String loI, TheClientDto theClientDto) throws RemoteException;
	...
	public ArrayList<?> getAllAnsprechpartner(Integer iIdPartnerI, TheClientDto theClientDto) throws RemoteException;

	public void createAnsprechpartnerfunktionspr(AnsprechpartnerfunktionsprDto ansprechpartnerfunktionsprDtoI)
			throws EJBExceptionLP, RemoteException;

	public void removeAnsprechpartnerfunktionspr(String localeCNr, Integer ansprechpartnerIId)
			throws EJBExceptionLP, RemoteException;
	...
	public void vertauscheAnsprechpartner(Integer iSort1, Integer iSort2, Integer iIdansprechpartner1,
			Integer iIdansprechpartner2) throws EJBExceptionLP, RemoteException;

	public void renumberISortAnsprechpartner(Integer partnerId) throws EJBExceptionLP, RemoteException;
	...
	public AnsprechpartnerDto[] ansprechpartnerFindByPartnerIIdAndPartnerIIdAnsprechpartner(Integer iIdPartnerI,
			Integer iIdPartnerAnsprechpartnerI, TheClientDto theClientDto) throws RemoteException;
	...
	public void zusammenfuehrenAnsprechpartner(AnsprechpartnerDto ansprechpartnerZielDto,
			int ansprechpartnerQuellDtoIid, PartnerDto partnerDto, TheClientDto theClientDto)
			throws EJBExceptionLP, RemoteException;

	public String getUebersteuerteEmpfaenger(PartnerDto partnerDto, String reportname, boolean bEmail,
			TheClientDto theClientDto);

	AnsprechpartnerDto[] ansprechpartnerFindByEmail(String email, TheClientDto theClientDto);
