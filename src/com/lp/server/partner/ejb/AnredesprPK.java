...
@Embeddable
public class AnredesprPK implements Serializable {
	public AnredesprPK() {
		// TODO Auto-generated constructor stub
	}

	@Column(name = "ANREDE_C_NR", insertable = false, updatable = false)
	...
	public AnredesprPK(String anredeCNr, String localeCNr) {
		setAnredeCNr(anredeCNr);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof AnredesprPK)) {
			return false;
		}
		AnredesprPK other = (AnredesprPK) o;
		return this.anredeCNr.equals(other.anredeCNr)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.anredeCNr.hashCode();
