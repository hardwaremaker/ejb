...
@Embeddable
public class SerienbriefselektionnegativPK implements Serializable {
	...
	public SerienbriefselektionnegativPK(Integer serienbriefIId,
			Integer selektionIId) {
		setSerienbriefIId(serienbriefIId);
		setSelektionIId(selektionIId);
	}

	public SerienbriefselektionnegativPK() {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof SerienbriefselektionnegativPK)) {
			return false;
		}
		SerienbriefselektionnegativPK other = (SerienbriefselektionnegativPK) o;
