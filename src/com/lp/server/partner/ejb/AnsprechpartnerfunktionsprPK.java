...
@Embeddable
public class AnsprechpartnerfunktionsprPK implements Serializable {
	@Column(name = "ANSPRECHPARTNERFUNKTION_I_ID", insertable = false, updatable = false)
	...
	public AnsprechpartnerfunktionsprPK() {
		super();
	}

	public AnsprechpartnerfunktionsprPK(String locUiAsString, Integer idI) {
		setLocaleCNr(locUiAsString);
		setAnsprechpartnerfunktionIId(idI);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof AnsprechpartnerfunktionsprPK)) {
			return false;
		}
		AnsprechpartnerfunktionsprPK other = (AnsprechpartnerfunktionsprPK) o;
		return this.ansprechpartnerfunktionIId
				.equals(other.ansprechpartnerfunktionIId)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.ansprechpartnerfunktionIId.hashCode();
