...
@Embeddable
public class KommunikationsartsprPK implements Serializable {
	public KommunikationsartsprPK() {
		// TODO Auto-generated constructor stub
	}

	@Column(name = "KOMMUNIKATIONSART_C_NR", insertable = false, updatable = false)
	...
	public KommunikationsartsprPK(String localeCNr, String kommunikationsartCNr) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof KommunikationsartsprPK)) {
			return false;
		}
		KommunikationsartsprPK other = (KommunikationsartsprPK) o;
		return this.kommunikationsartCNr.equals(other.kommunikationsartCNr)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.kommunikationsartCNr.hashCode();
