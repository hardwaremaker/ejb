...
@Embeddable
public class SelektionsprPK implements Serializable {
	...
	public SelektionsprPK(Integer selektionIId, String localeCNr) {
		setSelektionIId(selektionIId);
		setLocaleCNr(localeCNr);
	}

	public SelektionsprPK() {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof SelektionsprPK)) {
			return false;
		}
		SelektionsprPK other = (SelektionsprPK) o;
		return this.selektionIId.equals(other.selektionIId)
