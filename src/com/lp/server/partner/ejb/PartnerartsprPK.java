...
@Embeddable
public class PartnerartsprPK implements Serializable {
	@Column(name = "PARTNERART_C_NR", insertable = false, updatable = false)
	...
	public PartnerartsprPK(String localeCNr, String partnerartCNr) {
		setLocaleCNr(localeCNr);
		setPartnerartCNr(partnerartCNr);
	}

	public PartnerartsprPK() {
		super();
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof PartnerartsprPK)) {
			return false;
		}
		PartnerartsprPK other = (PartnerartsprPK) o;
		return this.partnerartCNr.equals(other.partnerartCNr)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.partnerartCNr.hashCode();
