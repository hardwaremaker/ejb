...
@Embeddable
public class LfliefergruppesprPK implements Serializable {
	...
	public LfliefergruppesprPK(Integer lfliefergruppeIId, String localeCNr) {
		setLfliefergruppeIId(lfliefergruppeIId);
		setLocaleCNr(localeCNr);
	}

	public LfliefergruppesprPK() {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof LfliefergruppesprPK)) {
			return false;
		}
		LfliefergruppesprPK other = (LfliefergruppesprPK) o;
