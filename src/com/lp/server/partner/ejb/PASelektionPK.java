...
@Embeddable
public class PASelektionPK implements Serializable {
	public PASelektionPK() {
	...
	public PASelektionPK(Integer partnerIId, Integer selektionIId) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof PASelektionPK)) {
			return false;
		}
		PASelektionPK other = (PASelektionPK) o;
		return this.partnerIId.equals(other.partnerIId)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.partnerIId.hashCode();
