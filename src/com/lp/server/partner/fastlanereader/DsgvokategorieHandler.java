...
import com.lp.server.partner.fastlanereader.generated.FLRDsgvokategorie;
 ...
 * @version 1.0
 */
public class DsgvokategorieHandler extends UseCaseHandler {
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				...
				FLRDsgvokategorie massnahme = (FLRDsgvokategorie) o[0];
	...
	private String getFromClause() {
		return "from FLRDsgvokategorie if LEFT JOIN if.sprset AS sprset";
	}
	...
	public QueryResult sort(SortierKriterium[] sortierKriterien,
		...
		if (selectedId != null && ((Integer) selectedId).intValue() >= 0) {
			...
			try {
				session = factory.openSession();
				session = setFilter(session);
				String queryString = "select if.i_id from FLRDsgvokategorie if  LEFT JOIN if.sprset AS sprset"
