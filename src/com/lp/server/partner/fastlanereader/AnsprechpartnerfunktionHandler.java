...
import com.lp.server.partner.fastlanereader.generated.FLRAnsprechpartnerfunktion;
...
/**
 * <p>
 * Diese Klasse kuemmert sich Ansprechpartnerfunktion-FLR.
 * </p>
 * 
 * <p>
 ...
 */
public class AnsprechpartnerfunktionHandler extends UseCaseHandler {
	...
	private String findSpr(String sLocaleI, Iterator<?> iterUebersetzungenI) {
		...
		while (iterUebersetzungenI.hasNext()) {
			FLRAnsprechpartnerfunktionspr ansprechpartnerfunktionspr = (FLRAnsprechpartnerfunktionspr) iterUebersetzungenI
					.next();
			if (ansprechpartnerfunktionspr.getLocale().getC_nr().compareTo(
					sLocaleI) == 0) {
				sUebersetzung = ansprechpartnerfunktionspr.getC_bez();
				break;
			}
		}
	...
	protected long getRowCountFromDataBase() {
		...
		try {
			...
			String queryString = "SELECT COUNT(*) FROM FLRAnsprechpartnerfunktion AS ansprechpartnerfunktion"
					+ " LEFT JOIN ansprechpartnerfunktion.ansprechpartnerfunktion_ansprechpartnerfunktionspr_set AS ansprechpartnerfunktion_ansprechpartnerfunktionspr_set "
					+ buildWhereClause();
		...
		if (getQuery() != null && getQuery().getFilterBlock() != null
			...
			for (int i = 0; i < filterKriterien.length; i++) {
				if (filterKriterien[i].isKrit) {
					...
					filterAdded = true;
					where.append(" ansprechpartnerfunktion."
	...
	private String buildOrderByClause() {
		...
		if (getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				...
				orderBy.append("ansprechpartnerfunktion.i_id ASC ");
				sortAdded = true;
			}
			if (orderBy.indexOf("ansprechpartnerfunktion.i_id") < 0) {
				...
				orderBy.append(" ansprechpartnerfunktion.i_id ");
				sortAdded = true;
			}
			if (sortAdded) {
	...
	private String getFromClause() {
		return " FROM FLRAnsprechpartnerfunktion AS ansprechpartnerfunktion"
				+ " LEFT JOIN ansprechpartnerfunktion.ansprechpartnerfunktion_ansprechpartnerfunktionspr_set AS ansprechpartnerfunktion_ansprechpartnerfunktionspr_set";
	}
			...
			try {
				...
				if (scrollableResult != null) {
					...
					while (scrollableResult.next()) {
						FLRAnsprechpartnerfunktion ansprechpartnerfunktion = (FLRAnsprechpartnerfunktion) scrollableResult
								.get(0);
						Integer id = ansprechpartnerfunktion.getI_id();
		...
		if (super.getTableInfo() == null) {
			setTableInfo(new TableInfo(
					...
					new int[] { QueryParameters.FLR_BREITE_SHARE_WITH_REST,
							...
							QueryParameters.FLR_BREITE_SHARE_WITH_REST },
					new String[] { "ansprechpartnerfunktion.id",
							"ansprechpartnerfunktion.c_nr",
							"ansprechpartnerfunktion_ansprechpartnerfunktionspr_set.c_bez" }));
		}
