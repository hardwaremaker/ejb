...
/**
 * <p>
 * Diese Klasse kuemmert sich um die PASelektion.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * Erstellung: Josef Ornetsmueller; 08.11.05
 * </p>
 * 
 * <p>
 * 
 ...
 */
public class PASelektionHandler extends UseCaseHandler {
	...
	private String getFromClause() {
		return "from FLRPASelektion paselektion ";
	}
	...
	public TableInfo getTableInfo() {
		if (super.getTableInfo() == null) {
			...
			setTableInfo(new TableInfo(
					...
					new String[] {
							"i_id",
							getTextRespectUISpr("part.selektion", mandantCNr,
									locUI),
					...
					new String[] {
							"i_id",
							"paselektion.flrselektion.c_nr",
							"paselektion."
									+ PartnerFac.FLR_PARTNER_SELEKTION_C_BEMERKUNG }));
		}
