...
public class FLRSerienbriefselektionPK implements Serializable {
    ...
    /** full constructor */
    public FLRSerienbriefselektionPK(Integer serienbrief_i_id, Integer selektion_i_id) {
        this.serienbrief_i_id = serienbrief_i_id;
        this.selektion_i_id = selektion_i_id;
    }

    /** default constructor */
    public FLRSerienbriefselektionPK() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof FLRSerienbriefselektionPK) ) return false;
        FLRSerienbriefselektionPK castOther = (FLRSerienbriefselektionPK) other;
