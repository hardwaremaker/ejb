...
public class LandDtoAssembler {
	public static LandDto createDto(Land land) {
		...
		if (land != null) {
			...
			landDto.setTEUMitgliedVon(land.getTEumitgliedVon());
			...
			landDto.setLandIIdGemeinsamespostland(land
					.getLandIIdGemeinsamespostland());
			landDto.setBPlznachort(land.getBPlznachort());
			landDto.setBPostfachmitstrasse(land.getBPostfachmitstrasse());
			landDto.setBMwstMuenzRundung(land.getBMwstMuenzrundung());
			landDto.setTEUMitgliedBis(land.getTEumitgliedBis());
			landDto.setBPraeferenzbeguenstigt(land.getBPraeferenzbeguenstigt());
		}
		return landDto;
	}
