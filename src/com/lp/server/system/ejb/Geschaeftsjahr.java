...
@NamedQueries( 	{ @NamedQuery(name = GeschaeftsjahrQuery.ByAll, query = "SELECT OBJECT(o) FROM Geschaeftsjahr o"),
				  @NamedQuery(name = GeschaeftsjahrQuery.ByDateMandant, query = "SELECT OBJECT(o) FROM Geschaeftsjahr o WHERE o.tBeginndatum<= :date ORDER BY o.tBeginndatum DESC"),
				  @NamedQuery(name = GeschaeftsjahrQuery.ByYear, query = "SELECT OBJECT(o) FROM Geschaeftsjahr o WHERE o.iGeschaeftsjahr = :year")})

@Entity
@Table(name = "LP_GESCHAEFTSJAHR")
public class Geschaeftsjahr implements Serializable {
	...
	public Geschaeftsjahr(Integer geschaeftsjahr, Timestamp beginndatum,
