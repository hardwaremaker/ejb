...
@Embeddable
public class PositionsartsprPK implements Serializable {
	...
	public PositionsartsprPK() {
		super();
	}

	public PositionsartsprPK(String nr, String locUiAsString) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof PositionsartsprPK)) {
			return false;
		}
		PositionsartsprPK other = (PositionsartsprPK) o;
		return this.positionsartCNr.equals(other.positionsartCNr)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.positionsartCNr.hashCode();
