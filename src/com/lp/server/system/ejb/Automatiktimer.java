...
@Entity
@Table(name = "LP_AUTOMATIKTIMER")
public class Automatiktimer implements Serializable {
	@Id
	@Column(name = "I_ID")
	private Integer iId;
	...
	@Column(name = "T_TIMETOPERFORM")
	private Time tTimetoperform;

	private static final long serialVersionUID = 1L;

	public Automatiktimer() {
		super();
	}
	
	public Automatiktimer(Integer id) {
		setIId(id);
	}
