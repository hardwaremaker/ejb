...
@Embeddable
public class ParametermandantgueltigabPK implements Serializable {
	...
	public ParametermandantgueltigabPK() {
		super();
	}

	public ParametermandantgueltigabPK(String nr, String mandantCMandant,
			String kategorie,Timestamp tGueltigab) {
		setCNr(nr);
		setMandantCNr(mandantCMandant);
		setCKategorie(kategorie);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ParametermandantgueltigabPK)) {
			return false;
		}
		ParametermandantgueltigabPK other = (ParametermandantgueltigabPK) o;
		return this.cNr.equals(other.cNr)
				&& this.mandantCNr.equals(other.mandantCNr)
				&& this.cKategorie.equals(other.cKategorie);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.cKategorie.hashCode();
		return hash;
	}

	@Override
	public String toString() {
		return "ParametermandantPK [mandantCNr=" + mandantCNr + ", cNr=" + cNr
