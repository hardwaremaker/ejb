...
@Embeddable
public class BelegartsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "BELEGART_C_NR", insertable = false, updatable = false)
	private String belegartCNr;

	private static final long serialVersionUID = 1L;

	public BelegartsprPK() {
		super();
	}

	public BelegartsprPK(String locUiAsString, String nrI) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof BelegartsprPK)) {
			return false;
		}
		BelegartsprPK other = (BelegartsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.belegartCNr.equals(other.belegartCNr);
	}
