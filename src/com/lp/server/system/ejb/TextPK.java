...
public class TextPK implements Serializable {
	...
	public TextPK(String lowerCase, String mandantCNr2, String localeCNr2) {
		setCToken(lowerCase);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof TextPK)) {
			return false;
		}
		TextPK other = (TextPK) o;
		return this.cToken.equals(other.cToken)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.cToken.hashCode();
