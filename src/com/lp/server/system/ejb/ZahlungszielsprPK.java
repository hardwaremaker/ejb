...
@Embeddable
public class ZahlungszielsprPK implements Serializable {
	@Column(name = "ZAHLUNGSZIEL_I_ID", insertable = false, updatable = false)
	...
	public ZahlungszielsprPK() {
		super();
	}

	public ZahlungszielsprPK(Integer id, String locUiAsString) {
		setZahlungszielIId(id);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ZahlungszielsprPK)) {
			return false;
		}
		ZahlungszielsprPK other = (ZahlungszielsprPK) o;
		return this.zahlungszielIId.equals(other.zahlungszielIId)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.zahlungszielIId.hashCode();
