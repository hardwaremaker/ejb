...
@Embeddable
public class StatussprPK implements Serializable {
	@Column(name = "STATUS_C_NR", insertable = false, updatable = false)
	...
	public StatussprPK(String nr, String localeCNr2) {
		setStatusCNr(nr);
		setLocaleCNr(localeCNr2);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof StatussprPK)) {
			return false;
		}
		StatussprPK other = (StatussprPK) o;
		return this.statusCNr.equals(other.statusCNr)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.statusCNr.hashCode();
