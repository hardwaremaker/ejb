...
@Embeddable
public class MediaartsprPK implements Serializable {
	@Column(name = "MEDIAART_C_NR", insertable = false, updatable = false)
	...
	public MediaartsprPK() {
		super();
	}

	public MediaartsprPK(String nr, String locUiAsString) {
		setMediaartCNr(nr);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof MediaartsprPK)) {
			return false;
		}
		MediaartsprPK other = (MediaartsprPK) o;
		return this.mediaartCNr.equals(other.mediaartCNr)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.mediaartCNr.hashCode();
