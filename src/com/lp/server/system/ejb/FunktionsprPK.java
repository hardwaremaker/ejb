...
@Embeddable
public class FunktionsprPK implements Serializable {
	@Column(name = "FUNKTION_I_ID", insertable = false, updatable = false)
	...
	public FunktionsprPK() {
		super();
	}

	public FunktionsprPK(Integer id, String locUiAsString) {
		setFunktionIId(id);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof FunktionsprPK)) {
			return false;
		}
		FunktionsprPK other = (FunktionsprPK) o;
		return this.funktionIId.equals(other.funktionIId)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.funktionIId.hashCode();
