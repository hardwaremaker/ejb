...
@Embeddable
public class LieferartsprPK implements Serializable {
	@Column(name = "LIEFERART_I_ID", insertable = false, updatable = false)
	...
	public LieferartsprPK() {
		super();
	}

	public LieferartsprPK(Integer iid, String locale) {
		setLieferartIId(iid);
		setLocaleCNr(locale);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof LieferartsprPK)) {
			return false;
		}
		LieferartsprPK other = (LieferartsprPK) o;
		return this.lieferartIId.equals(other.lieferartIId)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.lieferartIId.hashCode();
