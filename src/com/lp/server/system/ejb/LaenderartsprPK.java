...
@Embeddable
public class LaenderartsprPK implements Serializable {
	...
	public LaenderartsprPK() {
		super();
	}

	public LaenderartsprPK(String laenderartCNr, String localeCNr) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof LaenderartsprPK)) {
			return false;
		}
		LaenderartsprPK other = (LaenderartsprPK) o;
		return this.laenderartCNr.equals(other.laenderartCNr)
