...
@Remote
public interface PKGeneratorFac  {
	public Integer getNextPrimaryKey(String name) throws RemoteException;
	
	public Integer getLastPrimaryKey(String name) throws RemoteException;
