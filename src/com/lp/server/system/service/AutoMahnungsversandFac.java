...
@Remote
public interface AutoMahnungsversandFac {

	public void createAutoMahnungsversand(
			AutoMahnungsversandDto autoMahnungsversandDto) throws 
			RemoteException;

	public void removeAutoMahnungsversand(Integer iId) throws 
			RemoteException;
	...
	public AutoMahnungsversandDto autoMahnungsversandFindByPrimaryKey(
