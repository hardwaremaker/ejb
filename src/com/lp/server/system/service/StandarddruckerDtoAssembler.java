...
public class StandarddruckerDtoAssembler {
	public static StandarddruckerDto createDto(Standarddrucker standarddrucker) {
		StandarddruckerDto standarddruckerDto = new StandarddruckerDto();
		if (standarddrucker != null) {
			standarddruckerDto.setIId(standarddrucker.getIId());
			...
			standarddruckerDto.setBStandard(standarddrucker.getBStandard());
		}
		return standarddruckerDto;
	}

	public static StandarddruckerDto[] createDtos(Collection<?> standarddruckers) {
		...
		if (standarddruckers != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Standarddrucker) iterator.next()));
			}
		}
