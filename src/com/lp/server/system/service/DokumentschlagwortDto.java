...
public class DokumentschlagwortDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof DokumentschlagwortDto))
			return false;
		DokumentschlagwortDto that = (DokumentschlagwortDto) obj;
		if (!(that.iId == null ? this.iId == null : that.iId.equals(this.iId)))
			return false;
		if (!(that.dokumentIId == null ? this.dokumentIId == null
				: that.dokumentIId.equals(this.dokumentIId)))
			return false;
		if (!(that.cSchlagwort == null ? this.cSchlagwort == null
				: that.cSchlagwort.equals(this.cSchlagwort)))
			return false;
		return true;
	}
	...
	public int hashCode() {
		...
		result = 37 * result + this.cSchlagwort.hashCode();
		return result;
	}
	...
	public String toString() {
		...
		returnStringBuffer.append("cSchlagwort:").append(cSchlagwort);
		returnStringBuffer.append("]");
