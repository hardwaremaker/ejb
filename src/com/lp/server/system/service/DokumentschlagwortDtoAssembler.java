...
public class DokumentschlagwortDtoAssembler {
	public static DokumentschlagwortDto createDto(
			Dokumentschlagwort dokumentschlagwort) {
		DokumentschlagwortDto dokumentschlagwortDto = new DokumentschlagwortDto();
		if (dokumentschlagwort != null) {
			dokumentschlagwortDto.setIId(dokumentschlagwort.getIId());
			dokumentschlagwortDto.setDokumentIId(dokumentschlagwort
					.getDokumentIId());
			dokumentschlagwortDto.setCSchlagwort(dokumentschlagwort
					.getCSchlagwort());
		}
		return dokumentschlagwortDto;
	}

	public static DokumentschlagwortDto[] createDtos(
		...
		if (dokumentschlagworts != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Dokumentschlagwort) iterator.next()));
			}
		}
