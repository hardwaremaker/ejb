...
public class TextDto implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof TextDto))
			return false;
		TextDto that = (TextDto) obj;
		if (!(that.cToken == null ? this.cToken == null : that.cToken
				.equals(this.cToken)))
			return false;
	...
	public int hashCode() {
		int result = 17;
		result = 37 * result + this.cToken.hashCode();
