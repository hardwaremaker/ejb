...
public class InstallerDto implements Serializable {
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof InstallerDto))
			return false;
		InstallerDto that = (InstallerDto) obj;
		if (!(that.iId == null ? this.iId == null : that.iId.equals(this.iId)))
			return false;
		if (that.oClientpc != this.oClientpc)
			return false;
		return true;
	}
	...
	public String toString() {
		...
		returnStringBuffer.append("oClientpc:").append(oClientpc);
		returnStringBuffer.append("]");
