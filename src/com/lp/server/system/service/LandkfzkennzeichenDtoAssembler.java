...
public class LandkfzkennzeichenDtoAssembler {
	public static LandkfzkennzeichenDto createDto(
			Landkfzkennzeichen landkfzkennzeichen) {
		LandkfzkennzeichenDto landkfzkennzeichenDto = new LandkfzkennzeichenDto();
		if (landkfzkennzeichen != null) {
			landkfzkennzeichenDto.setCLkz(landkfzkennzeichen.getCLkz());
			landkfzkennzeichenDto.setCKfzkennzeichen(landkfzkennzeichen
					.getCKfzkennzeichen());
		}
		return landkfzkennzeichenDto;
	}

	public static LandkfzkennzeichenDto[] createDtos(
		...
		if (landkfzkennzeichens != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Landkfzkennzeichen) iterator.next()));
			}
		}
