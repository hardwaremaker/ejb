...
public class FLRParameteranwender implements Serializable {
	...
	/** identifier field */
	private FLRParameteranwenderPK id_comp;
	...
	/** full constructor */
	public FLRParameteranwender(FLRParameteranwenderPK id_comp, String c_wert,
	...
	/** default constructor */
	public FLRParameteranwender() {
	}

	/** minimal constructor */
	public FLRParameteranwender(FLRParameteranwenderPK id_comp) {
		this.id_comp = id_comp;
	}

	public FLRParameteranwenderPK getId_comp() {
		return this.id_comp;
	}

	public void setId_comp(FLRParameteranwenderPK id_comp) {
		this.id_comp = id_comp;
	}
	...
	public boolean equals(Object other) {
		if ((this == other))
			return true;
		if (!(other instanceof FLRParameteranwender))
			return false;
		FLRParameteranwender castOther = (FLRParameteranwender) other;
