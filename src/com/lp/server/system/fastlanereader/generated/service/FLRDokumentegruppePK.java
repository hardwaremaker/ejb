...
public class FLRDokumentegruppePK implements Serializable {
	/**
	 * 
	 */
	...
	/** full constructor */
	public FLRDokumentegruppePK(String c_nr, String mandant_c_nr) {
		this.c_nr = c_nr;
		this.mandant_c_nr = mandant_c_nr;
	}

	/** default constructor */
	public FLRDokumentegruppePK() {
	}
	...
	public boolean equals(Object other) {
		if ((this == other))
			return true;
		if (!(other instanceof FLRDokumentegruppePK))
			return false;
		FLRDokumentegruppePK castOther = (FLRDokumentegruppePK) other;
