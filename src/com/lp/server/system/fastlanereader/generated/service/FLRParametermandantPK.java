...
public class FLRParametermandantPK implements Serializable {
	...
	/** full constructor */
	public FLRParametermandantPK(String c_nr, String mandant_c_nr,
			String c_kategorie) {
		this.c_nr = c_nr;
	...
	public String toString() {
		return new ToStringBuilder(this).append("c_nr", getC_nr()).append(
				"mandant_c_nr", getMandant_c_nr()).append("c_kategorie",
				getC_kategorie()).toString();
	}

	public boolean equals(Object other) {
		if ((this == other))
			return true;
		if (!(other instanceof FLRParametermandantPK))
			return false;
		FLRParametermandantPK castOther = (FLRParametermandantPK) other;
	...
	public int hashCode() {
		return new HashCodeBuilder().append(getC_nr())
				.append(getMandant_c_nr()).append(getC_kategorie())
				.toHashCode();
	}
