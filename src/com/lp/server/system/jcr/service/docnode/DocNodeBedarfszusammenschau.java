	...
	public class DocNodeBedarfszusammenschau extends DocNodeBase {
		...
		public DocNodeBedarfszusammenschau(Node node) {
			super(node);
		}
		
		public DocNodeBedarfszusammenschau(String mandantCNr) {
			super(BEDARFSZUSAMMENSCHAU);
		...
		public List<DocNodeBase> getHierarchy() {
			return new HeliumDocPath().add(new DocNodeLiteral(mandantCNr))
					.add(new DocNodeFolder(BELEGART_INTERNEBESTELLUNG))
					.add(this).asDocNodeList();
		}

		@Override
		public String asPath() {
			return BELEGART_INTERNEBESTELLUNG;
		}
