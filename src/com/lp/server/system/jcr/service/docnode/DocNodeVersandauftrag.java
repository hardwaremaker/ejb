...
public class DocNodeVersandauftrag extends DocNodeJCR {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6149301018207501035L;
	private int partnerIId;
	private String partnerName;

	public DocNodeVersandauftrag(Node node) {
		super(node);
	}

	public DocNodeVersandauftrag(VersandauftragDto versand, PersonalDto personal) {
		super(BELEGART_VERSANDAUFTRAG, versand.getIId(), String.valueOf(versand
				.getIId()), BELEGART_VERSANDAUFTRAG, personal.getMandantCNr());
