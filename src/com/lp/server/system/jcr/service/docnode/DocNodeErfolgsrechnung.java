...
public class DocNodeErfolgsrechnung extends DocNodeJCR {
	...
	public DocNodeErfolgsrechnung(Node node) {
		super(node);
	}

	public DocNodeErfolgsrechnung(ReportErfolgsrechnungKriterienDto krit, String mandantCNr) {
		super(BELEGART_ERFOLGSRECHNUNG, krit.getIPeriode(), String.valueOf(krit.getIPeriode()), BELEGART_ERFOLGSRECHNUNG, mandantCNr);
	...
	public List<DocNodeBase> getHierarchy() {
		...
		hierarchy.add(new DocNodeLiteral(String.valueOf(BELEGART_ERFOLGSRECHNUNG)));
		hierarchy.add(this);
