...
@MessageDriven(activationConfig= { 
		...
		@ActivationConfigProperty(propertyName="destination",propertyValue="topic/QSTopic"),
		@ActivationConfigProperty(propertyName="destinationType",propertyValue="javax.jms.Topic")
		} ) 
public class LPTopicQsBean implements MessageListener {
	private MessageDrivenContext messageDrivenContext = null;
	private ConnectionFactory connectionFactory = null;

	public final static String DESTINATION_TOPIC_NAME_QS = "topic/QSTopic";
	public final static String TOPIC_NAME_QS = "TopicQs";
	
	public LPTopicQsBean() {
		try {
