...
@MessageDriven(activationConfig= { 
		...
		@ActivationConfigProperty(propertyName="destination",propertyValue="topic/FertTopic"),
		@ActivationConfigProperty(propertyName="destinationType",propertyValue="javax.jms.Topic")
		} ) 
public class LPTopicFertBean implements MessageListener {
	private MessageDrivenContext messageDrivenContext = null;
	private ConnectionFactory connectionFactory = null;

	public final static String DESTINATION_TOPIC_NAME_FERT = "topic/FertTopic";
	public final static String TOPIC_NAME_FERT = "TopicFert";
	
	public LPTopicFertBean() {
		try {
