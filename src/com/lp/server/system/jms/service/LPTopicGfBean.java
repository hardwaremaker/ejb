...
@MessageDriven(activationConfig= { 
		...
		@ActivationConfigProperty(propertyName="destination",propertyValue="topic/GfTopic"),
		@ActivationConfigProperty(propertyName="destinationType",propertyValue="javax.jms.Topic")
		} ) 
public class LPTopicGfBean implements MessageListener{
	private MessageDrivenContext messageDrivenContext = null;
	private ConnectionFactory connectionFactory = null;

	public final static String DESTINATION_TOPIC_NAME_GF = "topic/GfTopic";
	public final static String TOPIC_NAME_GF = "TopicGf";
	
	public LPTopicGfBean() {
		try {
