...
public class AngeboterledigungsgrundsprDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AngeboterledigungsgrundsprDto)) {
			return false;
		}
		AngeboterledigungsgrundsprDto that = (AngeboterledigungsgrundsprDto) obj;
		if (!(that.localeCNr == null ? this.localeCNr == null : that.localeCNr
				.equals(this.localeCNr))) {
			return false;
		}
		if (!(that.angeboterledigungsgrundCNr == null ? this.angeboterledigungsgrundCNr == null
				: that.angeboterledigungsgrundCNr
						.equals(this.angeboterledigungsgrundCNr))) {
			return false;
		}
	...
	public int hashCode() {
		...
		result = 37 * result + this.angeboterledigungsgrundCNr.hashCode();
