...
public class AngebotartsprDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AngebotartsprDto)) {
			return false;
		}
		AngebotartsprDto that = (AngebotartsprDto) obj;
		if (!(that.localeCNr == null ? this.localeCNr == null : that.localeCNr
				.equals(this.localeCNr))) {
			return false;
		}
		if (!(that.angebotartCNr == null ? this.angebotartCNr == null
				: that.angebotartCNr.equals(this.angebotartCNr))) {
			return false;
		}
	...
	public int hashCode() {
		...
		result = 37 * result + this.angebotartCNr.hashCode();
