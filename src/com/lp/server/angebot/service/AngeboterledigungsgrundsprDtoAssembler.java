...
public class AngeboterledigungsgrundsprDtoAssembler {
	public static AngeboterledigungsgrundsprDto createDto(
			Angeboterledigungsgrundspr angeboterledigungsgrundspr) {
		AngeboterledigungsgrundsprDto angeboterledigungsgrundsprDto = new AngeboterledigungsgrundsprDto();
		if (angeboterledigungsgrundspr != null) {
			angeboterledigungsgrundsprDto
					.setLocaleCNr(angeboterledigungsgrundspr.getPk().getLocaleCNr());
			angeboterledigungsgrundsprDto
					.setAngeboterledigungsgrundCNr(angeboterledigungsgrundspr.getPk()
							.getAngeboterledigungsgrundCNr());
			angeboterledigungsgrundsprDto.setCBez(angeboterledigungsgrundspr
					.getCBez());
		}
		return angeboterledigungsgrundsprDto;
	}

	public static AngeboterledigungsgrundsprDto[] createDtos(
		...
		if (angeboterledigungsgrundsprs != null) {
			...
			while (iterator.hasNext()) {
				list
						.add(createDto((Angeboterledigungsgrundspr) iterator
								.next()));
			}
		}
