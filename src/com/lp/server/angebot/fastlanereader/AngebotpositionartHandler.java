...
import com.lp.server.angebot.fastlanereader.generated.FLRAngebotpositionart;
...
/**
 * <p>
 * <I>FLR fuer ANGB_ANGEBOTPOSITIONART.</I>
 * </p>
 * 
 * <p>
 ...
 * @version 1.0
 */
public class AngebotpositionartHandler extends UseCaseHandler {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public static final String FLR_ANGEBOTPOSITIONART = "flrangebotpositionart.";
	public static final String FLR_ANGEBOTPOSITIONART_FROM_CLAUSE = " from FLRAngebotpositionart flrangebotpositionart ";
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				FLRAngebotpositionart positionart = (FLRAngebotpositionart) resultListIterator
						.next();
		...
		if (this.getQuery() != null && this.getQuery().getFilterBlock() != null
			...
			for (int i = 0; i < filterKriterien.length; i++) {
				if (filterKriterien[i].isKrit) {
					...
					filterAdded = true;
					where.append(" " + FLR_ANGEBOTPOSITIONART
			...
			if (kriterien != null && kriterien.length > 0) {
				for (int i = 0; i < kriterien.length; i++) {
					if (kriterien[i].isKrit) {
						...
						sortAdded = true;
						orderBy.append(FLR_ANGEBOTPOSITIONART
				...
				orderBy.append(FLR_ANGEBOTPOSITIONART).append("i_sort").append(
						" ASC ");
				sortAdded = true;
			}
			if (orderBy.indexOf(FLR_ANGEBOTPOSITIONART + "i_sort") < 0) {
				...
				orderBy.append(" ").append(FLR_ANGEBOTPOSITIONART).append(
						"i_sort").append(" ");
				sortAdded = true;
			}
			if (sortAdded) {
	...
	private String getFromClause() {
		return FLR_ANGEBOTPOSITIONART_FROM_CLAUSE;
	}
	...
	public TableInfo getTableInfo() {
		if (super.getTableInfo() == null) {
			setTableInfo(new TableInfo(new Class[] { String.class,
					...
					AngebotServiceFac.FLR_ANGEBOTPOSITIONART_POSITIONSART_C_NR,
					AngebotServiceFac.FLR_ANGEBOTPOSITIONART_POSITIONSART_C_NR,
					"i_sort" }));
		}
		...
		if (selectedId != null) {
			...
			try {
				...
				String queryString = "select "
						+ FLR_ANGEBOTPOSITIONART
						+ AngebotServiceFac.FLR_ANGEBOTPOSITIONART_POSITIONSART_C_NR
						+ FLR_ANGEBOTPOSITIONART_FROM_CLAUSE
