...
public class AngebotzeitenHandler extends UseCaseHandlerTabelle {
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			for (int row = 0; row < getAnzahlZeilen(); row++) {
				...
				FilterKriterium fkAuswertung = aFilterKriterium[AngebotFac.IDX_KRIT_AUSWERTUNG];
				...
				if (fkAuswertung.kritName.equals(AngebotFac.KRIT_PERSONAL)) {
				...
				} else if (fkAuswertung.kritName.equals(AngebotFac.KRIT_IDENT)) {
					if (hmKoepfe
