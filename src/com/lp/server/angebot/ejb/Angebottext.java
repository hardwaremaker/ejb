...
@NamedQueries( { @NamedQuery(name = "AngebottextfindByMandantCNrLocaleCNrMediaartCNr", query = "SELECT OBJECT (o) FROM Angebottext o WHERE o.mandantCNr=?1 AND o.localeCNr=?2 AND o.mediaartCNr=?3") })
@Entity
@Table(name = "ANGB_ANGEBOTTEXT")
public class Angebottext implements Serializable {
	@Id
	@Column(name = "I_ID")
	private Integer iId;
	...
	public Angebottext(Integer id, String mandantCNr, String localeCNr,
