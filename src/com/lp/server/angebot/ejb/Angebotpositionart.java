...
@NamedQueries( {
		@NamedQuery(name = "AngebotpositionartfindAll", query = "SELECT OBJECT (o) FROM Angebotpositionart o ORDER BY o.iSort"),
		@NamedQuery(name = "AngebotpositionartfindAllEnable", query = "SELECT OBJECT (o) FROM Angebotpositionart o  WHERE o.bVersteckt=0 ORDER BY o.iSort") })
@Entity
@Table(name = "ANGB_ANGEBOTPOSITIONART")
public class Angebotpositionart implements Serializable {
	@Id
	...
	public Angebotpositionart() {
		super();
	}

	public Angebotpositionart(String positionsartCNr, Integer iSort,
			Short bVersteckt) {
