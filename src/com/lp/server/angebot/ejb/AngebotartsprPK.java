...
@Embeddable
public class AngebotartsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "ANGEBOTART_C_NR", insertable = false, updatable = false)
	private String angebotartCNr;

	private static final long serialVersionUID = 1L;

	public AngebotartsprPK(String localeCNr, String angebotartCNr) {
		setLocaleCNr(localeCNr);
		setAngebotartCNr(angebotartCNr);
	}

	public AngebotartsprPK() {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof AngebotartsprPK)) {
			return false;
		}
		AngebotartsprPK other = (AngebotartsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.angebotartCNr.equals(other.angebotartCNr);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.angebotartCNr.hashCode();
		return hash;
	}
