...
@Embeddable
public class AngeboterledigungsgrundsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "ANGEBOTERLEDIGUNGSGRUND_C_NR", insertable = false, updatable = false)
	private String angeboterledigungsgrundCNr;

	private static final long serialVersionUID = 1L;

	public AngeboterledigungsgrundsprPK() {
		super();
	}

	public AngeboterledigungsgrundsprPK(String angeboterledigungsgrundCNr,
			String localeCNr) {
		setAngeboterledigungsgrundCNr(angeboterledigungsgrundCNr);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof AngeboterledigungsgrundsprPK)) {
			return false;
		}
		AngeboterledigungsgrundsprPK other = (AngeboterledigungsgrundsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.angeboterledigungsgrundCNr
						.equals(other.angeboterledigungsgrundCNr);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.angeboterledigungsgrundCNr.hashCode();
		return hash;
	}
