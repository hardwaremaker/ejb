...
public class ImportColumnQueryBuilderHerstellerBez implements IImportColumnQueryBuilder {
	
	private static final String QUERY = Artikel + ".c_artikelbezhersteller like '%{VALUE}%'";
