...
public class StklImportSearchHelperVerkauf extends StklImportSearchHelper {

	private Integer kundeIId;

	public StklImportSearchHelperVerkauf(StklImportSpezifikation spez,
	...
	protected void initImportColumnsMap() {
		...
		importColumns.put(StklImportSpezifikation.KUNDENARTIKELNUMMER,
		...
		importColumns.put(StklImportSpezifikation.HERSTELLER, 
				new ImportColumnQueryBuilderHersteller());
	}
