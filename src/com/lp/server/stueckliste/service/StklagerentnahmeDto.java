...
public class StklagerentnahmeDto implements Serializable {
	/**
	 * 
	 */
	...
	public void setStuecklisteIId(Integer losIId) {
		this.stuecklisteIId = losIId;
	}
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof StklagerentnahmeDto))
			return false;
		StklagerentnahmeDto that = (StklagerentnahmeDto) obj;
		if (!(that.iId == null ? this.iId == null : that.iId.equals(this.iId)))
			return false;
		if (!(that.stuecklisteIId == null ? this.stuecklisteIId == null : that.stuecklisteIId
				.equals(this.stuecklisteIId)))
			return false;
