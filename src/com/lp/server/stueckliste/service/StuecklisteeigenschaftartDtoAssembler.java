...
public class StuecklisteeigenschaftartDtoAssembler {
	public static StuecklisteeigenschaftartDto createDto(
			Stuecklisteeigenschaftart stuecklisteeigenschaftart) {
		StuecklisteeigenschaftartDto stuecklisteeigenschaftartDto = new StuecklisteeigenschaftartDto();
		if (stuecklisteeigenschaftart != null) {
			stuecklisteeigenschaftartDto.setIId(stuecklisteeigenschaftart
					.getIId());
			stuecklisteeigenschaftartDto.setCBez(stuecklisteeigenschaftart
					.getCBez());
			stuecklisteeigenschaftartDto.setISort(stuecklisteeigenschaftart
					.getISort());
		}
		return stuecklisteeigenschaftartDto;
	}

	public static StuecklisteeigenschaftartDto[] createDtos(
		...
		if (stuecklisteeigenschaftarts != null) {
			...
			while (iterator.hasNext()) {
				list
						.add(createDto((Stuecklisteeigenschaftart) iterator
								.next()));
			}
		}
