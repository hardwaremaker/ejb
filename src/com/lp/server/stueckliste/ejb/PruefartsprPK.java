...
@Embeddable
public class PruefartsprPK implements Serializable {
	@Column(name = "LOCALE_C_NR", insertable = false, updatable = false)
	private String localeCNr;

	@Column(name = "PRUEFART_I_ID", insertable = false, updatable = false)
	...
	public PruefartsprPK(String locUiAsString, Integer pruefartIId) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof PruefartsprPK)) {
			return false;
		}
		PruefartsprPK other = (PruefartsprPK) o;
		return this.localeCNr.equals(other.localeCNr)
				&& this.pruefartIId.equals(other.pruefartIId);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.pruefartIId.hashCode();
		return hash;
	}
