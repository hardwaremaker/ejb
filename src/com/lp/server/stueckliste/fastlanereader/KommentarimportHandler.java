...
import com.lp.server.stueckliste.fastlanereader.generated.FLRKommentarimport;
 ...
 * @version 1.0
 */
public class KommentarimportHandler extends UseCaseHandler {
...
//			String locale = theClientDto.getLocUiAsString();
			while (resultListIterator.hasNext()) {
				...
				rows[row][col++] = artikelkommentar.getBelegart_c_nr();
			...
			for (int i = 0; i < filterKriterien.length; i++) {
				if (filterKriterien[i].isKrit) {
					...
					if (filterKriterien[i].isBIgnoreCase()) {
						where.append(" upper(kommentarimport."
								+ filterKriterien[i].kritName + ")");
					} else {
						where.append(" kommentarimport."
								+ filterKriterien[i].kritName);
					}
	...
	private String buildOrderByClause() {
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				for (int i = 0; i < kriterien.length; i++) {
					if (!kriterien[i].kritName
						...
						if (kriterien[i].isKrit) {
							...
							sortAdded = true;
							orderBy.append("kommentarimport."
				...
				orderBy.append("kommentarimport.belegart_c_nr ASC ");
				sortAdded = true;
			}
			if (orderBy.indexOf("kommentarimport.belegart_c_nr") < 0) {
				...
				orderBy.append(" kommentarimport.belegart_c_nr ");
				sortAdded = true;
			}
			if (sortAdded) {
	...
	private String getFromClause() {
		return "from FLRKommentarimport as kommentarimport ";
	}
	...
	public QueryResult sort(SortierKriterium[] sortierKriterien,
		...
		if (selectedId != null && ((Integer) selectedId).intValue() >= 0) {
			...
			try {
				session = factory.openSession();
				String queryString = "select kommentarimport.i_id from FLRKommentarimport kommentarimport "
