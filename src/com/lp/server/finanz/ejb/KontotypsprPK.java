...
@Embeddable
public class KontotypsprPK implements Serializable {
	...
	public KontotypsprPK() {
		super();
	}

	public KontotypsprPK(String nr, String locale) {
		setKontotypCNr(nr);
		setLocaleCNr(locale);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof KontotypsprPK)) {
			return false;
		}
		KontotypsprPK other = (KontotypsprPK) o;
		return this.kontotypCNr.equals(other.kontotypCNr)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.kontotypCNr.hashCode();
