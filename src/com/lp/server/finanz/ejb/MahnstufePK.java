...
@Embeddable
public class MahnstufePK implements Serializable {
	...
	public MahnstufePK(Integer mahnstufeIId, String mandantCNr) {
		setIId(mahnstufeIId);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof MahnstufePK)) {
			return false;
		}
		MahnstufePK other = (MahnstufePK) o;
