...
@Embeddable
public class UvaartsprPK implements Serializable {
	...
	public UvaartsprPK(Integer iId, String locale) {
		setUvaartIId(iId);
		setLocaleCNr(locale);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof UvaartsprPK)) {
			return false;
		}
		UvaartsprPK other = (UvaartsprPK) o;
		return this.uvaartIId.equals(other.uvaartIId)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.uvaartIId.hashCode();
