...
@Embeddable
public class BuchungsartsprPK implements Serializable {
	...
	public BuchungsartsprPK() {
		super();
	}

	public BuchungsartsprPK(String nr, String locale) {
		setBuchungsartCNr(nr);
		setLocaleCNr(locale);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof BuchungsartsprPK)) {
			return false;
		}
		BuchungsartsprPK other = (BuchungsartsprPK) o;
		return this.buchungsartCNr.equals(other.buchungsartCNr)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.buchungsartCNr.hashCode();
