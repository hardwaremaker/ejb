...
public class KontoHandlerAuswahl extends KontoHandler {
	/**
	 * 
	 */
	...
	protected TableInfo produceTableInfo() {
		// hier etwas anders, wegen vererbung.
		...
		return new TableInfo(new Class[] { Integer.class, String.class,
				...
				new int[] { -1, 6, -1 }, new String[] {
						FinanzFac.FLR_KONTO_I_ID, FinanzFac.FLR_KONTO_C_NR,
