...
import com.lp.server.finanz.fastlanereader.generated.FLRKontoLand;
 ...
 *         </p>
 * 
 * @version unbekannt Date $Date: 2009/04/28 08:32:43 $
 */
public class KontoLandHandler extends UseCaseHandler {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final String FLR_KONTOLAND = "flrkontoland.";
	private static final String FLR_KONTOLAND_FROM_CLAUSE = " from FLRKontoLand flrkontoland ";

	public KontoLandHandler() {
		super();
	}
	...
	private String buildOrderByClause() {
		...
		if (this.getQuery() != null) {
			...
			if (kriterien != null && kriterien.length > 0) {
				for (int i = 0; i < kriterien.length; i++) {
					if (kriterien[i].isKrit) {
						...
						sortAdded = true;
						orderBy.append(FLR_KONTOLAND + kriterien[i].kritName);
						orderBy.append(" ");
			...
			if (orderBy.indexOf(FLR_KONTOLAND
				...
				orderBy.append(" ").append(FLR_KONTOLAND).append(
						FinanzFac.FLR_KONTOLAND_FLRKONTOUEBERSETZT + "."
	...
	private String getFromClause() {
		return FLR_KONTOLAND_FROM_CLAUSE;
	}
