...
public class KontoHandlerKreditorenkonten extends KontoHandler {

	private static final long serialVersionUID = -5119001930441252997L;
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				...
				rows[row][col++] = konto.getSteuerkategorie_c_nr() ;
...
//						getTextRespectUISpr("lp.kurzbezeichnung", mandantCNr, locUI),
				...
				new int[] { -1, 6, 40, -1, 25, 0 },
				new String[] {
						FinanzFac.FLR_KONTO_I_ID,
						FinanzFac.FLR_KONTO_C_NR,
						FinanzFac.FLR_KONTO_C_BEZ,
						"steuerkategorie_c_nr",
						FinanzFac.FLR_KONTO_FINANZAMT_I_ID,
						""
						});
	}
}
