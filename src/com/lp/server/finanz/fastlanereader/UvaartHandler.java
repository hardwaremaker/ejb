...
/**
 * <p>
 * Hier wird die FLR Funktionalitaet fuer die UVA-Arten
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class UvaartHandler extends UseCaseHandler {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public static final String FLR_UVAART = "flruvaart.";
	public static final String FLR_UVAART_FROM_CLAUSE = " from FLRFinanzUVAArt flruvaart ";
		...
		if (this.getQuery() != null && this.getQuery().getFilterBlock() != null
			...
			for (int i = 0; i < filterKriterien.length; i++) {
				if (filterKriterien[i].isKrit) {
					...
					filterAdded = true;
					where.append(" " + FLR_UVAART + filterKriterien[i].kritName);
			...
			if (kriterien != null && kriterien.length > 0) {
				for (int i = 0; i < kriterien.length; i++) {
					if (kriterien[i].isKrit) {
						...
						sortAdded = true;
						orderBy.append(FLR_UVAART + kriterien[i].kritName);
						orderBy.append(" ");
				...
				orderBy.append(FLR_UVAART).append(FinanzFac.FLR_UVAART_I_SORT)
						.append(" ASC ");
				sortAdded = true;
			}
			if (orderBy.indexOf(FLR_UVAART + FinanzFac.FLR_UVAART_C_NR) < 0) {
				...
				orderBy.append(" ").append(FLR_UVAART)
						.append(FinanzFac.FLR_UVAART_C_NR).append(" ");
				sortAdded = true;
			}
			if (sortAdded) {
	...
	public QueryResult sort(SortierKriterium[] sortierKriterien,
		...
		if (selectedId != null) {
			...
			try {
				session = factory.openSession();
				String queryString = "select " + FLR_UVAART + "i_id"
						+ FLR_UVAART_FROM_CLAUSE + this.buildWhereClause()
						+ this.buildOrderByClause();
				Query query = session.createQuery(queryString);
