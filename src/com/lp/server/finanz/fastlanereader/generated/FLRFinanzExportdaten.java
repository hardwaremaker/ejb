...
public class FLRFinanzExportdaten implements Serializable {
	...
	/** nullable persistent field */
	private com.lp.server.finanz.fastlanereader.generated.FLRFinanzExportlauf flrexportlauf;

	/** nullable persistent field */
	private FLRBelegart flrbelegart;

	/** full constructor */
	public FLRFinanzExportdaten(
			String belegart_c_nr,
			Integer i_belegiid,
			com.lp.server.finanz.fastlanereader.generated.FLRFinanzExportlauf flrexportlauf,
			FLRBelegart flrbelegart) {
		this.belegart_c_nr = belegart_c_nr;
		this.i_belegiid = i_belegiid;
		this.flrexportlauf = flrexportlauf;
	...
	public com.lp.server.finanz.fastlanereader.generated.FLRFinanzExportlauf getFlrexportlauf() {
		return this.flrexportlauf;
	}

	public void setFlrexportlauf(
			com.lp.server.finanz.fastlanereader.generated.FLRFinanzExportlauf flrexportlauf) {
		this.flrexportlauf = flrexportlauf;
	}
