...
public class FLRFinanzKassenbuch implements Serializable {
	...
	public Short getB_hauptkassenbuch() {
		return this.b_hauptkassenbuch;
	}

	public void setB_hauptkassenbuch(Short b_hauptkassenbuch) {
		this.b_hauptkassenbuch = b_hauptkassenbuch;
	}
