...
public class BankverbindungDtoAssembler {
	public static BankverbindungDto createDto(Bankverbindung bankverbindung) {
		...
		if (bankverbindung != null) {
			...
			bankverbindungDto.setCSepaVerzeichnis(bankverbindung.getCSepaVerzeichnis());
			bankverbindungDto.setbFuerSepaLastschrift(
					Helper.short2boolean(bankverbindung.getbFuerSepaLastschrift()));
			bankverbindungDto.setbAlsGeldtransitkonto(Helper.short2boolean(bankverbindung.getbAlsGeldtransitkonto()));
			bankverbindungDto.setIStellenAuszugsnummer(bankverbindung.getIStellenAuszugsnummer());
		}
