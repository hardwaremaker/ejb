...
public class SepaXmlUnmarshallerCamt052V02 extends SepaXmlUnmarshaller {
	...
	private String v02Part1 = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>\r\n" + 
			...
			"<xs:schema xmlns=\"urn:iso:std:iso:20022:tech:xsd:camt.052.001.02\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" elementFormDefault=\"qualified\" targetNamespace=\"urn:iso:std:iso:20022:tech:xsd:camt.052.001.02\">\r\n" + 
			...
			"            <xs:element maxOccurs=\"unbounded\" minOccurs=\"0\" name=\"Bal\" type=\"CashBalance3\"/>\r\n" + 
			...
			"            <xs:element maxOccurs=\"1\" minOccurs=\"0\" name=\"AddtlRptInf\" type=\"Max500Text\"/>\r\n" + 
			"        </xs:sequence>\r\n" + 
			"    </xs:complexType>\r\n" + 
			...
			"            <xs:element maxOccurs=\"unbounded\" minOccurs=\"1\" name=\"Rpt\" type=\"AccountReport11\"/>\r\n" + 
			"        </xs:sequence>\r\n" + 
			"    </xs:complexType>\r\n" + 
	...
	public SepaXmlUnmarshallerCamt052V02() {
	}

	@Override
	public Object unmarshal(String xmlContent) throws JAXBException,
			SAXException {
		Object sepaStmt = unmarshal(xsdSchemaV02ISO, xmlContent, CA052Document.class);
