...
/**
 * Factory zur Erzeugung des SepaTransformers nach Version
 * 
 * @author andi
 *
 */
public class SepaTransformerFactory {

	public SepaImportTransformer getImportTransformer(ISepaCamtFormat camtFormat, String lkz) {
		...
		if (SepaCamtFormatEnum.CAMT053.equals(camtFormat.getCamtFormatEnum())) {
			if(SepaCamtVersionEnum.VERSION02.equals(camtFormat.getCamtVersionEnum())) {
				return new SepaImportTransformerCamt053V02(lkz);
			}	
			if(SepaCamtVersionEnum.VERSION05.equals(camtFormat.getCamtVersionEnum())) {
				return new SepaImportTransformerCamt053V05(lkz);
			}
		}
		
		if (SepaCamtFormatEnum.CAMT052.equals(camtFormat.getCamtFormatEnum())) {
			if(SepaCamtVersionEnum.VERSION02.equals(camtFormat.getCamtVersionEnum())) {
				return new SepaImportTransformerCamt052V02(lkz);
			}	
		}
