...
/**
 * Sucht nach Rechnungen mit Belegdatum kleiner dem Buchungsdatum
 * 
 * @author andi
 *
 */
public class SepaImportQueryBuilderArBelegdatum extends
		SepaImportQueryBuilderAr {

	private Date buchungsdatum;
	
	public SepaImportQueryBuilderArBelegdatum(String mandantCNr,
			List<String> stati) {
	...
	public List<Integer> getResultList(EntityManager em) {
		List<Rechnung> rechnungen = RechnungQuery
