...
/**
 * Sucht nach der Lieferantenrechnungsnummer der Eingangsrechnungen
 * im Verwendungszweck
 * 
 * @author andi
 *
 */
public class SepaImportQueryBuilderLiefReNr extends SepaImportQueryBuilderEr {

	public SepaImportQueryBuilderLiefReNr(String mandantCNr, List<String> stati) {
	...
	protected void buildWhereCriterion() {
		wheres.add(getCritValueWithSingleQuotes() + " LIKE '%' || " + Eingangsrechnung + ".c_lieferantenrechnungsnummer || '%'");
	}

	@Override
	public boolean setValueForCriterionImpl(SepaZahlung payment, SepaBuchung booking) {
		if (payment.getVerwendungszweck() == null) return false;
