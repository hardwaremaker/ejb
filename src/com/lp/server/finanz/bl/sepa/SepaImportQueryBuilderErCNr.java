...
/**
 * Sucht nach Eingangsrechnung-CNr im Verwendungszweck
 * 
 * @author andi
 *
 */
public class SepaImportQueryBuilderErCNr extends SepaImportQueryBuilderEr {

	public SepaImportQueryBuilderErCNr(String mandantCNr, List<String> stati) {
	...
	protected void buildWhereCriterion() {
		wheres.add(getCritValueWithSingleQuotes() + getLikeClauseForCNrSearch(Eingangsrechnung));
	}
