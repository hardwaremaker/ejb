...
/**
 * <p>
 * Diese Klasse kuemmert sich um den Export von Personenkonten in BMD.
 * </p>
 * 
 * <p>
 * Copyright Logistik Pur Software GmbH (c) 2004-2007
 * </p>
 * FibuKontoExportFormatterBMD //MR 20080403: BMD Kontenexport ist zurzeit genau
 * gleich wie RZL.
 * <p>
 * Erstellung: Markus Rabenberger
 * 
 * @version not attributable Date $Date: 2009/01/12 17:38:32 $
 */
class FibuKontoExportFormatterBMD extends FibuKontoExportFormatter {

	/**
	 * Satzart 0 - FIBU-Buchungssatz, oder Satzart 1 -
	 * Kostenrechnungsaufteilung, oder Satzart 2 - mehrzeiliger Buchungstext
	 * (nur bei fixem Satzaufbau) Zurzeit wird nur Satzart 0 unterstuetzt
	 */
	...
	protected String exportiereDaten(FibuKontoExportDto[] fibuExportDtos,
		...
		for (int i = 0; i < fibuExportDtos.length; i++) {
			...
			// Satzart ist default FIBU-Buchungssatz
			mt.addParameter(P_SATZART, "0");

			// Die Kontonummer darf laut Exportbeschreibung max. 9 Stellen haben
			if (kontoDto.getCNr().length() > 9) {
				EJBExceptionLP e = new EJBExceptionLP(
						EJBExceptionLP.FEHLER_FINANZ_EXPORT_BMD_KONTONUMMER_MAXIMAL_9_STELLEN,
						new Exception("Konto " + kontoDto.getCNr()
								+ " hat mehr als 9 Stellen"));
