...
public interface BelegbuchungFac {
	...
	public BuchungInfoDto verbucheRechnung(Integer rechnungIId, TheClientDto theClientDto)
			throws EJBExceptionLP, RemoteException;
...
//	public BuchungDto verbucheZahlung(Integer zahlungIId, TheClientDto theClientDto, String kommentar)
//			throws EJBExceptionLP, RemoteException;
	...
	public List<BucheBelegPeriodeInfoDto> verbucheBelegePeriode(
			Integer geschaeftsjahr, int periode, boolean alleNeu, TheClientDto theClientDto)
			throws EJBExceptionLP, RemoteException;
...
/*	
	public void belegbuchungenAusziffernWennNoetig(Integer kontoIId, TheClientDto theClientDto,
...
*/
	...
	void belegbuchungenAusziffernWennNoetig(Integer kontoIId,
