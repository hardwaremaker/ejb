...
public class MahnstufeDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof MahnstufeDto))
			return false;
		MahnstufeDto that = (MahnstufeDto) obj;
		...
		if (!(that.iTage == null ? this.iTage == null : that.iTage
				.equals(this.iTage)))
			return false;
		if (!(that.nMahnspesen == null ? this.nMahnspesen == null
				: that.nMahnspesen.equals(this.nMahnspesen)))
			return false;
		if (!(that.fZinssatz == null ? this.fZinssatz == null : that.fZinssatz
				.equals(this.fZinssatz)))
			return false;
		return true;
	}
	...
	public int hashCode() {
		...
		result = 37 * result + this.nMahnspesen.hashCode();
		result = 37 * result + this.fZinssatz.hashCode();
		return result;
	}
	...
	public String toString() {
		...
		returnString += ", " + iTage;
		returnString += ", " + nMahnspesen;
		returnString += ", " + fZinssatz;
		return returnString;
	}
}
