...
public class FibuExportKriterienDto implements java.io.Serializable {
	...
	public FibuExportKriterienDto() {
	}
	
	public FibuExportKriterienDto(boolean auchBelegeAusserhalbGueltigkeitszeitraum) {
		this.bAuchBelegeAusserhalbGueltigkeitszeitraum = auchBelegeAusserhalbGueltigkeitszeitraum ;
	}
