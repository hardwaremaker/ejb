...
public class BuchungsartsprDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof BuchungsartsprDto)) {
			return false;
		}
		BuchungsartsprDto that = (BuchungsartsprDto) obj;
	...
	public int hashCode() {
		int result = 17;
		result = 37 * result + this.buchungsartCNr.hashCode();
