...
public class ReportUvaKriterienDto implements Serializable {

	private static final long serialVersionUID = 1L;

	private int iGeschaeftsjahr;
	
	private int iPeriode = 1;
	...
	public int getIPeriode() {
		return iPeriode;
	}

	public void setIGeschaeftsjahr(int iGeschaeftsjahr) {
		this.iGeschaeftsjahr = iGeschaeftsjahr;
	}

	public int getIGeschaeftsjahr() {
		return iGeschaeftsjahr;
	}

	public void setSPeriode(String sPeriode) {
		this.sPeriode = sPeriode;
	}

	public String getSPeriode() {
		return sPeriode;
	}
	...
	public void setSAbrechnungszeitraum(String sAbrechnungszeitraum) {
		this.sAbrechnungszeitraum = sAbrechnungszeitraum;
	}
