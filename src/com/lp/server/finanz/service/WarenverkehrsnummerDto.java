...
public class WarenverkehrsnummerDto implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof WarenverkehrsnummerDto))
			return false;
		WarenverkehrsnummerDto that = (WarenverkehrsnummerDto) obj;
