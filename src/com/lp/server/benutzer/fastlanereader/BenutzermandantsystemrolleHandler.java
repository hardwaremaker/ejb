 ...
 * @version 1.0
 */
public class BenutzermandantsystemrolleHandler extends UseCaseHandler {
	 ...
	 * Konstruktor.
	 */
	public BenutzermandantsystemrolleHandler() {
	}
	...
	public QueryResult sort(SortierKriterium[] sortierKriterien,
		...
		if (selectedId != null && ((Integer) selectedId).intValue() >= 0) {
			...
			try {
				session = factory.openSession();
				String queryString = "select benutzermandantsystemrolle.i_id from FLRBenutzermandantsystemrolle benutzermandantsystemrolle "
	...
	public TableInfo getTableInfo() {
		if (super.getTableInfo() == null) {
			setTableInfo(new TableInfo(
					...
					new String[] {
							"Id",
							getTextRespectUISpr("lp.benutzerkennung", theClientDto
