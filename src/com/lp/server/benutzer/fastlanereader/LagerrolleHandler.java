 ...
 * @version 1.0
 */
public class LagerrolleHandler extends UseCaseHandler {
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				...
				FLRLagerrolle artikelkommentarart = (FLRLagerrolle) resultListIterator
						.next();
	...
	protected long getRowCountFromDataBase() {
		...
		try {
			...
			String queryString = "SELECT COUNT(*) FROM FLRLagerrolle AS lagerrolle"
					+ buildWhereClause();
	...
	private String getFromClause() {
		return " FROM FLRLagerrolle AS lagerrolle";
	}
			...
			try {
				...
				if (scrollableResult != null) {
					...
					while (scrollableResult.next()) {
						FLRLagerrolle artikelkommentarart = (FLRLagerrolle) scrollableResult
								.get(0);
		...
		if (super.getTableInfo() == null) {
			setTableInfo(new TableInfo(new Class[] { Integer.class,
					...
					new String[] {
							...
							BenutzerFac.FLR_LAGERROLLE_FLRLAGER
									+ ".mandant_c_nr" }));
