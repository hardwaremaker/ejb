...
public class BenutzermandantsystemrolleDtoAssembler {
	public static BenutzermandantsystemrolleDto createDto(
		...
		if (benutzermandantsystemrolle != null) {
			...
			benutzermandantsystemrolleDto.setSystemrolleIIdRestapi(
					benutzermandantsystemrolle.getSystemrolleIIdRestapi());
			benutzermandantsystemrolleDto.setSystemrolleIIdHvma(
					benutzermandantsystemrolle.getSystemrolleIIdHvma());
		}
