...
@NamedQueries( {
		@NamedQuery(name = "RechtfindByCNr", query = "SELECT OBJECT(C) FROM Recht c WHERE c.cNr = ?1"),
		@NamedQuery(name = "RechtfindAll", query = "SELECT OBJECT(c) FROM Recht c") })
@Entity
@Table(name = "PERS_RECHT")
