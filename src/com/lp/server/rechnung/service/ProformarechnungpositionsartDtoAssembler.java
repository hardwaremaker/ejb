...
public class ProformarechnungpositionsartDtoAssembler {
	public static ProformarechnungpositionsartDto createDto(
			Proformarechnungpositionsart proformarechnungpositionsart) {
		ProformarechnungpositionsartDto proformarechnungpositionsartDto = new ProformarechnungpositionsartDto();
		if (proformarechnungpositionsart != null) {
			proformarechnungpositionsartDto
					.setPositionsartCNr(proformarechnungpositionsart
							.getPositionsartCNr());
			proformarechnungpositionsartDto
					.setISort(proformarechnungpositionsart.getISort());
		}
		return proformarechnungpositionsartDto;
	}

	public static ProformarechnungpositionsartDto[] createDtos(
		...
		if (proformarechnungpositionsarts != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Proformarechnungpositionsart) iterator
						.next()));
			}
		}
