...
public class GutschriftsgrundsprDto implements Serializable {
	...
	public Integer getGutschriftsgrundIId() {
		return gutschriftsgrundIId;
	}

	public void setGutschriftsgrundIId(Integer brancheIId) {
		this.gutschriftsgrundIId = brancheIId;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof GutschriftsgrundsprDto)) {
			return false;
		}
		GutschriftsgrundsprDto that = (GutschriftsgrundsprDto) obj;
	...
	public String toString() {
		String returnString = "";
		returnString += gutschriftsgrundIId;
