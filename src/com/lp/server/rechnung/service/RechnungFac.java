...
public interface RechnungFac extends IAktivierbarControlled{
	...
	public RechnungDto[] rechnungFindByKundeIIdMandantCNrOhneExc(
			Integer kundeIId, String mandantCNr) throws RemoteException;
	...
	public RechnungDto[] rechnungFindByBelegdatumVonBis(String mandantCNr,
			Date dVon, Date dBis) throws RemoteException;
	 ...
	 * lsPosDto, TheClientDto theClientDto) throws EJBExceptionLP,
	 * RemoteException;
	 * 
	...
	public RechnungPositionDto[] rechnungPositionFindByRechnungIIdArtikelIId(
			Integer positionIId, Integer artikelIId) throws EJBExceptionLP,
			RemoteException;

	public Integer getLastPositionNummer(Integer reposIId)
			throws EJBExceptionLP, RemoteException;

	public Integer getPositionNummer(Integer reposIId) throws EJBExceptionLP,
			RemoteException;
	...
	public RechnungPositionDto rechnungPositionFindByLieferscheinIId(
			Integer lieferscheinIId) throws EJBExceptionLP, RemoteException;
