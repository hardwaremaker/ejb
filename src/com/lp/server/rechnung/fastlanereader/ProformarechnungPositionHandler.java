...
import com.lp.server.system.jcr.service.docnode.DocNodeGutsPosition;
import com.lp.server.system.jcr.service.docnode.DocNodeProformaPosition;
import com.lp.server.system.jcr.service.docnode.DocPath;

/**
 * <p>
 * Hier wird die FLR Funktionalitaet fuer die ProformarechnungPosition
...
public class ProformarechnungPositionHandler extends PositionHandler {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;public PrintInfoDto getSDocPathAndPartner(Object key) {
...
//					+ "Gutschriftpositionen/" + "Position "
//					+ rechnungPositionDto.getIId();
			DocPath docPath = new DocPath(new DocNodeProformaPosition(rechnungPositionDto, rechnungDto));
