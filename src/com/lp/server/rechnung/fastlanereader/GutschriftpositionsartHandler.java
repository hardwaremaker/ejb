...
import com.lp.server.rechnung.fastlanereader.generated.FLRGutschriftpositionsart;
 ...
 */
public class GutschriftpositionsartHandler extends UseCaseHandler {
	...
	private static final String FLR_GUTSCHRIFTPOSITIONSART = "flrGutschriftpositionsart.";
	private static final String FLR_GUTSCHRIFTPOSITIONSART_FROM_CLAUSE = " from FLRGutschriftpositionsart flrGutschriftpositionsart ";
	...
	public QueryResult getPageAt(Integer rowIndex) throws EJBExceptionLP {
		...
		try {
			...
			while (resultListIterator.hasNext()) {
				...
				FLRGutschriftpositionsart art = (FLRGutschriftpositionsart) o[0];
		...
		if (this.getQuery() != null && this.getQuery().getFilterBlock() != null
			...
			for (int i = 0; i < filterKriterien.length; i++) {
				if (filterKriterien[i].isKrit) {
					...
					filterAdded = true;
					where.append(" " + FLR_GUTSCHRIFTPOSITIONSART
			...
			if (kriterien != null && kriterien.length > 0) {
				for (int i = 0; i < kriterien.length; i++) {
					if (kriterien[i].isKrit) {
						...
						sortAdded = true;
						orderBy.append(FLR_GUTSCHRIFTPOSITIONSART
				...
				orderBy.append(FLR_GUTSCHRIFTPOSITIONSART).append("i_sort")
						.append(" ASC ");
				sortAdded = true;
			}
			if (orderBy.indexOf(FLR_GUTSCHRIFTPOSITIONSART + "i_sort") < 0) {
				...
				orderBy.append(" ").append(FLR_GUTSCHRIFTPOSITIONSART).append(
						"i_sort").append(" ");
				sortAdded = true;
			}
			if (sortAdded) {
	...
	private String getFromClause() {
		return FLR_GUTSCHRIFTPOSITIONSART_FROM_CLAUSE
				+ " LEFT JOIN "
				+ FLR_GUTSCHRIFTPOSITIONSART
				+ RechnungFac.FLR_GUTSCHRIFTPOSITIONSART_GUTSCHRIFTPOSITIONSART_POSITIONSART_SET
				+ " AS "
				+ RechnungFac.FLR_GUTSCHRIFTPOSITIONSART_GUTSCHRIFTPOSITIONSART_POSITIONSART_SET;
	}
	...
	public TableInfo getTableInfo() {
		if (super.getTableInfo() == null) {
			...
			setTableInfo(new TableInfo(
					...
					new String[] {
							RechnungFac.FLR_GUTSCHRIFTPOSITIONSART_POSITIONSART_C_NR,
...
//							RechnungFac.FLR_GUTSCHRIFTPOSITIONSART_GUTSCHRIFTPOSITIONSART_POSITIONSART_SET
//									+ ".c_bez",
							RechnungFac.FLR_GUTSCHRIFTPOSITIONSART_I_SORT }));
		}
		...
		if (selectedId != null) {
			...
			try {
				...
				String queryString = "select "
						+ FLR_GUTSCHRIFTPOSITIONSART
						+ RechnungFac.FLR_GUTSCHRIFTPOSITIONSART_POSITIONSART_C_NR
						+ FLR_GUTSCHRIFTPOSITIONSART_FROM_CLAUSE
