...
/**
 * <p>
 * Hier wird die FLR Funktionalitaet fuer die GutschriftPosition implementiert.
...
public class GutschriftPositionHandler extends PositionHandler {
...
//					+ rechnungPositionDto.getIId();
			DocPath docPath = new DocPath(new DocNodeGutsPosition(rechnungPositionDto, rechnungDto));
