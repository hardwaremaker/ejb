...
public class FLRRechnungKontierung implements Serializable {
	...
	/** nullable persistent field */
	private BigDecimal n_prozentsatz;
	...
	/** full constructor */
	public FLRRechnungKontierung(
			Integer rechnung_i_id,
			BigDecimal n_prozentsatz,
			FLRKostenstelle flrkostenstelle,
			com.lp.server.rechnung.fastlanereader.generated.FLRRechnung flrrechnung) {
		this.rechnung_i_id = rechnung_i_id;
		this.n_prozentsatz = n_prozentsatz;
	...
	public BigDecimal getN_prozentsatz() {
		return this.n_prozentsatz;
	}

	public void setN_prozentsatz(BigDecimal n_prozentsatz) {
		this.n_prozentsatz = n_prozentsatz;
	}
