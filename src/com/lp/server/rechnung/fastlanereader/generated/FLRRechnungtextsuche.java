...
public class FLRRechnungtextsuche implements Serializable {
	...
	/** full constructor */
	public FLRRechnungtextsuche(String c_typ, String c_nr, String c_suche) {
		this.c_typ = c_typ;
		this.c_nr = c_nr;
