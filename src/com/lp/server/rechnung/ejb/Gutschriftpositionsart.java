...
@NamedQueries( {
		@NamedQuery(name = "GutschriftpositionsartfindAll", query = "SELECT OBJECT(o) FROM Gutschriftpositionsart o  ORDER BY o.iSort ASC"),
		@NamedQuery(name = "GutschriftpositionsartfindAllEnable", query = "SELECT OBJECT(o) FROM Gutschriftpositionsart o  WHERE o.bVersteckt=0 ORDER BY o.iSort ASC") })
@Entity
@Table(name = "RECH_GUTSCHRIFTPOSITIONSART")
public class Gutschriftpositionsart implements Serializable {
	...
	public Gutschriftpositionsart() {
		super();
	}

	public Gutschriftpositionsart(String positionsartCNr, Integer sort,
			Short versteckt) {
