...
@NamedQueries( { @NamedQuery(name = "GutschrifttextfindByMandantLocaleCNr", query = "SELECT OBJECT (o) FROM Gutschrifttext o WHERE o.mandantCNr=?1 AND o.localeCNr=?2 AND o.cNr=?3") })
@Entity
@Table(name = "RECH_GUTSCHRIFTTEXT") 
public class Gutschrifttext implements Serializable {
	@Id
	@Column(name = "I_ID")
	private Integer iId;
	...
	public Gutschrifttext() {
		super();
	}

	public Gutschrifttext(Integer id, String mandantCNr, String localeCNr,
