...
@NamedQueries( { @NamedQuery(name = "RechnungtextfindByMandantLocaleCNr", query = "SELECT OBJECT (o) FROM Rechnungtext o WHERE o.mandantCNr=?1 AND o.localeCNr=?2 AND o.cNr=?3") })
@Entity
@Table(name = "RECH_RECHNUNGTEXT")
public class Rechnungtext implements Serializable {
	@Id
	@Column(name = "I_ID")
	private Integer iId;
	...
	public Rechnungtext(Integer id, String mandantCNr, String localeCNr,
