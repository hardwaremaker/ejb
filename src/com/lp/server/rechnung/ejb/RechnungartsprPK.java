...
@Embeddable
public class RechnungartsprPK implements Serializable {
	...
	public RechnungartsprPK() {
		super();
	}

	public RechnungartsprPK(String nr, String locale) {
		setRechnungartCNr(nr);
		setLocaleCNr(locale);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof RechnungartsprPK)) {
			return false;
		}
		RechnungartsprPK other = (RechnungartsprPK) o;
		return this.rechnungartCNr.equals(other.rechnungartCNr)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.rechnungartCNr.hashCode();
