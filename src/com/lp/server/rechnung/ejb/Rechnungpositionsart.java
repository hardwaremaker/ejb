...
@NamedQueries( {
		@NamedQuery(name = "RechnungpositionsartfindAll", query = "SELECT OBJECT(o) FROM Rechnungpositionsart o ORDER BY o.iSort ASC"),
		@NamedQuery(name = "RechnungpositionsartfindAllEnable", query = "SELECT OBJECT(o) FROM Rechnungpositionsart o WHERE o.bVersteckt=0 ORDER BY o.iSort ASC") })
@Entity
@Table(name = "RECH_RECHNUNGPOSITIONSART")
public class Rechnungpositionsart implements Serializable {
	@Id
	...
	public Rechnungpositionsart() {
		super();
	}

	public Rechnungpositionsart(String positionsartCNr, Integer sort,
			Short versteckt) {
