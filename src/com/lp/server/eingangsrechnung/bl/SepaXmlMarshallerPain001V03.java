...
/**
 * Marshaller der Pain-Version pain.001.001.003
 * 
 * @author andi
 *
 */
public class SepaXmlMarshallerPain001V03 extends SepaXmlMarshaller {
	
	String xsdSchemaV03ISO = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>\r\n" + 
	...
	public SepaXmlMarshallerPain001V03() {
	}

	@Override
	public String marshal(Object sepaDoc) throws JAXBException, SAXException {
		
		return marshal(xsdSchemaV03ISO, (PADocument)sepaDoc);
	}
