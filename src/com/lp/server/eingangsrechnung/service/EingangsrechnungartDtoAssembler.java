...
import com.lp.server.eingangsrechnung.ejb.Eingangsrechnungart;

public class EingangsrechnungartDtoAssembler {
	public static EingangsrechnungartDto createDto(
			Eingangsrechnungart eingangsrechnungart) {
		EingangsrechnungartDto eingangsrechnungartDto = new EingangsrechnungartDto();
		if (eingangsrechnungart != null) {
			eingangsrechnungartDto.setCNr(eingangsrechnungart.getCNr());
		}
		return eingangsrechnungartDto;
	}

	public static EingangsrechnungartDto[] createDtos(
		...
		if (eingangsrechnungarts != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Eingangsrechnungart) iterator.next()));
			}
		}
