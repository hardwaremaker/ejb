...
public class EingangsrechnungtextDto implements Serializable {
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof EingangsrechnungtextDto))
			return false;
		EingangsrechnungtextDto that = (EingangsrechnungtextDto) obj;
		...
		if (!(that.cNr == null ? this.cNr == null : that.cNr.equals(this.cNr)))
			return false;
		if (!(that.cTextinhalt == null ? this.cTextinhalt == null
				: that.cTextinhalt.equals(this.cTextinhalt)))
			return false;
		return true;
	}
	...
	public int hashCode() {
		...
		result = 37 * result + this.cTextinhalt.hashCode();
		return result;
	}
