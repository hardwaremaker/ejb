...
public class EingangsrechnungUebersichtTabelleDto extends TabelleDto implements
		Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private BigDecimal bdOffenBrutto;
	private BigDecimal bdOffenNetto;
	...
	public BigDecimal getBdOffenBrutto() {
		return bdOffenBrutto;
	}

	public BigDecimal getBdOffenNetto() {
		return bdOffenNetto;
	}
	...
	public void setBdOffenBrutto(BigDecimal bdOffenBrutto) {
		this.bdOffenBrutto = bdOffenBrutto;
	}

	public void setBdOffenNetto(BigDecimal bdOffenNetto) {
		this.bdOffenNetto = bdOffenNetto;
	}
