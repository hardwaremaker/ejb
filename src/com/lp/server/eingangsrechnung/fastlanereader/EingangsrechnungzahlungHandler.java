	...
	public TableInfo getTableInfo() {
		if (super.getTableInfo() == null) {
			...
			setTableInfo(new TableInfo(
					new Class[] { Integer.class, Date.class, String.class, BigDecimal.class, BigDecimal.class,
							BigDecimalFinanz.class, Boolean.class },
					new String[] { "Id", getTextRespectUISpr("lp.zahldatum", mandantCNr, locUI),
					...
					new int[] { -1, QueryParameters.FLR_BREITE_M, -1, QueryParameters.FLR_BREITE_PREIS,
							QueryParameters.FLR_BREITE_PREIS, QueryParameters.FLR_BREITE_XM,
							QueryParameters.FLR_BREITE_S },
					new String[] { EingangsrechnungFac.FLR_ZAHLUNG_I_ID, Facade.NICHT_SORTIERBAR,
