...
public class FLRZahlungsvorschlaglauf implements Serializable {
	...
	/** full constructor */
	public FLRZahlungsvorschlaglauf(String mandant_c_nr, Date t_anlegen,
			Date t_zahlungsstichtag, Date t_naechsterzahlungslauf,
			Short b_mitskonto, Integer i_skontoueberziehungsfristintagen,
			Integer bankverbindung_i_id, FLRFinanzBankkonto flrbankverbindung) {
	...
	public void setI_skontoueberziehungsfristintagen(
			Integer i_skontoueberziehungsfristintagen) {
		this.i_skontoueberziehungsfristintagen = i_skontoueberziehungsfristintagen;
	}
