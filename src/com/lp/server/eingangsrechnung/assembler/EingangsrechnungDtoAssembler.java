...
public class EingangsrechnungDtoAssembler {
	public static EingangsrechnungDto createDto(
		...
		if (eingangsrechnung != null) {
			...
			eingangsrechnungDto.setBMitpositionen(eingangsrechnung.getBMitpositionen());
			eingangsrechnungDto.setCFusstextuebersteuert(eingangsrechnung.getCFusstextuebersteuert());
			eingangsrechnungDto.setCKopftextuebersteuert(eingangsrechnung.getCKopftextuebersteuert());
			eingangsrechnungDto.setReversechargeartId(eingangsrechnung.getReversechargeartIId());
			eingangsrechnungDto.setPersonalIIdAbwBankverbindung(eingangsrechnung.getPersonalIIdAbwBankverbindung());
			
			eingangsrechnungDto.setPersonalIIdGeprueft(eingangsrechnung.getPersonalIIdGeprueft());
			eingangsrechnungDto.setTGeprueft(eingangsrechnung.getTGeprueft());
