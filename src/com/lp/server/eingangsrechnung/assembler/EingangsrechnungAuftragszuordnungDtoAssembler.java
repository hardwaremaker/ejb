...
public class EingangsrechnungAuftragszuordnungDtoAssembler {
	public static EingangsrechnungAuftragszuordnungDto createDto(
			EingangsrechnungAuftragszuordnung eingangsrechnungAuftragszuordnung) {
		EingangsrechnungAuftragszuordnungDto eingangsrechnungAuftragszuordnungDto = new EingangsrechnungAuftragszuordnungDto();
		if (eingangsrechnungAuftragszuordnung != null) {
			eingangsrechnungAuftragszuordnungDto
					.setIId(eingangsrechnungAuftragszuordnung.getIId());
			eingangsrechnungAuftragszuordnungDto
					.setEingangsrechnungIId(eingangsrechnungAuftragszuordnung
							.getEingangsrechnungIId());
			eingangsrechnungAuftragszuordnungDto
					.setAuftragIId(eingangsrechnungAuftragszuordnung
							.getAuftragIId());
			eingangsrechnungAuftragszuordnungDto
					.setNBetrag(eingangsrechnungAuftragszuordnung.getNBetrag());
			eingangsrechnungAuftragszuordnungDto
					.setCText(eingangsrechnungAuftragszuordnung.getCText());
			eingangsrechnungAuftragszuordnungDto
					.setPersonalIIdAnlegen(eingangsrechnungAuftragszuordnung
							.getPersonalIIdAnlegen());
			eingangsrechnungAuftragszuordnungDto
					.setTAnlegen(eingangsrechnungAuftragszuordnung
							.getTAnlegen());
			eingangsrechnungAuftragszuordnungDto
					.setPersonalIIdAendern(eingangsrechnungAuftragszuordnung
			...
			eingangsrechnungAuftragszuordnungDto.setFVerrechenbar(eingangsrechnungAuftragszuordnung.getFVerrechenbar());
			eingangsrechnungAuftragszuordnungDto.setPersonalIIdErledigt(eingangsrechnungAuftragszuordnung.getPersonalIIdErledigt());
			eingangsrechnungAuftragszuordnungDto.setTErledigt(eingangsrechnungAuftragszuordnung.getTErledigt());

		}
		return eingangsrechnungAuftragszuordnungDto;
	}

	public static EingangsrechnungAuftragszuordnungDto[] createDtos(
