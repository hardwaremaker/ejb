...
import com.lp.server.eingangsrechnung.ejb.Eingangsrechnungstatus;
import com.lp.server.eingangsrechnung.service.EingangsrechnungstatusDto;

public class EingangsrechnungstatusDtoAssembler {
	public static EingangsrechnungstatusDto createDto(
			Eingangsrechnungstatus eingangsrechnungstatus) {
		EingangsrechnungstatusDto eingangsrechnungstatusDto = new EingangsrechnungstatusDto();
		if (eingangsrechnungstatus != null) {
			eingangsrechnungstatusDto.setStatusCNr(eingangsrechnungstatus
					.getStatusCNr());
		}
		return eingangsrechnungstatusDto;
	}

	public static EingangsrechnungstatusDto[] createDtos(
		...
		if (eingangsrechnungstatuss != null) {
			...
			while (iterator.hasNext()) {
				list.add(createDto((Eingangsrechnungstatus) iterator.next()));
			}
		}
