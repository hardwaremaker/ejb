...
@Embeddable
public class EingangsrechnungartsprPK implements Serializable {
	@Column(name = "EINGANGSRECHNUNGART_C_NR", insertable = false, updatable = false)
	...
	public EingangsrechnungartsprPK() {
		super();
	}

	public EingangsrechnungartsprPK(String nr, String localeCNr) {
		setEingangsrechnungartCNr(nr);
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof EingangsrechnungartsprPK)) {
			return false;
		}
		EingangsrechnungartsprPK other = (EingangsrechnungartsprPK) o;
		return this.eingangsrechnungartCNr.equals(other.eingangsrechnungartCNr)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + this.eingangsrechnungartCNr.hashCode();
