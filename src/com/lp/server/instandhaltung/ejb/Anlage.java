...
@NamedQueries({ @NamedQuery(name = "AnlageFindByMandantCNrCBez", query = "SELECT OBJECT(o) FROM Anlage o WHERE o.mandantCNr = ?1 AND o.cBez = ?2") })
@Entity
@Table(name = "IS_ANLAGE")
public class Anlage implements Serializable {
	...
	public Anlage(Integer id, String mandantCNr, String cBez, Integer halleIId) {
		setIId(id);
		setMandantCNr(mandantCNr);
		setCBez(cBez);
		setHalleIId(halleIId);
