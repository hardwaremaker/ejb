...
public class Instandhaltung implements Serializable {
	...
	@Column(name = "KATEGORIE_I_ID")
	private Integer kategorieIId;

	public Integer getKategorieIId() {
		return kategorieIId;
	}

	public void setKategorieIId(Integer kategorieIId) {
		this.kategorieIId = kategorieIId;
	}
	...
	public Instandhaltung() {
		super();
	}

	public Instandhaltung(Integer iId, Integer kundeIId, Short bVersteckt, Integer kategorieIId) {
		setIId(iId);
		setKundeIId(kundeIId);
		setBVersteckt(bVersteckt);
		setKategorieIId(kategorieIId);
