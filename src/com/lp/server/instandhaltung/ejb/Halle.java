...
@NamedQueries({ @NamedQuery(name = "HalleFindByMandantCNrCBez", query = "SELECT OBJECT(o) FROM Halle o WHERE o.mandantCNr = ?1 AND o.cBez = ?2") })
@Entity
@Table(name = "IS_HALLE")
public class Halle implements Serializable {
	...
	public Halle(Integer id, String mandantCNr, String cBez, Integer standortIId) {
		setIId(id);
