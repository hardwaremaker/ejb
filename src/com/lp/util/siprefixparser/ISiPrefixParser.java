...
public interface ISiPrefixParser {
	...
	/**
	 * Erzwingt, dass eine Einheit (nicht SI prefix!) verwendet werden muss.
	 * Dadurch werden Einheiten, deren Buchstabe in den SI Prefixen vorkommt, verwendbar.
	 * @param forceZeroUnit
	 */
	 ...
	 * 2&micro;8F (F)<br>
	 * 1F (F)<br>
	 * @param units nicht Mikro-Alternativen 
	 */
