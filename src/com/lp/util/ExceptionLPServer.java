 ...
 */
public class ExceptionLPServer extends Exception {
	/**
	 * 
	 */
	...
	public ExceptionLPServer(int iCodeI, String sMsgI,
			ArrayList<?> alInfoForTheClientI, Throwable throwableI) {
		iCode = iCodeI;
		sMsg = sMsgI;
		alInfoForTheClient = alInfoForTheClientI;
	}

	public ExceptionLPServer(int iCodeI, String sMsgI, Throwable throwableI) {
		iCode = iCodeI;
		sMsg = sMsgI;
		throwable = throwableI;
	}

	public ExceptionLPServer(int iCodeI, Throwable throwableI) {
		iCode = iCodeI;
		throwable = throwableI;
	}
