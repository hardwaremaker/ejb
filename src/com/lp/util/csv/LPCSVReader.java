...
public class LPCSVReader {
	 ...
	 */
	public LPCSVReader(Reader reader) {
	 ...
	 */
	public LPCSVReader(Reader reader, char separator) {
	 ...
	 */
	public LPCSVReader(Reader reader, char separator, Character quotechar) {
				...
				if (c.equals(quotechar)) {
					...
					if (inQuotes // we are in quotes, therefore there can be
							...
							&& nextLine.length() > (i + 1) // there is indeed
															// another character
															// to check.
							&& nextLine.charAt(i + 1) == quotechar.charValue()) { // .
																					// .
																					// and
																					// that
																					// char
