 ...
 */
public class DataZE {
	private Date buchungsZeitpunkt = null;
	private String sAusweisnr = null;
	...
	public void setSAusweisnr(String sAusweisnr) {
		this.sAusweisnr = sAusweisnr;
	}
	...
	public String getSAusweisnr() {
		return sAusweisnr;
	}

	public String getBuchungsZeitpunktASString() {
		return Helper.formatDatumZeit(buchungsZeitpunkt, Locale.GERMANY);
	}
