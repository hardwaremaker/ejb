...
public class Sg27Visitor implements IVisitor {
	protected final ILPLogger log = LPLogService.getInstance().getLogger(Sg27Visitor.class); 
	...
	public void visit(SccSegment sccSegment) {
		log.warn("visit scc " + sccSegment.get().getPlanCommitmentCode());
	}
