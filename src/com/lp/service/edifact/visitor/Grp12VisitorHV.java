...
public class Grp12VisitorHV implements IVisitor {
	protected final ILPLogger log = LPLogService.getInstance().getLogger(Grp12VisitorHV.class); 

	
	public Grp12VisitorHV(IEjbService service, IDelforRepository repository) {
	}
