...
public class Grp4VisitorHV implements IVisitor {
	protected final ILPLogger log = LPLogService.getInstance().getLogger(Grp2VisitorHV.class); 

	private IEjbService service;
	private IDelforRepository repository;
	
	public Grp4VisitorHV(IEjbService service, IDelforRepository repository) {
