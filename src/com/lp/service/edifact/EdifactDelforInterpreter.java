...
import com.lp.service.edifact.schema.EdifactDelforMessage;
...
public class EdifactDelforInterpreter extends EdifactInterpreter {
	private EdifactDelforMessage msg;
	...
	private List <UnsInfo> unsInfos;
	
	public EdifactDelforInterpreter(EdifactReader reader) throws EdifactException {
		super(reader);
		msg = new EdifactDelforMessage();
		...
		unsInfos = new ArrayList<UnsInfo>();
	}
	
	@Override
	protected List<EdifactOpcode<?>> createOpcodes() throws EdifactException {
		List<EdifactOpcode<?>> codes = super.createOpcodes();

		codes.add(new EdifactOpcode<FtxInfo>(new FtxSegment(), 5, true, msg.getHeaderTexts()));
		
		EdifactGroupOpcode sg1 = new EdifactGroupOpcode("sg1", this, 10, true)
		...
		EdifactGroupOpcode sg2 = new EdifactGroupOpcode("sg2", this, 99, true)
			.add(new EdifactOpcode<NadInfo>(new NadSegment(), 1, false, nadInfos));
		codes.add(sg2);
		
		EdifactGroupOpcode sg3 = new EdifactGroupOpcode("sg3", this, 10, true)
		...
		EdifactGroupOpcode sg4 = new EdifactGroupOpcode("sg4", this, 5, true)
		...
		EdifactGroupOpcode sg6 = new EdifactGroupOpcode("sg6", this, 9999, true)
			.add(new EdifactOpcode<GisInfo>(new GisSegment(), 1, false, gisInfos));
		codes.add(sg6);
	
		EdifactGroupOpcode sg7 = new EdifactGroupOpcode("sg7", this, 1, true)
		...
		EdifactGroupOpcode sg12 = new EdifactGroupOpcode("sg12", this, 9999, true)
		...
		EdifactGroupOpcode sg13 = new EdifactGroupOpcode("sg13", this, 10, true)
		...
		EdifactGroupOpcode sg15 = new EdifactGroupOpcode("sg15", this, 99, true)
		...
		EdifactGroupOpcode sg16 = new EdifactGroupOpcode("sg16", this, 10, true)
		...
		EdifactGroupOpcode sg17 = new EdifactGroupOpcode("sg17", this, 999, true)
			.add(new EdifactOpcode<SccInfo>(new SccSegment(), 1, false, sg17SccInfos)) ;
		sg12.add(sg17);

		EdifactGroupOpcode sg18 = new EdifactGroupOpcode("sg18", this, 999, true)
		...
		EdifactGroupOpcode sg19 = new EdifactGroupOpcode("sg19", this, 10, true)
		...
		EdifactGroupOpcode sg22 = new EdifactGroupOpcode("sg22", this, 999, true)
		...
		EdifactGroupOpcode sg24 = new EdifactGroupOpcode("sg24", this, 5, true)
		...
		sg22.add(sg24);
		EdifactGroupOpcode sg25 = new EdifactGroupOpcode("sg25", this, 10, true)
		...
		sg22.add(sg25);
		EdifactGroupOpcode sg26 = new EdifactGroupOpcode("sg26", this, 10, true)
		...
		EdifactGroupOpcode sg27 = new EdifactGroupOpcode("sg27", this, 999, false)
			.add(new EdifactOpcode<SccInfo>(new SccSegment(), 1, false, sg27SccInfos)) ;
		sg22.add(sg27);
		
		EdifactGroupOpcode sg28 = new EdifactGroupOpcode("sg28", this, 999, false)
		...
		EdifactGroupOpcode sg29 = new EdifactGroupOpcode("sg29", this, 10, true)
		...
		// delfor 91.1
		codes.add(new EdifactOpcode<UnsInfo>(new UnsSegment(), 1, true, unsInfos));
		
		codes.add(new EdifactOpcode<UntInfo>(new UntSegment(), 1, false, getHeaderMessage().getUnts()));
		return codes;
	}

	public EdifactDelforMessage getDelforMessage() {
		return msg;
	}
